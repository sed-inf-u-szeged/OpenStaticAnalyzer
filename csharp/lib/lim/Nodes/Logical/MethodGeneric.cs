...
namespace Columbus.Lim.Asg.Nodes.Logical {
    ...
    /// <summary>
    /// MethodGeneric class, which represents the logical::MethodGeneric node.
    /// </summary>
    ...
    class MethodGeneric : Method {
        ...
        public MethodGeneric(uint nodeId, Factory factory) : base(nodeId, factory) {
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkMethodGeneric; }
        }
        ...
        public void addHasGenericParameter(uint nodeId) {
            if (!fact.getExist(nodeId))
                throw new LimException("Columbus.Lim.Asg.Nodes.Logical.MethodGeneric.addHasGenericParameter(NodeId)", "The end point of the edge does not exist.");
            ...
            if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkGenericParameter)) {
                ...
                throw new LimException("Columbus.Lim.Asg.Nodes.Logical.MethodGeneric.setHasGenericParameter(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
            }
           setParentEdge(nodeId, (uint)Types.EdgeKind.edkMethodGeneric_HasGenericParameter);
            if (fact.ReverseEdges != null)
              fact.ReverseEdges.insertEdge(nodeId, this.Id, Types.EdgeKind.edkMethodGeneric_HasGenericParameter);
        }
        ...
        public override void load(IO binIo) {
            ...
            while (_id != 0) {
              ...
              setParentEdge(_id, (uint)Types.EdgeKind.edkMethodGeneric_HasGenericParameter);
              _id = binIo.readUInt4();
            }
        }
