    ...
    class Filter {
        ...
        public bool getIsFiltered(uint id) {
            if (container.Count <= id)
                throw new LimException("Columbus.Lim.Asg.Filter.getIsSelected()", "Too large NodeId");
        ...
        public void setFilteredThisNodeOnly(uint id) {
            if (container.Count <= id)
                throw new LimException("Columbus.Lim.Asg.Filter.setFilteredThisNodeOnly()", "Too large NodeId");
        ...
        public void setNotFilteredThisNodeOnly(uint id) {
            if (container.Count <= id)
                throw new LimException("Columbus.Lim.Asg.Filter.setNotFilteredThisNodeOnly()", "Too large NodeId");
        ...
        public FilterState getFilterState(uint id) {
            if (container.Count <= id)
                throw new LimException("Columbus.Lim.Asg.Filter.getFilterState()", "Too large NodeId");
