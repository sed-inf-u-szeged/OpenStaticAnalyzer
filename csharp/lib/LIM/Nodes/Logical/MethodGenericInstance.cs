...
namespace Columbus.Lim.Asg.Nodes.Logical {
    ...
    /// <summary>
    /// MethodGenericInstance class, which represents the logical::MethodGenericInstance node.
    /// </summary>
    ...
    public
#endif
    class MethodGenericInstance : Method {
        ...
        public MethodGenericInstance(uint nodeId, Factory factory) : base(nodeId, factory) {
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkMethodGenericInstance; }
        }
        ...
        public void addHasArguments(uint nodeId, Types.TypeArgumentConstraintKind acValue) {
            if (!fact.getExist(nodeId))
                throw new LimException("Columbus.Lim.Asg.Nodes.Logical.MethodGenericInstance.addHasArguments(NodeId)", "The end point of the edge does not exist.");
            ...
            if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkType)) {
                ...
                throw new LimException("Columbus.Lim.Asg.Nodes.Logical.MethodGenericInstance.setHasArguments(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
            }
            if (fact.ReverseEdges != null)
              fact.ReverseEdges.insertEdge(nodeId, this.Id, Types.EdgeKind.edkMethodGenericInstance_HasArguments);
        }
