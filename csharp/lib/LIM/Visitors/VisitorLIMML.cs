...
public override void visitComponent_CompilationUnit(uint begin, uint end) {
    createIndentation();
    writer.Write("<Component_CompilationUnit ref='");
    if (!bNoId)
      writer.Write("id" + end);
    writer.Write("'/>\n");
}

public override void visitEndComponent_CompilationUnit(uint begin, uint end) {
}
...
public override void visitClass_Extends(uint begin, uint end) {
    createIndentation();
    writer.Write("<Class_Extends ref='");
    if (!bNoId)
      writer.Write("id" + end);
    writer.Write("'/>\n");
}

public override void visitEndClass_Extends(uint begin, uint end) {
}
