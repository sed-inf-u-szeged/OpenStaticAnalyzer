...
namespace Columbus.Lim.Asg.Visitors {
    ...
    class Visitor {
        ...
        public virtual void visitComponent_CompilationUnit(uint begin, uint end) { }
        ...
        /// <param name="begin">[in] The id of the node the edge starts from.</param>
        /// <param name="end">[in] The id of the node the edge points to.</param>
        public virtual void visitEndComponent_CompilationUnit(uint begin, uint end) { }
        ...
        /// <summary>
        /// Edge visitor for extends edge which.
        /// </summary>
        /// <param name="begin">[in] The id of the node the edge starts from.</param>
        /// <param name="end">[in] The id of the node the edge points to.</param>
        public virtual void visitClass_Extends(uint begin, uint end) { }

        /// <summary>
        /// Edge end visitor for extends edge which is called after the visit pair of this edge is called.
        /// </summary>
        /// <param name="begin">[in] The id of the node the edge starts from.</param>
        /// <param name="end">[in] The id of the node the edge points to.</param>
        public virtual void visitEndClass_Extends(uint begin, uint end) { }
