...
namespace Columbus.Lim.Asg {
    ...
    class Types {
        ...
        public enum ClassKind {
            ...
            /// <summary>Value if the ClassKind is Category.</summary>
            clkCategory,
            ...
            /// <summary>Value if the ClassKind is Extension.</summary>
            clkExtension,

            /// <summary>Value if the ClassKind is Interface.</summary>
            clkInterface,

            /// <summary>Value if the ClassKind is Protocol.</summary>
            clkProtocol,
        ...
        public enum EdgeKind {
            ...
            /// <summary>Value if the EdgeKind is Component_CompilationUnit.</summary>
            ...
            /// <summary>Value if the EdgeKind is Class_Extends.</summary>
            edkClass_Extends,
