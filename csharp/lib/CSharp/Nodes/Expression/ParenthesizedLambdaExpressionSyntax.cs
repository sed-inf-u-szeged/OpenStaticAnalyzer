...
namespace Columbus.Csharp.Asg.Nodes.Expression {
    ...
    /// <summary>
    /// ParenthesizedLambdaExpressionSyntax class, which represents the expression::ParenthesizedLambdaExpressionSyntax node.
    /// </summary>
    ...
    class ParenthesizedLambdaExpressionSyntax : LambdaExpressionSyntax {
        ...
        public ParenthesizedLambdaExpressionSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_ParameterList = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkParenthesizedLambdaExpressionSyntax; }
        }
