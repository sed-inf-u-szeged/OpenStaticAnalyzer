...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// PropertyPatternClauseSyntax class, which represents the structure::PropertyPatternClauseSyntax node.
    /// </summary>
    ...
    public
#endif
    class PropertyPatternClauseSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public PropertyPatternClauseSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkPropertyPatternClauseSyntax; }
        }
        ...
        public void addSubpatterns(uint nodeId) {
            if (!fact.getExist(nodeId))
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.PropertyPatternClauseSyntax.addSubpatterns(NodeId)", "The end point of the edge does not exist.");
            ...
            if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkSubpatternSyntax)) {
                ...
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.PropertyPatternClauseSyntax.setSubpatterns(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
            }
           setParentEdge(nodeId, (uint)Types.EdgeKind.edkPropertyPatternClauseSyntax_Subpatterns);
            if (fact.ReverseEdges != null)
              fact.ReverseEdges.insertEdge(nodeId, this.Id, Types.EdgeKind.edkPropertyPatternClauseSyntax_Subpatterns);
        }
        ...
        public override void load(IO binIo) {
            ...
            while (_id != 0) {
              ...
              setParentEdge(_id, (uint)Types.EdgeKind.edkPropertyPatternClauseSyntax_Subpatterns);
              _id = binIo.readUInt4();
            }
        }
