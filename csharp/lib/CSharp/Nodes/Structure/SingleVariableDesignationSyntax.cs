...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// SingleVariableDesignationSyntax class, which represents the structure::SingleVariableDesignationSyntax node.
    /// </summary>
    ...
    class SingleVariableDesignationSyntax : VariableDesignationSyntax {
        ...
        public SingleVariableDesignationSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkSingleVariableDesignationSyntax; }
        }
