...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.DeclarationExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:DeclarationExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.ImplicitStackAllocArrayCreationExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:ImplicitStackAllocArrayCreationExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.IsPatternExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:IsPatternExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.RangeExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:RangeExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.RefExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:RefExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.RefTypeSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:RefTypeSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.SwitchExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:SwitchExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.ThrowExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:ThrowExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.TupleExpressionSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:TupleExpressionSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Expression.TupleTypeSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<expression:TupleTypeSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Statement.ForEachVariableStatementSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<statement:ForEachVariableStatementSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Statement.LocalFunctionStatementSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<statement:LocalFunctionStatementSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.CasePatternSwitchLabelSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:CasePatternSwitchLabelSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.ConstantPatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:ConstantPatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.DeclarationPatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:DeclarationPatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.DiscardDesignationSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:DiscardDesignationSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.DiscardPatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:DiscardPatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.ParenthesizedVariableDesignationSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:ParenthesizedVariableDesignationSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.PositionalPatternClauseSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:PositionalPatternClauseSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.PropertyPatternClauseSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:PropertyPatternClauseSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.RecursivePatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:RecursivePatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.SingleVariableDesignationSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:SingleVariableDesignationSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.SubpatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:SubpatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.SwitchExpressionArmSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:SwitchExpressionArmSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.TupleElementSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:TupleElementSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.VarPatternSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:VarPatternSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visit(Columbus.Csharp.Asg.Nodes.Structure.WhenClauseSyntax node, bool callVirtualBase) {
  createIndentation();
  writer.Write("<structure:WhenClauseSyntax");
  writeAttributes(node,false,true);
  writer.Write(">\n");
...
public override void visitAnonymousFunctionExpressionSyntax_Block(uint begin, uint end) {
    createIndentation();
    writer.Write("<AnonymousFunctionExpressionSyntax_Block>\n");
    incDepth();
}

public override void visitEndAnonymousFunctionExpressionSyntax_Block(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</AnonymousFunctionExpressionSyntax_Block>\n");
}

public override void visitAnonymousFunctionExpressionSyntax_ExpressionBody(uint begin, uint end) {
    createIndentation();
    writer.Write("<AnonymousFunctionExpressionSyntax_ExpressionBody>\n");
    incDepth();
}

public override void visitEndAnonymousFunctionExpressionSyntax_ExpressionBody(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</AnonymousFunctionExpressionSyntax_ExpressionBody>\n");
}
...
public override void visitDeclarationExpressionSyntax_Designation(uint begin, uint end) {
    createIndentation();
    writer.Write("<DeclarationExpressionSyntax_Designation>\n");
    incDepth();
}

public override void visitEndDeclarationExpressionSyntax_Designation(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</DeclarationExpressionSyntax_Designation>\n");
}

public override void visitDeclarationExpressionSyntax_Type(uint begin, uint end) {
    createIndentation();
    writer.Write("<DeclarationExpressionSyntax_Type>\n");
    incDepth();
}

public override void visitEndDeclarationExpressionSyntax_Type(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</DeclarationExpressionSyntax_Type>\n");
}
...
public override void visitImplicitStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
    createIndentation();
    writer.Write("<ImplicitStackAllocArrayCreationExpressionSyntax_Initializer>\n");
    incDepth();
}

public override void visitEndImplicitStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</ImplicitStackAllocArrayCreationExpressionSyntax_Initializer>\n");
}
...
public override void visitInvocationExpressionSyntax_LocalFunctionCall(uint begin, uint end) {
    createIndentation();
    writer.Write("<InvocationExpressionSyntax_LocalFunctionCall ref='");
    if (!bNoId)
      writer.Write("id" + end);
    writer.Write("'/>\n");
}

public override void visitEndInvocationExpressionSyntax_LocalFunctionCall(uint begin, uint end) {
}
...
public override void visitIsPatternExpressionSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<IsPatternExpressionSyntax_Expression>\n");
    incDepth();
}

public override void visitEndIsPatternExpressionSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</IsPatternExpressionSyntax_Expression>\n");
}

public override void visitIsPatternExpressionSyntax_Pattern(uint begin, uint end) {
    createIndentation();
    writer.Write("<IsPatternExpressionSyntax_Pattern>\n");
    incDepth();
}

public override void visitEndIsPatternExpressionSyntax_Pattern(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</IsPatternExpressionSyntax_Pattern>\n");
}
...
public override void visitRangeExpressionSyntax_LeftOperand(uint begin, uint end) {
    createIndentation();
    writer.Write("<RangeExpressionSyntax_LeftOperand>\n");
    incDepth();
}

public override void visitEndRangeExpressionSyntax_LeftOperand(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RangeExpressionSyntax_LeftOperand>\n");
}

public override void visitRangeExpressionSyntax_RightOperand(uint begin, uint end) {
    createIndentation();
    writer.Write("<RangeExpressionSyntax_RightOperand>\n");
    incDepth();
}

public override void visitEndRangeExpressionSyntax_RightOperand(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RangeExpressionSyntax_RightOperand>\n");
}

public override void visitRefExpressionSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<RefExpressionSyntax_Expression>\n");
    incDepth();
}

public override void visitEndRefExpressionSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RefExpressionSyntax_Expression>\n");
}
...
public override void visitRefTypeSyntax_Type(uint begin, uint end) {
    createIndentation();
    writer.Write("<RefTypeSyntax_Type>\n");
    incDepth();
}

public override void visitEndRefTypeSyntax_Type(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RefTypeSyntax_Type>\n");
}
...
public override void visitStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
    createIndentation();
    writer.Write("<StackAllocArrayCreationExpressionSyntax_Initializer>\n");
    incDepth();
}

public override void visitEndStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</StackAllocArrayCreationExpressionSyntax_Initializer>\n");
}
...
public override void visitSwitchExpressionSyntax_Arms(uint begin, uint end) {
    createIndentation();
    writer.Write("<SwitchExpressionSyntax_Arms>\n");
    incDepth();
}

public override void visitEndSwitchExpressionSyntax_Arms(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SwitchExpressionSyntax_Arms>\n");
}

public override void visitSwitchExpressionSyntax_GoverningExpression(uint begin, uint end) {
    createIndentation();
    writer.Write("<SwitchExpressionSyntax_GoverningExpression>\n");
    incDepth();
}

public override void visitEndSwitchExpressionSyntax_GoverningExpression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SwitchExpressionSyntax_GoverningExpression>\n");
}

public override void visitThrowExpressionSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<ThrowExpressionSyntax_Expression>\n");
    incDepth();
}

public override void visitEndThrowExpressionSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</ThrowExpressionSyntax_Expression>\n");
}

public override void visitTupleExpressionSyntax_Arguments(uint begin, uint end) {
    createIndentation();
    writer.Write("<TupleExpressionSyntax_Arguments>\n");
    incDepth();
}

public override void visitEndTupleExpressionSyntax_Arguments(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</TupleExpressionSyntax_Arguments>\n");
}

public override void visitTupleTypeSyntax_Elements(uint begin, uint end) {
    createIndentation();
    writer.Write("<TupleTypeSyntax_Elements>\n");
    incDepth();
}

public override void visitEndTupleTypeSyntax_Elements(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</TupleTypeSyntax_Elements>\n");
}
...
public override void visitCommonForEachStatementSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<CommonForEachStatementSyntax_Expression>\n");
    incDepth();
}

public override void visitEndCommonForEachStatementSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</CommonForEachStatementSyntax_Expression>\n");
}

public override void visitCommonForEachStatementSyntax_Statement(uint begin, uint end) {
    createIndentation();
    writer.Write("<CommonForEachStatementSyntax_Statement>\n");
    incDepth();
}

public override void visitEndCommonForEachStatementSyntax_Statement(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</CommonForEachStatementSyntax_Statement>\n");
}
...
public override void visitForEachVariableStatementSyntax_Variable(uint begin, uint end) {
    createIndentation();
    writer.Write("<ForEachVariableStatementSyntax_Variable>\n");
    incDepth();
}

public override void visitEndForEachVariableStatementSyntax_Variable(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</ForEachVariableStatementSyntax_Variable>\n");
}
...
public override void visitLocalFunctionStatementSyntax_Body(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_Body>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_Body(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_Body>\n");
}

public override void visitLocalFunctionStatementSyntax_ConstraintClauses(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_ConstraintClauses>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_ConstraintClauses(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_ConstraintClauses>\n");
}

public override void visitLocalFunctionStatementSyntax_ExpressionBody(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_ExpressionBody>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_ExpressionBody(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_ExpressionBody>\n");
}

public override void visitLocalFunctionStatementSyntax_ParameterList(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_ParameterList>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_ParameterList(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_ParameterList>\n");
}

public override void visitLocalFunctionStatementSyntax_ReturnType(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_ReturnType>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_ReturnType(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_ReturnType>\n");
}

public override void visitLocalFunctionStatementSyntax_TypeParameterList(uint begin, uint end) {
    createIndentation();
    writer.Write("<LocalFunctionStatementSyntax_TypeParameterList>\n");
    incDepth();
}

public override void visitEndLocalFunctionStatementSyntax_TypeParameterList(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</LocalFunctionStatementSyntax_TypeParameterList>\n");
}
...
public override void visitStatementSyntax_AttributeLists(uint begin, uint end) {
    createIndentation();
    writer.Write("<StatementSyntax_AttributeLists>\n");
    incDepth();
}

public override void visitEndStatementSyntax_AttributeLists(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</StatementSyntax_AttributeLists>\n");
}
...
public override void visitAccessorDeclarationSyntax_ExpressionBody(uint begin, uint end) {
    createIndentation();
    writer.Write("<AccessorDeclarationSyntax_ExpressionBody>\n");
    incDepth();
}

public override void visitEndAccessorDeclarationSyntax_ExpressionBody(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</AccessorDeclarationSyntax_ExpressionBody>\n");
}
...
public override void visitBaseMethodDeclarationSyntax_ExpressionBody(uint begin, uint end) {
    createIndentation();
    writer.Write("<BaseMethodDeclarationSyntax_ExpressionBody>\n");
    incDepth();
}

public override void visitEndBaseMethodDeclarationSyntax_ExpressionBody(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</BaseMethodDeclarationSyntax_ExpressionBody>\n");
}
...
public override void visitCasePatternSwitchLabelSyntax_Pattern(uint begin, uint end) {
    createIndentation();
    writer.Write("<CasePatternSwitchLabelSyntax_Pattern>\n");
    incDepth();
}

public override void visitEndCasePatternSwitchLabelSyntax_Pattern(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</CasePatternSwitchLabelSyntax_Pattern>\n");
}

public override void visitCasePatternSwitchLabelSyntax_WhenClause(uint begin, uint end) {
    createIndentation();
    writer.Write("<CasePatternSwitchLabelSyntax_WhenClause>\n");
    incDepth();
}

public override void visitEndCasePatternSwitchLabelSyntax_WhenClause(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</CasePatternSwitchLabelSyntax_WhenClause>\n");
}
...
public override void visitConstantPatternSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<ConstantPatternSyntax_Expression>\n");
    incDepth();
}

public override void visitEndConstantPatternSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</ConstantPatternSyntax_Expression>\n");
}
...
public override void visitDeclarationPatternSyntax_Designation(uint begin, uint end) {
    createIndentation();
    writer.Write("<DeclarationPatternSyntax_Designation>\n");
    incDepth();
}

public override void visitEndDeclarationPatternSyntax_Designation(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</DeclarationPatternSyntax_Designation>\n");
}

public override void visitDeclarationPatternSyntax_Type(uint begin, uint end) {
    createIndentation();
    writer.Write("<DeclarationPatternSyntax_Type>\n");
    incDepth();
}

public override void visitEndDeclarationPatternSyntax_Type(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</DeclarationPatternSyntax_Type>\n");
}
...
public override void visitParenthesizedVariableDesignationSyntax_Variables(uint begin, uint end) {
    createIndentation();
    writer.Write("<ParenthesizedVariableDesignationSyntax_Variables>\n");
    incDepth();
}

public override void visitEndParenthesizedVariableDesignationSyntax_Variables(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</ParenthesizedVariableDesignationSyntax_Variables>\n");
}

public override void visitPositionalPatternClauseSyntax_Subpatterns(uint begin, uint end) {
    createIndentation();
    writer.Write("<PositionalPatternClauseSyntax_Subpatterns>\n");
    incDepth();
}

public override void visitEndPositionalPatternClauseSyntax_Subpatterns(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</PositionalPatternClauseSyntax_Subpatterns>\n");
}
...
public override void visitPropertyPatternClauseSyntax_Subpatterns(uint begin, uint end) {
    createIndentation();
    writer.Write("<PropertyPatternClauseSyntax_Subpatterns>\n");
    incDepth();
}

public override void visitEndPropertyPatternClauseSyntax_Subpatterns(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</PropertyPatternClauseSyntax_Subpatterns>\n");
}
...
public override void visitRecursivePatternSyntax_Designation(uint begin, uint end) {
    createIndentation();
    writer.Write("<RecursivePatternSyntax_Designation>\n");
    incDepth();
}

public override void visitEndRecursivePatternSyntax_Designation(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RecursivePatternSyntax_Designation>\n");
}

public override void visitRecursivePatternSyntax_PositionalPatternClause(uint begin, uint end) {
    createIndentation();
    writer.Write("<RecursivePatternSyntax_PositionalPatternClause>\n");
    incDepth();
}

public override void visitEndRecursivePatternSyntax_PositionalPatternClause(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RecursivePatternSyntax_PositionalPatternClause>\n");
}

public override void visitRecursivePatternSyntax_PropertyPatternClause(uint begin, uint end) {
    createIndentation();
    writer.Write("<RecursivePatternSyntax_PropertyPatternClause>\n");
    incDepth();
}

public override void visitEndRecursivePatternSyntax_PropertyPatternClause(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RecursivePatternSyntax_PropertyPatternClause>\n");
}

public override void visitRecursivePatternSyntax_Type(uint begin, uint end) {
    createIndentation();
    writer.Write("<RecursivePatternSyntax_Type>\n");
    incDepth();
}

public override void visitEndRecursivePatternSyntax_Type(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</RecursivePatternSyntax_Type>\n");
}
...
public override void visitSubpatternSyntax_Pattern(uint begin, uint end) {
    createIndentation();
    writer.Write("<SubpatternSyntax_Pattern>\n");
    incDepth();
}

public override void visitEndSubpatternSyntax_Pattern(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SubpatternSyntax_Pattern>\n");
}

public override void visitSwitchExpressionArmSyntax_Expression(uint begin, uint end) {
    createIndentation();
    writer.Write("<SwitchExpressionArmSyntax_Expression>\n");
    incDepth();
}

public override void visitEndSwitchExpressionArmSyntax_Expression(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SwitchExpressionArmSyntax_Expression>\n");
}

public override void visitSwitchExpressionArmSyntax_Pattern(uint begin, uint end) {
    createIndentation();
    writer.Write("<SwitchExpressionArmSyntax_Pattern>\n");
    incDepth();
}

public override void visitEndSwitchExpressionArmSyntax_Pattern(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SwitchExpressionArmSyntax_Pattern>\n");
}

public override void visitSwitchExpressionArmSyntax_WhenClause(uint begin, uint end) {
    createIndentation();
    writer.Write("<SwitchExpressionArmSyntax_WhenClause>\n");
    incDepth();
}

public override void visitEndSwitchExpressionArmSyntax_WhenClause(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</SwitchExpressionArmSyntax_WhenClause>\n");
}
...
public override void visitTupleElementSyntax_Type(uint begin, uint end) {
    createIndentation();
    writer.Write("<TupleElementSyntax_Type>\n");
    incDepth();
}

public override void visitEndTupleElementSyntax_Type(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</TupleElementSyntax_Type>\n");
}
...
public override void visitTypeParameterListSyntax_Parameters(uint begin, uint end) {
    createIndentation();
    writer.Write("<TypeParameterListSyntax_Parameters>\n");
    incDepth();
}
...
public override void visitVarPatternSyntax_Designation(uint begin, uint end) {
    createIndentation();
    writer.Write("<VarPatternSyntax_Designation>\n");
    incDepth();
}

public override void visitEndVarPatternSyntax_Designation(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</VarPatternSyntax_Designation>\n");
}
...
public override void visitWhenClauseSyntax_Condition(uint begin, uint end) {
    createIndentation();
    writer.Write("<WhenClauseSyntax_Condition>\n");
    incDepth();
}

public override void visitEndWhenClauseSyntax_Condition(uint begin, uint end) {
    decDepth();
    createIndentation();
    writer.Write("</WhenClauseSyntax_Condition>\n");
}
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.DeclarationExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.ImplicitStackAllocArrayCreationExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.IsPatternExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.RangeExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.RefExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.RefTypeSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.TypeSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.SwitchExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.ThrowExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.TupleExpressionSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.ExpressionSyntax)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Expression.TupleTypeSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Expression.TypeSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Statement.CommonForEachStatementSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Statement.StatementSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Statement.ForEachStatementSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Statement.CommonForEachStatementSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Statement.ForEachVariableStatementSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Statement.CommonForEachStatementSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Statement.LocalFunctionStatementSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Statement.StatementSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.CasePatternSwitchLabelSyntax node,bool composite, bool bWithParent = true ) {
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.ConstantPatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.DeclarationPatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.DiscardDesignationSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.VariableDesignationSyntax)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.DiscardPatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.ParenthesizedVariableDesignationSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.VariableDesignationSyntax)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.PositionalPatternClauseSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.PropertyPatternClauseSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.RecursivePatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.SingleVariableDesignationSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.VariableDesignationSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.SubpatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.SwitchExpressionArmSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.TupleElementSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.VarPatternSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Structure.PatternSyntax)node,composite,false);
...
public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.VariableDesignationSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);

}

public void writeAttributes(Columbus.Csharp.Asg.Nodes.Structure.WhenClauseSyntax node,bool composite, bool bWithParent = true ) {
  writeAttributes((Columbus.Csharp.Asg.Nodes.Base.Positioned)node,composite,false);
