...
namespace Columbus.Csharp.Asg.Visitors {
    ...
    class VisitorReverseEdges : VisitorAbstractNodes {
        ...
        public override void visitAnonymousFunctionExpressionSyntax_Block(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkAnonymousFunctionExpressionSyntax_Block);
        }

        public override void visitAnonymousFunctionExpressionSyntax_ExpressionBody(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkAnonymousFunctionExpressionSyntax_ExpressionBody);
        }
        ...
        public override void visitDeclarationExpressionSyntax_Designation(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkDeclarationExpressionSyntax_Designation);
        }

        public override void visitDeclarationExpressionSyntax_Type(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkDeclarationExpressionSyntax_Type);
        }
        ...
        public override void visitImplicitStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkImplicitStackAllocArrayCreationExpressionSyntax_Initializer);
        }
        ...
        public override void visitInvocationExpressionSyntax_LocalFunctionCall(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkInvocationExpressionSyntax_LocalFunctionCall);
        }
        ...
        public override void visitIsPatternExpressionSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkIsPatternExpressionSyntax_Expression);
        }

        public override void visitIsPatternExpressionSyntax_Pattern(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkIsPatternExpressionSyntax_Pattern);
        }
        ...
        public override void visitRangeExpressionSyntax_LeftOperand(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRangeExpressionSyntax_LeftOperand);
        }

        public override void visitRangeExpressionSyntax_RightOperand(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRangeExpressionSyntax_RightOperand);
        }

        public override void visitRefExpressionSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRefExpressionSyntax_Expression);
        }
        ...
        public override void visitRefTypeSyntax_Type(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRefTypeSyntax_Type);
        }
        ...
        public override void visitStackAllocArrayCreationExpressionSyntax_Initializer(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkStackAllocArrayCreationExpressionSyntax_Initializer);
        }
        ...
        public override void visitSwitchExpressionSyntax_Arms(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSwitchExpressionSyntax_Arms);
        }

        public override void visitSwitchExpressionSyntax_GoverningExpression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSwitchExpressionSyntax_GoverningExpression);
        }

        public override void visitThrowExpressionSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkThrowExpressionSyntax_Expression);
        }

        public override void visitTupleExpressionSyntax_Arguments(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkTupleExpressionSyntax_Arguments);
        }

        public override void visitTupleTypeSyntax_Elements(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkTupleTypeSyntax_Elements);
        }
        ...
        public override void visitCommonForEachStatementSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkCommonForEachStatementSyntax_Expression);
        }

        public override void visitCommonForEachStatementSyntax_Statement(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkCommonForEachStatementSyntax_Statement);
        }
        ...
        public override void visitForEachVariableStatementSyntax_Variable(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkForEachVariableStatementSyntax_Variable);
        }
        ...
        public override void visitLocalFunctionStatementSyntax_Body(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_Body);
        }

        public override void visitLocalFunctionStatementSyntax_ConstraintClauses(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_ConstraintClauses);
        }

        public override void visitLocalFunctionStatementSyntax_ExpressionBody(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_ExpressionBody);
        }

        public override void visitLocalFunctionStatementSyntax_ParameterList(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_ParameterList);
        }

        public override void visitLocalFunctionStatementSyntax_ReturnType(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_ReturnType);
        }

        public override void visitLocalFunctionStatementSyntax_TypeParameterList(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkLocalFunctionStatementSyntax_TypeParameterList);
        }
        ...
        public override void visitStatementSyntax_AttributeLists(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkStatementSyntax_AttributeLists);
        }
        ...
        public override void visitAccessorDeclarationSyntax_ExpressionBody(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkAccessorDeclarationSyntax_ExpressionBody);
        }
        ...
        public override void visitBaseMethodDeclarationSyntax_ExpressionBody(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkBaseMethodDeclarationSyntax_ExpressionBody);
        }
        ...
        public override void visitCasePatternSwitchLabelSyntax_Pattern(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkCasePatternSwitchLabelSyntax_Pattern);
        }

        public override void visitCasePatternSwitchLabelSyntax_WhenClause(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkCasePatternSwitchLabelSyntax_WhenClause);
        }
        ...
        public override void visitConstantPatternSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkConstantPatternSyntax_Expression);
        }
        ...
        public override void visitDeclarationPatternSyntax_Designation(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkDeclarationPatternSyntax_Designation);
        }

        public override void visitDeclarationPatternSyntax_Type(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkDeclarationPatternSyntax_Type);
        }
        ...
        public override void visitParenthesizedVariableDesignationSyntax_Variables(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkParenthesizedVariableDesignationSyntax_Variables);
        }

        public override void visitPositionalPatternClauseSyntax_Subpatterns(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkPositionalPatternClauseSyntax_Subpatterns);
        }
        ...
        public override void visitPropertyPatternClauseSyntax_Subpatterns(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkPropertyPatternClauseSyntax_Subpatterns);
        }
        ...
        public override void visitRecursivePatternSyntax_Designation(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRecursivePatternSyntax_Designation);
        }

        public override void visitRecursivePatternSyntax_PositionalPatternClause(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRecursivePatternSyntax_PositionalPatternClause);
        }

        public override void visitRecursivePatternSyntax_PropertyPatternClause(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRecursivePatternSyntax_PropertyPatternClause);
        }

        public override void visitRecursivePatternSyntax_Type(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkRecursivePatternSyntax_Type);
        }
        ...
        public override void visitSubpatternSyntax_Pattern(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSubpatternSyntax_Pattern);
        }

        public override void visitSwitchExpressionArmSyntax_Expression(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSwitchExpressionArmSyntax_Expression);
        }

        public override void visitSwitchExpressionArmSyntax_Pattern(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSwitchExpressionArmSyntax_Pattern);
        }

        public override void visitSwitchExpressionArmSyntax_WhenClause(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkSwitchExpressionArmSyntax_WhenClause);
        }
        ...
        public override void visitTupleElementSyntax_Type(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkTupleElementSyntax_Type);
        }
        ...
        public override void visitVarPatternSyntax_Designation(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkVarPatternSyntax_Designation);
        }
        ...
        public override void visitWhenClauseSyntax_Condition(uint begin, uint end) {
          revEdges.insertEdge(end, begin, Types.EdgeKind.edkWhenClauseSyntax_Condition);
        }
