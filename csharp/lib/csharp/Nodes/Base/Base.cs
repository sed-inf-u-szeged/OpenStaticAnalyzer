...
namespace Columbus.Csharp.Asg.Nodes.Base {
    ...
    class Base {
        ...
        /// <exception cref="Columbus.Csharp.Asg.CsharpException">Throws CsharpException if the id is invalid.</exception>
        ...
        /// </summary>
        public virtual ListIterator<Columbus.Csharp.Asg.Nodes.Base.Base> GetListIteratorBegin(string edge) {
            return null;
        }
