...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// EnumDeclarationSyntax class, which represents the structure::EnumDeclarationSyntax node.
    /// </summary>
    ...
    class EnumDeclarationSyntax : BaseTypeDeclarationSyntax {
        ...
        public EnumDeclarationSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkEnumDeclarationSyntax; }
        }
        ...
        public ListIterator<Columbus.Csharp.Asg.Nodes.Structure.EnumMemberDeclarationSyntax> MembersListIteratorBegin {
            get {
                return new ListIterator<Columbus.Csharp.Asg.Nodes.Structure.EnumMemberDeclarationSyntax>(MembersContainer, fact, true);
            }
        }
        ...
        /// </summary>
        /// <returns>Returns an iterator for the Members edges.</returns>
        public ListIterator<Columbus.Csharp.Asg.Nodes.Structure.EnumMemberDeclarationSyntax> MembersListIteratorEnd {
            get {
                return new ListIterator<Columbus.Csharp.Asg.Nodes.Structure.EnumMemberDeclarationSyntax>(MembersContainer, fact, false);
            }
        }
        ...
        public void addMembers(Columbus.Csharp.Asg.Nodes.Structure.EnumMemberDeclarationSyntax node) {
            addMembers(node.Id);
        }
        ...
        public void addMembers(uint nodeId) {
            if (!fact.getExist(nodeId))
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.EnumDeclarationSyntax.addMembers(NodeId)", "The end point of the edge does not exist.");
            ...
            if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkEnumMemberDeclarationSyntax)) {
                ...
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.EnumDeclarationSyntax.setMembers(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
            }
           setParentEdge(nodeId, (uint)Types.EdgeKind.edkEnumDeclarationSyntax_Members);
            if (fact.ReverseEdges != null)
              fact.ReverseEdges.insertEdge(nodeId, this.Id, Types.EdgeKind.edkEnumDeclarationSyntax_Members);
        }
        ...
        public override void load(IO binIo) {
            ...
            while (_id != 0) {
              ...
              setParentEdge(_id, (uint)Types.EdgeKind.edkEnumDeclarationSyntax_Members);
              _id = binIo.readUInt4();
            }
        }
