...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// TypeParameterSyntax class, which represents the structure::TypeParameterSyntax node.
    /// </summary>
    ...
    public
#endif
    class TypeParameterSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public TypeParameterSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkTypeParameterSyntax; }
        }
        ...
        public void addAttributeLists(uint nodeId) {
            if (!fact.getExist(nodeId))
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.TypeParameterSyntax.addAttributeLists(NodeId)", "The end point of the edge does not exist.");
            ...
            if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkAttributeListSyntax)) {
                ...
                throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.TypeParameterSyntax.setAttributeLists(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
            }
           setParentEdge(nodeId, (uint)Types.EdgeKind.edkTypeParameterSyntax_AttributeLists);
            if (fact.ReverseEdges != null)
              fact.ReverseEdges.insertEdge(nodeId, this.Id, Types.EdgeKind.edkTypeParameterSyntax_AttributeLists);
        }
        ...
        public override void load(IO binIo) {
            ...
            while (_id != 0) {
              ...
              setParentEdge(_id, (uint)Types.EdgeKind.edkTypeParameterSyntax_AttributeLists);
              _id = binIo.readUInt4();
            }
        }
