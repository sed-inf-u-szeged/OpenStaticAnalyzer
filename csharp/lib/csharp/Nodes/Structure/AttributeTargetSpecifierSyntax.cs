...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// AttributeTargetSpecifierSyntax class, which represents the structure::AttributeTargetSpecifierSyntax node.
    /// </summary>
    ...
    public
#endif
    class AttributeTargetSpecifierSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public AttributeTargetSpecifierSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkAttributeTargetSpecifierSyntax; }
        }
