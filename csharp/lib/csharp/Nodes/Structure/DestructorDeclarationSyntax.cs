...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// DestructorDeclarationSyntax class, which represents the structure::DestructorDeclarationSyntax node.
    /// </summary>
    ...
    class DestructorDeclarationSyntax : BaseMethodDeclarationSyntax {
        ...
        public DestructorDeclarationSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkDestructorDeclarationSyntax; }
        }
