...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// EventDeclarationSyntax class, which represents the structure::EventDeclarationSyntax node.
    /// </summary>
    ...
    class EventDeclarationSyntax : BasePropertyDeclarationSyntax {
        ...
        public EventDeclarationSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkEventDeclarationSyntax; }
        }
