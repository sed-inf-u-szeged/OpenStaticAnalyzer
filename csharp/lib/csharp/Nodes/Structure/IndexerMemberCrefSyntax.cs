...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// IndexerMemberCrefSyntax class, which represents the structure::IndexerMemberCrefSyntax node.
    /// </summary>
    ...
    class IndexerMemberCrefSyntax : MemberCrefSyntax {
        ...
        public IndexerMemberCrefSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_Parameters = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkIndexerMemberCrefSyntax; }
        }
        ...
        public void setParameters(Columbus.Csharp.Asg.Nodes.Structure.CrefBracketedParameterListSyntax node) {
            if (m_Parameters != 0) {
                removeParentEdge(m_Parameters);
            }
