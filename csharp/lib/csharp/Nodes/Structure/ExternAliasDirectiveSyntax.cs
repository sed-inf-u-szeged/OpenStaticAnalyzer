...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// ExternAliasDirectiveSyntax class, which represents the structure::ExternAliasDirectiveSyntax node.
    /// </summary>
    ...
    public
#endif
    class ExternAliasDirectiveSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public ExternAliasDirectiveSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkExternAliasDirectiveSyntax; }
        }
