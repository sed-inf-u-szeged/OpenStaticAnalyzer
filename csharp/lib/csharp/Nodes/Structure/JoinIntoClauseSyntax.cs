...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// JoinIntoClauseSyntax class, which represents the structure::JoinIntoClauseSyntax node.
    /// </summary>
    ...
    public
#endif
    class JoinIntoClauseSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public JoinIntoClauseSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_identifier = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkJoinIntoClauseSyntax; }
        }
