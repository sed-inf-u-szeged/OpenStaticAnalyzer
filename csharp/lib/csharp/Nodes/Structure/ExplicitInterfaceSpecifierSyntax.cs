...
namespace Columbus.Csharp.Asg.Nodes.Structure {
    ...
    /// <summary>
    /// ExplicitInterfaceSpecifierSyntax class, which represents the structure::ExplicitInterfaceSpecifierSyntax node.
    /// </summary>
    ...
    public
#endif
    class ExplicitInterfaceSpecifierSyntax : Columbus.Csharp.Asg.Nodes.Base.Positioned {
        ...
        public ExplicitInterfaceSpecifierSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_Name = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkExplicitInterfaceSpecifierSyntax; }
        }
        ...
        public void setName(uint nodeId) {
            if (nodeId != 0) {
                if (!fact.getExist(nodeId))
                    throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.ExplicitInterfaceSpecifierSyntax.setName(NodeId)", "The end point of the edge does not exist.");
                ...
                if (Common.getIsBaseClassKind(node.NodeKind, Types.NodeKind.ndkNameSyntax)) {
                    ...
                    throw new CsharpException("Columbus.Csharp.Asg.Nodes.Structure.ExplicitInterfaceSpecifierSyntax.setName(NodeId)", "Invalid NodeKind (" + node.NodeKind.ToString() + ").");
                }
            } else {
                if (m_Name != 0) {
                    removeParentEdge(m_Name);
