...
namespace Columbus.Csharp.Asg.Nodes.Expression {
    ...
    /// <summary>
    /// MemberBindingExpressionSyntax class, which represents the expression::MemberBindingExpressionSyntax node.
    /// </summary>
    ...
    class MemberBindingExpressionSyntax : ExpressionSyntax {
        ...
        public MemberBindingExpressionSyntax(uint nodeId, Factory factory) : base(nodeId, factory) {
            m_Name = 0;
        }
        ...
        public override Types.NodeKind NodeKind {
            get { return Types.NodeKind.ndkMemberBindingExpressionSyntax; }
        }
