...
namespace Columbus.Csharp.Asg.Visitors {
    ...
    class VisitorAbstractNodes : Visitor {
        ...
        /// <summary>
        /// Abstract visitor, which calls the visitor of the base class (Columbus.Csharp.Asg.Nodes.Statement.StatementSyntax) of the Columbus.Csharp.Asg.Nodes.Statement.ForEachStatementSyntax node.
        /// </summary>
        /// <param name="node">[in] The node which is visited.</param>
        ...
        /// <summary>
        /// Abstract end visitor, which calls the end visitor of the base class (Columbus.Csharp.Asg.Nodes.Statement.StatementSyntax) of the Columbus.Csharp.Asg.Nodes.Statement.ForEachStatementSyntax node.
        /// </summary>
        /// <param name="node">[in] The node which is visited.</param>
