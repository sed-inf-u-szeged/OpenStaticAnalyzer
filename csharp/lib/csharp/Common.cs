    ...
    class Common {
        ...
        public static bool getIsNotComposite(Columbus.Csharp.Asg.Nodes.Base.Base node) {
            ...
            return
                ...
                ndk == Types.NodeKind.ndkStatementSyntax ||
                ndk == Types.NodeKind.ndkBreakStatementSyntax ||
                ndk == Types.NodeKind.ndkContinueStatementSyntax ||
                ndk == Types.NodeKind.ndkEmptyStatementSyntax ||
                ...
                ndk == Types.NodeKind.ndkTypeParameterListSyntax ||
