...
#ifndef _CLPARAMSUP_H
#define _CLPARAMSUP_H
...
namespace ClWrapperSup {
   ...
   *        If there is some problem with the argument, puts it into the can_warning list of clWarnings struct.
   *
   ...
   * @param clWarnings     [out] The problematic argument is put into this struct.
   ...
   */
  ParErrorCode examinePreprocArg (std::list<std::string>::iterator& args_it, const std::list<std::string>::const_iterator& args_end, Warnings& clWarnings, PreprocArgs& preprocArgs, Argument& actArg);
   ...
   * @return                     EC_ERROR if the given argument is not correct.
   */
  ParErrorCode examineLinkerArg (std::list<std::string>::iterator& args_it, const std::list<std::string>::const_iterator& args_end, LinkerArgs& linkerArgs, Argument& actArg);
   ...
   *        If there are some problematic arguments, they are put into the can_warnings list of clWarnings struct.
   *        If there are some unknown arguments, they are put into the unrec_args list of clWarnings struct.
   *
   * @param args           [in] The given linker argument list.
   * @param clWarnings     [out] The problematic or unknown arguments are put into this struct.
   ...
   */
  bool linkerArguments  (std::list<std::string> args, Warnings& clWarnings, LinkerArgs& linkerArgs);
   ...
   * @return                     True if it can processes the given argument list.
   */
  bool compilerArguments (std::list<std::string> args, Warnings& clWarnings, PreprocArgs& preprocArgs, CompilerArgs& compilerArgs, LinkerArgs& linkerArgs);
