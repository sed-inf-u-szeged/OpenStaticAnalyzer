...
#ifndef _CLANGPARAMSUP_H
#define _CLANGPARAMSUP_H
...
namespace ClangWrapperSup {
   ...
   *        If there is some problem with the argument, puts it into the can_warning list of clangWarnings struct.
   *
   ...
   * @param clangWarnings  [out] The problematic argument is put into this struct.
   ...
   */
  ParErrorCode examinePreprocArg (std::list<std::string>::iterator& args_it, const std::list<std::string>::const_iterator& args_end, Warnings& clangWarnings, PreprocArgs& preprocArgs, Argument& actArg);
   ...
   *        If there are some problematic arguments, they are put into the can_warnings list of clangWarnings struct.
   *        If there are some unknown arguments, they are put into the unrec_args list of clangWarnings struct.
   *
   * @param args           [in] The given compiler argument list.
   * @param clangWarnings  [out] The problematic or unknown arguments are put into this struct.
   ...
   */
  bool compilerArguments (std::list<std::string> args, Warnings& clangWarnings, PreprocArgs& preprocArgs, CompilerArgs& compilerArgs, LinkerArgs& linkerArgs);
