...
#ifndef _ARMCCPARAMSUP_H
#define _ARMCCPARAMSUP_H
...
namespace ArmccWrapperSup {
   ...
   *        If there is some problem with the argument, puts it into the can_warning list of armccWarnings struct.
   *
   ...
   * @param armccWarnings    [out] The problematic argument is put into this struct.
   ...
   */
  ParErrorCode examinePreprocArg (std::list<std::string>::iterator& args_it, const std::list<std::string>::const_iterator& args_end, Warnings& armccWarnings, PreprocArgs& preprocArgs, Argument& actArg);
   ...
   *        If there are some problematic arguments, they are put into the can_warnings list of armccWarnings struct.
   *        If there are some unknown arguments, they are put into the unrec_args list of armccWarnings struct.
   *
   * @param args           [in] The given linker argument list.
   * @param armccWarnings    [out] The problematic or unknown arguments are put into this struct.
   ...
   */
  bool linkerArguments (std::list<std::string> args, Warnings& armccWarnings, LinkerArgs& linkerArgs);
   ...
   * @return                     True if it can processes the given argument list.
   */
  bool compilerArguments (std::list<std::string> args, Warnings& armccWarnings, PreprocArgs& preprocArgs, CompilerArgs& compilerArgs, LinkerArgs& linkerArgs);
}}
