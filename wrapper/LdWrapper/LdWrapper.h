...
namespace ColumbusWrappers {
  class LdWrapper : public AbstractLinker {
/**
 * @brief This class can processes parameter list of ld and calls CANLink.
 */
  public:
    /**
     * @brief Public constructor for LdWrapper class.
     *
     * @param configfile     [in] The input configuration file (analyzer_wrapper_config.ini) for analyzer wrapper.
     */
    LdWrapper(std::string configfile);
