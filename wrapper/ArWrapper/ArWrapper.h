...
#ifndef _AR_WRAPPER_H
#define _AR_WRAPPER_H
...
namespace ColumbusWrappers {
  class ArWrapper : public AbstractArchive {
/**
 * @brief This class can processes parameter list of ar and calls CANLib.
 */
  public:
    /**
     * @brief Public constructor for ArWrapper class.
     *
     * @param configfile     [in] The input configuration file (analyzer_wrapper_config.ini) for analyzer wrapper.
     */
    ArWrapper(std::string configfile);
