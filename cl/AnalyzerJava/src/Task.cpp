...
Task::ExecutionResult PMD2GraphTask::execute()
{
  ...
  try {
    ...
    sv.push_back("-rul:" + (props.tempDir / "PMD.rul.md").string());
...
Task::ExecutionResult FindBugsTask::execute()
{
  ...
  try {
    ...
    sv.push_back("-lim:" + (props.asgDir / (props.projectName + ".lim")).string());
    sv.push_back("-rul:" + (props.tempDir / "FindBugs.rul.md").string());
    sv.push_back("-exportrul");
...
Task::ExecutionResult ProfileTask::execute()
{
  ...
  try {
    ...
    // original rul files
    path FindBugsRulFileOrig = props.toolsDir / "FindBugs.rul.md";
    path FindBugsRulMetadataFileOrig = props.toolsDir / "FindBugs.rul_metadata.md";
    path PMDRulFileOrig = props.toolsDir / "PMD.rul.md";
    path PMDRulMetadataFileOrig = props.toolsDir / "PMD.rul_metadata.md";
    path GeneralMetadataFileOrig = props.toolsDir / "general_metadata.md";
    path CWEMetadataFileOrig = props.toolsDir / "cwe_metadata.md";
    path OWASPMetadataFileOrig = props.toolsDir / "owasp_metadata.md";
    path SeiCertMetadataFileOrig = props.toolsDir / "sei_cert_metadata.md";

    // temp rul files
    path FindBugsRulFile = props.tempDir / "FindBugs.rul.md";
    path FindBugsRulMetadataFile = props.tempDir / "FindBugs.rul_metadata.md";
    path PMDRulFile = props.tempDir / "PMD.rul.md";
    path PMDRulMetadataFile = props.tempDir / "PMD.rul_metadata.md";
    path GeneralMetadataFile = props.tempDir / "general_metadata.md";
    path CWEMetadataFile = props.tempDir / "cwe_metadata.md";
    path OWASPMetadataFile = props.tempDir / "owasp_metadata.md";
    path SeiCertMetadataFile = props.tempDir / "sei_cert_metadata.md";
    ...
    if (exists(GeneralMetadataFileOrig))
    {
      copy_file(GeneralMetadataFileOrig, GeneralMetadataFile);
    }
    if (exists(CWEMetadataFileOrig))
    {
      copy_file(CWEMetadataFileOrig, CWEMetadataFile);
    }
    if (exists(OWASPMetadataFileOrig))
    {
      copy_file(OWASPMetadataFileOrig, OWASPMetadataFile);
    }
    if (exists(SeiCertMetadataFileOrig))
    {
      copy_file(SeiCertMetadataFileOrig, SeiCertMetadataFile);
    }

    if (exists(FindBugsRulMetadataFileOrig))
    {
      copy_file(FindBugsRulMetadataFileOrig, FindBugsRulMetadataFile);
    }
    ...
    if (exists(PMDRulMetadataFileOrig))
    {
      copy_file(PMDRulMetadataFileOrig, PMDRulMetadataFile);
    }
    ...
    //process udm metrics
    bool UDM_result = profileProcessUDM(profile, (props.tempDir / "UDM.rul.md").string(), "java");
