...
#define PROGRAM_NAME "AnalyzerCPP"
#define EXECUTABLE_NAME "AnalyzerCPP"
...
void initializeProperties() {
  ...
  if (common::setEnvironmentVariable(COLUMBUS_ANALYZER_IS_ACTIVE, "true") != 0) {
    WriteMsg::write(CMSG_ENV_VAR_SET_ERROR, COLUMBUS_ANALYZER_IS_ACTIVE);
    exit(EXIT_FAILURE);
  }
