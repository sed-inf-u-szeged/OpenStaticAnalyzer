...
#ifndef _ESLINT2GRAPH_RULECONVERTER_H_
#define _ESLINT2GRAPH_RULECONVERTER_H_
...
namespace columbus {  namespace eslint2graph {
  /**
   * \brief Class for generating rul file from eslint error list.
   */
  class RuleConverter {
  public:
    /**
