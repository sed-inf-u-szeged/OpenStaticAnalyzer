...
#include "../../inc/Conditions/AnyCondition.h"
...
namespace columbus { namespace lim { namespace patterns { namespace conditions{
    AnyCondition::AnyCondition(const EdgeKind _edgeKind, Direction _edgeDirection, const vector<string> &_from, NodeTypeCondition *_condition)
        : from(_from), edgeDirection(_edgeDirection), edgeKind(_edgeKind), nodeCondition(_condition) {}
    AnyCondition::~AnyCondition() {}
    
    bool AnyCondition::testCondition(graph::Graph &inGraph, const Base& limNode) {
