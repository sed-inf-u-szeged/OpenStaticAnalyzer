...
#include "../../inc/Conditions/NorCondition.h"
...
namespace columbus { namespace lim { namespace patterns { namespace conditions {
    ...
    NorCondition::NorCondition(MultiCondition *multiCond) : MultiCondition(multiCond) {};
    bool NorCondition::testCondition(Graph &inGraph, const Base& limNode) {
