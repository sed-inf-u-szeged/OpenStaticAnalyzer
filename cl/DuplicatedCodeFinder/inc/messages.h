...
#define CMSG_PROBALBLY_CLONES_FOUND             common::WriteMsg::mlDebug,"Probalbly clones found done. Building instances\n " 
#define CMSG_LOAD_ASG_DONE                      common::WriteMsg::mlDebug,"Load asg done"
#define CMSG_CONVERTING_TO_GRAPH                common::WriteMsg::mlDebug,"Converting to graph\n"
#define CMSG_BUILD_CE                           common::WriteMsg::mlDebug, "The CE cache"
#define CMSG_CLONE_INSTANCE                     common::WriteMsg::mlDDDDebug,"CloneInstance%d:\n"
...
#define CMSG_DONE_IN                            common::WriteMsg::mlDebug, "Debug: Done in %lu\n"
...
#define CMSG_ADDING_PATH_TO_FILTER              common::WriteMsg::mlDebug, "Debug: Adding path to filter: %s\n"
