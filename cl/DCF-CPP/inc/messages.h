...
#define CMSG_NO_INFO_FOR_FILE                   common::WriteMsg::mlError, "The information for the %s component is missing in the %s file.\n"
...
// debug
#define CMSG_SERIALIZED_AST_SIZE                common::WriteMsg::mlDebug, "Debug: Size of the serialized AST:%lu\n"
...
// TODO ez alatt 4-5 sorral van meg string konstans !!!
