...
@Mojo(name = "install-apmd", defaultPhase = LifecyclePhase.INSTALL, threadSafe = true, requiresDependencyResolution = ResolutionScope.COMPILE_PLUS_RUNTIME)
public class InstallApmdMojo extends AbstractColumbusMojo {
