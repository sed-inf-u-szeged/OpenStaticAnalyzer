...
@Mojo(name = "deploy-ajsi", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresDependencyResolution = ResolutionScope.COMPILE_PLUS_RUNTIME)
public class DeployAjsiMojo extends AbstractColumbusMojo {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    //
    runDependency();
    System.out.println("deploy to " + project.getUrl());
    // upload
    executeMojo(
        getMyPlugin(),
        "deploy-file",
