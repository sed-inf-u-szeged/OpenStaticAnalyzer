...
@Mojo(name = "deploy-apmd", defaultPhase = LifecyclePhase.DEPLOY, threadSafe = true, requiresDependencyResolution = ResolutionScope.COMPILE_PLUS_RUNTIME)
public class DeployApmdMojo extends AbstractColumbusMojo {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try {
      executeMojo(
          ...
          "deploy-file",
          element("file", EnvManager.getInstance().getProjectApmdFileName()),
          element("artifactId", project.getArtifactId()),
          element("classifier",  EnvManager.OSA_CLASSIFER_APMD),
