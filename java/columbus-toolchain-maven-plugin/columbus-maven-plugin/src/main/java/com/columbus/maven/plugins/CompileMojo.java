...
@Mojo(name = "compileArgs", defaultPhase = LifecyclePhase.COMPILE, threadSafe = true, requiresDependencyResolution = ResolutionScope.COMPILE_PLUS_RUNTIME )
public class CompileMojo extends AbstractCompilerMojo {
  ...
  public class ColumbusCompilerWrapper implements
    ...
    public CompilerResult performCompile(CompilerConfiguration arg0)
        throws CompilerException {
      CompilerResult result = new CompilerResult(); // original.performCompile(arg0);
