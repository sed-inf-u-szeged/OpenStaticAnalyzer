...
then
    ...
    mvn install:install-file -Dfile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0.jar -DpomFile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0-V2.pom
...
then
    ...
    mvn install:install-file -Dfile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0.jar -DpomFile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0-V3.pom
...
then
    ...
    mvn install:install-file -Dfile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0.jar -DpomFile=LinuxWrapper/WrapperBins/Tools/OpenStaticAnalyzer-maven-plugin-4.0-V31.pom
...
mvn org.apache.maven.plugins:OpenStaticAnalyzer-maven-plugin:4.0:installyourself
