...
:hackalias
call mvn org.apache.maven.plugins:OpenStaticAnalyzer-maven-plugin:8.2:installyourself
goto:eof

:oldmaven
echo Installing plugin for Maven 2.2.1 ...
call mvn install:install-file -Dfile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2.jar -DpomFile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2-V2.pom
goto:eof

:newmaven
echo Installing plugin for Maven 3.0.5 ...
call mvn install:install-file -Dfile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2.jar -DpomFile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2-V3.pom
goto:eof

:newermaven
echo Installing plugin for Maven 3.1.1 ...
call mvn install:install-file -Dfile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2.jar -DpomFile=WindowsWrapper\WrapperBins\Tools\OpenStaticAnalyzer-maven-plugin-8.2-V31.pom
goto:eof
