...
public class War extends org.apache.tools.ant.taskdefs.War {
	...
	@Override
	public void addClasses(ZipFileSet set) {
		ZipHelper.addExcludes(set);
		super.addClasses(set);
	}

	@Override
	public void addLib(ZipFileSet set) {
		ZipHelper.addExcludes(set);
		super.addLib(set);
	}

	@Override
	public void addWebinf(ZipFileSet set) {
		ZipHelper.addExcludes(set);
		super.addWebinf(set);
	}
