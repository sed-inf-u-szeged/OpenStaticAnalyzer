...
namespace expression { 
  ...
  ListIterator<base::Positioned> ObjectExpression::getPropertiesListIteratorBegin() const {
    return ListIterator<base::Positioned>(&hasPropertiesContainer, factory, true);
  }

  ListIterator<base::Positioned> ObjectExpression::getPropertiesListIteratorEnd() const {
  ...
  void ObjectExpression::addProperties(const base::Positioned *_node) {
    if (_node == NULL)
  ...
  void ObjectExpression::removeProperties(base::Positioned *_node) {
    if (_node == NULL)
