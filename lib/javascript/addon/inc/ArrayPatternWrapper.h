...
#ifndef _JAVASCRIPT_ArrayPatternWrapper_H_
#define _JAVASCRIPT_ArrayPatternWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ArrayPatternWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ArrayPattern* ArrayPattern;
      static void Init(v8::Handle<v8::Object> exports);
      ArrayPatternWrapper(const ArrayPatternWrapper&);
      ArrayPatternWrapper(Factory* fact);
      virtual ~ArrayPatternWrapper();
    ...
    private:
      ...
      static void addElementsArrayPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void addElementsAssignmentPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void addElementsObjectPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void addElementsRestElement(const v8::FunctionCallbackInfo<v8::Value>& args);
