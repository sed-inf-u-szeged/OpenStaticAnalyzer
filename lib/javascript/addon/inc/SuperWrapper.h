...
#ifndef _JAVASCRIPT_SuperWrapper_H_
#define _JAVASCRIPT_SuperWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class SuperWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::Super* Super;
      static void Init(v8::Handle<v8::Object> exports);
      SuperWrapper(const SuperWrapper&);
      SuperWrapper(Factory* fact);
      virtual ~SuperWrapper();
