...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ClassExpressionWrapper : BaseWrapper{
    public:
      static napi_value Init(napi_env env, napi_value& exports);
      static void Destructor(napi_env env, void* nativeObject, void* finalize_hint);
      static napi_status NewInstance(napi_env env, expression::ClassExpression* arg, napi_value* instance);
    private:
      explicit ClassExpressionWrapper(); // Constructor
      ~ClassExpressionWrapper();
