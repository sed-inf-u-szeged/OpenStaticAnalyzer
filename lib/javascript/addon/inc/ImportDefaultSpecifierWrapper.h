...
#ifndef _JAVASCRIPT_ImportDefaultSpecifierWrapper_H_
#define _JAVASCRIPT_ImportDefaultSpecifierWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ImportDefaultSpecifierWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::structure::ImportDefaultSpecifier* ImportDefaultSpecifier;
      static void Init(v8::Handle<v8::Object> exports);
      ImportDefaultSpecifierWrapper(const ImportDefaultSpecifierWrapper&);
      ImportDefaultSpecifierWrapper(Factory* fact);
      virtual ~ImportDefaultSpecifierWrapper();
...
}; //end of ImportDefaultSpecifierWrapper
