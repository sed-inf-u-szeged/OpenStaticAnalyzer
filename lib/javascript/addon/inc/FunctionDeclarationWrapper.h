...
#ifndef _JAVASCRIPT_FunctionDeclarationWrapper_H_
#define _JAVASCRIPT_FunctionDeclarationWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class FunctionDeclarationWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::declaration::FunctionDeclaration* FunctionDeclaration;
      static void Init(v8::Handle<v8::Object> exports);
      FunctionDeclarationWrapper(const FunctionDeclarationWrapper&);
      FunctionDeclarationWrapper(Factory* fact);
      virtual ~FunctionDeclarationWrapper();
...
}; //end of FunctionDeclarationWrapper
