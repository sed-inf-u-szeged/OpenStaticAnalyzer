...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class WithStatementWrapper : BaseWrapper{
    public:
      static napi_value Init(napi_env env, napi_value& exports);
      static void Destructor(napi_env env, void* nativeObject, void* finalize_hint);
      static napi_status NewInstance(napi_env env, statement::WithStatement* arg, napi_value* instance);
    private:
      explicit WithStatementWrapper(); // Constructor
      ~WithStatementWrapper();
