...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class WhileStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::WhileStatement* WhileStatement;
      static void Init(v8::Handle<v8::Object> exports);
      WhileStatementWrapper(const WhileStatementWrapper&);
      WhileStatementWrapper(Factory* fact);
      virtual ~WhileStatementWrapper();
