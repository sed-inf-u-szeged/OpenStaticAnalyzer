...
#ifndef _JAVASCRIPT_ExportAllDeclarationWrapper_H_
#define _JAVASCRIPT_ExportAllDeclarationWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ExportAllDeclarationWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::declaration::ExportAllDeclaration* ExportAllDeclaration;
      static void Init(v8::Handle<v8::Object> exports);
      ExportAllDeclarationWrapper(const ExportAllDeclarationWrapper&);
      ExportAllDeclarationWrapper(Factory* fact);
      virtual ~ExportAllDeclarationWrapper();
...
}; //end of ExportAllDeclarationWrapper
