...
#ifndef _JAVASCRIPT_ExportSpecifierWrapper_H_
#define _JAVASCRIPT_ExportSpecifierWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ExportSpecifierWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::structure::ExportSpecifier* ExportSpecifier;
      static void Init(v8::Handle<v8::Object> exports);
      ExportSpecifierWrapper(const ExportSpecifierWrapper&);
      ExportSpecifierWrapper(Factory* fact);
      virtual ~ExportSpecifierWrapper();
    ...
    private:
      ...
      static void setExportedIdentifier(const v8::FunctionCallbackInfo<v8::Value>& args);
