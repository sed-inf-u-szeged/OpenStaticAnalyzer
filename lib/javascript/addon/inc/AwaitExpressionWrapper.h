...
#ifndef _JAVASCRIPT_AwaitExpressionWrapper_H_
#define _JAVASCRIPT_AwaitExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class AwaitExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::AwaitExpression* AwaitExpression;
      static void Init(v8::Handle<v8::Object> exports);
      AwaitExpressionWrapper(const AwaitExpressionWrapper&);
      AwaitExpressionWrapper(Factory* fact);
      virtual ~AwaitExpressionWrapper();
