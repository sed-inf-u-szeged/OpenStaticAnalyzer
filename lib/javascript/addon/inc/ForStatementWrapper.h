...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ForStatementWrapper : BaseWrapper{
    public:
      static napi_value Init(napi_env env, napi_value& exports);
      static void Destructor(napi_env env, void* nativeObject, void* finalize_hint);
      static napi_status NewInstance(napi_env env, statement::ForStatement* arg, napi_value* instance);
    private:
      explicit ForStatementWrapper(); // Constructor
      ~ForStatementWrapper();
      ...
      static napi_value setUpdate(napi_env env, napi_callback_info info);
      static napi_value setInit(napi_env env, napi_callback_info info);
