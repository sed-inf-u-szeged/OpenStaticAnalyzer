...
#ifndef _JAVASCRIPT_StringLiteralWrapper_H_
#define _JAVASCRIPT_StringLiteralWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class StringLiteralWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::StringLiteral* StringLiteral;
      static void Init(v8::Handle<v8::Object> exports);
      StringLiteralWrapper(const StringLiteralWrapper&);
      StringLiteralWrapper(Factory* fact);
      virtual ~StringLiteralWrapper();
