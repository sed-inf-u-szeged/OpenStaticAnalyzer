...
#ifndef _JAVASCRIPT_MetaPropertyWrapper_H_
#define _JAVASCRIPT_MetaPropertyWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class MetaPropertyWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::MetaProperty* MetaProperty;
      static void Init(v8::Handle<v8::Object> exports);
      MetaPropertyWrapper(const MetaPropertyWrapper&);
      MetaPropertyWrapper(Factory* fact);
      virtual ~MetaPropertyWrapper();
    ...
    private:
      ...
      static void setMetaIdentifier(const v8::FunctionCallbackInfo<v8::Value>& args);
