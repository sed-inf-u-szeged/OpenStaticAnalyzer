...
#ifndef _JAVASCRIPT_NullLiteralWrapper_H_
#define _JAVASCRIPT_NullLiteralWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class NullLiteralWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::NullLiteral* NullLiteral;
      static void Init(v8::Handle<v8::Object> exports);
      NullLiteralWrapper(const NullLiteralWrapper&);
      NullLiteralWrapper(Factory* fact);
      virtual ~NullLiteralWrapper();
