...
#ifndef _JAVASCRIPT_ImportNamespaceSpecifierWrapper_H_
#define _JAVASCRIPT_ImportNamespaceSpecifierWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ImportNamespaceSpecifierWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::structure::ImportNamespaceSpecifier* ImportNamespaceSpecifier;
      static void Init(v8::Handle<v8::Object> exports);
      ImportNamespaceSpecifierWrapper(const ImportNamespaceSpecifierWrapper&);
      ImportNamespaceSpecifierWrapper(Factory* fact);
      virtual ~ImportNamespaceSpecifierWrapper();
    ...
    private:
      ...
      static void setLocalIdentifier(const v8::FunctionCallbackInfo<v8::Value>& args);
...
}; //end of ImportNamespaceSpecifierWrapper
