...
#ifndef _JAVASCRIPT_ForInStatementWrapper_H_
#define _JAVASCRIPT_ForInStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ForInStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ForInStatement* ForInStatement;
      static void Init(v8::Handle<v8::Object> exports);
      ForInStatementWrapper(const ForInStatementWrapper&);
      ForInStatementWrapper(Factory* fact);
      virtual ~ForInStatementWrapper();
