...
#ifndef _JAVASCRIPT_AssignmentExpressionWrapper_H_
#define _JAVASCRIPT_AssignmentExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class AssignmentExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::AssignmentExpression* AssignmentExpression;
      static void Init(v8::Handle<v8::Object> exports);
      AssignmentExpressionWrapper(const AssignmentExpressionWrapper&);
      AssignmentExpressionWrapper(Factory* fact);
      virtual ~AssignmentExpressionWrapper();
...
}; //end of AssignmentExpressionWrapper
