...
#ifndef _JAVASCRIPT_UnaryExpressionWrapper_H_
#define _JAVASCRIPT_UnaryExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class UnaryExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::UnaryExpression* UnaryExpression;
      static void Init(v8::Handle<v8::Object> exports);
      UnaryExpressionWrapper(const UnaryExpressionWrapper&);
      UnaryExpressionWrapper(Factory* fact);
      virtual ~UnaryExpressionWrapper();
