...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ReturnStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ReturnStatement* ReturnStatement;
      static void Init(v8::Handle<v8::Object> exports);
      ReturnStatementWrapper(const ReturnStatementWrapper&);
      ReturnStatementWrapper(Factory* fact);
      virtual ~ReturnStatementWrapper();
