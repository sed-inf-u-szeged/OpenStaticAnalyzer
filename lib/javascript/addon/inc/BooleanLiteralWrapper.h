...
#ifndef _JAVASCRIPT_BooleanLiteralWrapper_H_
#define _JAVASCRIPT_BooleanLiteralWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class BooleanLiteralWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::BooleanLiteral* BooleanLiteral;
      static void Init(v8::Handle<v8::Object> exports);
      BooleanLiteralWrapper(const BooleanLiteralWrapper&);
      BooleanLiteralWrapper(Factory* fact);
      virtual ~BooleanLiteralWrapper();
