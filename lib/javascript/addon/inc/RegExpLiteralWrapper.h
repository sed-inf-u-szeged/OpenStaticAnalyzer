...
#ifndef _JAVASCRIPT_RegExpLiteralWrapper_H_
#define _JAVASCRIPT_RegExpLiteralWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class RegExpLiteralWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::RegExpLiteral* RegExpLiteral;
      static void Init(v8::Handle<v8::Object> exports);
      RegExpLiteralWrapper(const RegExpLiteralWrapper&);
      RegExpLiteralWrapper(Factory* fact);
      virtual ~RegExpLiteralWrapper();
    ...
    private:
      ...
      static void setPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
