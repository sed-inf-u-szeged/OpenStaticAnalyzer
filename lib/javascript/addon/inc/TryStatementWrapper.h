...
#ifndef _JAVASCRIPT_TryStatementWrapper_H_
#define _JAVASCRIPT_TryStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class TryStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::TryStatement* TryStatement;
      static void Init(v8::Handle<v8::Object> exports);
      TryStatementWrapper(const TryStatementWrapper&);
      TryStatementWrapper(Factory* fact);
      virtual ~TryStatementWrapper();
    ...
    private:
      ...
      static void setBlockBlockStatement(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void setFinalizerBlockStatement(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void setHandlerCatchClause(const v8::FunctionCallbackInfo<v8::Value>& args);
