...
#ifndef _JAVASCRIPT_ObjectPatternWrapper_H_
#define _JAVASCRIPT_ObjectPatternWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ObjectPatternWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ObjectPattern* ObjectPattern;
      static void Init(v8::Handle<v8::Object> exports);
      ObjectPatternWrapper(const ObjectPatternWrapper&);
      ObjectPatternWrapper(Factory* fact);
      virtual ~ObjectPatternWrapper();
