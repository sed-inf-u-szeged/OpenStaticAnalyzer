...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ClassDeclarationWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::declaration::ClassDeclaration* ClassDeclaration;
      static void Init(v8::Handle<v8::Object> exports);
      ClassDeclarationWrapper(const ClassDeclarationWrapper&);
      ClassDeclarationWrapper(Factory* fact);
      virtual ~ClassDeclarationWrapper();
