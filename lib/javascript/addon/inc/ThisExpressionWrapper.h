...
#ifndef _JAVASCRIPT_ThisExpressionWrapper_H_
#define _JAVASCRIPT_ThisExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ThisExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::ThisExpression* ThisExpression;
      static void Init(v8::Handle<v8::Object> exports);
      ThisExpressionWrapper(const ThisExpressionWrapper&);
      ThisExpressionWrapper(Factory* fact);
      virtual ~ThisExpressionWrapper();
