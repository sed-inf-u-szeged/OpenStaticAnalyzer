...
#ifndef _JAVASCRIPT_RestElementWrapper_H_
#define _JAVASCRIPT_RestElementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class RestElementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::RestElement* RestElement;
      static void Init(v8::Handle<v8::Object> exports);
      RestElementWrapper(const RestElementWrapper&);
      RestElementWrapper(Factory* fact);
      virtual ~RestElementWrapper();
    ...
    private:
      ...
      static void setArgumentArrayPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void setArgumentAssignmentPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void setArgumentObjectPattern(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void setArgumentRestElement(const v8::FunctionCallbackInfo<v8::Value>& args);
