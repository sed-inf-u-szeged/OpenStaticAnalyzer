...
#ifndef _JAVASCRIPT_ContinueStatementWrapper_H_
#define _JAVASCRIPT_ContinueStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ContinueStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ContinueStatement* ContinueStatement;
      static void Init(v8::Handle<v8::Object> exports);
      ContinueStatementWrapper(const ContinueStatementWrapper&);
      ContinueStatementWrapper(Factory* fact);
      virtual ~ContinueStatementWrapper();
...
}; //end of ContinueStatementWrapper
