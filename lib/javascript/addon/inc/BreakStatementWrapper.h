...
#ifndef _JAVASCRIPT_BreakStatementWrapper_H_
#define _JAVASCRIPT_BreakStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class BreakStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::BreakStatement* BreakStatement;
      static void Init(v8::Handle<v8::Object> exports);
      BreakStatementWrapper(const BreakStatementWrapper&);
      BreakStatementWrapper(Factory* fact);
      virtual ~BreakStatementWrapper();
