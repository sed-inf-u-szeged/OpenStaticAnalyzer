...
#ifndef _JAVASCRIPT_VariableDeclarationWrapper_H_
#define _JAVASCRIPT_VariableDeclarationWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class VariableDeclarationWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::declaration::VariableDeclaration* VariableDeclaration;
      static void Init(v8::Handle<v8::Object> exports);
      VariableDeclarationWrapper(const VariableDeclarationWrapper&);
      VariableDeclarationWrapper(Factory* fact);
      virtual ~VariableDeclarationWrapper();
    ...
    private:
      ...
      static void addDeclarationsVariableDeclarator(const v8::FunctionCallbackInfo<v8::Value>& args);
...
}; //end of VariableDeclarationWrapper
