...
#ifndef _JAVASCRIPT_EmptyStatementWrapper_H_
#define _JAVASCRIPT_EmptyStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class EmptyStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::EmptyStatement* EmptyStatement;
      static void Init(v8::Handle<v8::Object> exports);
      EmptyStatementWrapper(const EmptyStatementWrapper&);
      EmptyStatementWrapper(Factory* fact);
      virtual ~EmptyStatementWrapper();
