...
#ifndef _JAVASCRIPT_ThrowStatementWrapper_H_
#define _JAVASCRIPT_ThrowStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ThrowStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::ThrowStatement* ThrowStatement;
      static void Init(v8::Handle<v8::Object> exports);
      ThrowStatementWrapper(const ThrowStatementWrapper&);
      ThrowStatementWrapper(Factory* fact);
      virtual ~ThrowStatementWrapper();
