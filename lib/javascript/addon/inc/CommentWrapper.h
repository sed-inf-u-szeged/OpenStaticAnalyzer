...
#ifndef _JAVASCRIPT_CommentWrapper_H_
#define _JAVASCRIPT_CommentWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class CommentWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::base::Comment* Comment;
      static void Init(v8::Handle<v8::Object> exports);
      CommentWrapper(const CommentWrapper&);
      CommentWrapper(Factory* fact);
      virtual ~CommentWrapper();
