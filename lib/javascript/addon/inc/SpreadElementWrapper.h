...
#ifndef _JAVASCRIPT_SpreadElementWrapper_H_
#define _JAVASCRIPT_SpreadElementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class SpreadElementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::SpreadElement* SpreadElement;
      static void Init(v8::Handle<v8::Object> exports);
      SpreadElementWrapper(const SpreadElementWrapper&);
      SpreadElementWrapper(Factory* fact);
      virtual ~SpreadElementWrapper();
