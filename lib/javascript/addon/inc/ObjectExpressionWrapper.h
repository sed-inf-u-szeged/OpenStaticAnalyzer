...
#ifndef _JAVASCRIPT_ObjectExpressionWrapper_H_
#define _JAVASCRIPT_ObjectExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ObjectExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::ObjectExpression* ObjectExpression;
      static void Init(v8::Handle<v8::Object> exports);
      ObjectExpressionWrapper(const ObjectExpressionWrapper&);
      ObjectExpressionWrapper(Factory* fact);
      virtual ~ObjectExpressionWrapper();
    ...
    private:
      ...
      static void addPropertiesProperty(const v8::FunctionCallbackInfo<v8::Value>& args);
      static void addPropertiesAssignmentProperty(const v8::FunctionCallbackInfo<v8::Value>& args);
...
}; //end of ObjectExpressionWrapper
