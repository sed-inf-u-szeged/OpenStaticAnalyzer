...
#ifndef _JAVASCRIPT_ImportSpecifierWrapper_H_
#define _JAVASCRIPT_ImportSpecifierWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ImportSpecifierWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::structure::ImportSpecifier* ImportSpecifier;
      static void Init(v8::Handle<v8::Object> exports);
      ImportSpecifierWrapper(const ImportSpecifierWrapper&);
      ImportSpecifierWrapper(Factory* fact);
      virtual ~ImportSpecifierWrapper();
    ...
    private:
      ...
      static void setImportedIdentifier(const v8::FunctionCallbackInfo<v8::Value>& args);
