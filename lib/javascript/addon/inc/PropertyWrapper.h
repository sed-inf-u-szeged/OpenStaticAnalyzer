...
#ifndef _JAVASCRIPT_PropertyWrapper_H_
#define _JAVASCRIPT_PropertyWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class PropertyWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::Property* Property;
      static void Init(v8::Handle<v8::Object> exports);
      PropertyWrapper(const PropertyWrapper&);
      PropertyWrapper(Factory* fact);
