...
#ifndef _JAVASCRIPT_FunctionExpressionWrapper_H_
#define _JAVASCRIPT_FunctionExpressionWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class FunctionExpressionWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::expression::FunctionExpression* FunctionExpression;
      static void Init(v8::Handle<v8::Object> exports);
      FunctionExpressionWrapper(const FunctionExpressionWrapper&);
      FunctionExpressionWrapper(Factory* fact);
      virtual ~FunctionExpressionWrapper();
...
}; //end of FunctionExpressionWrapper
