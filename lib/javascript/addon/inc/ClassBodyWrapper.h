...
#ifndef _JAVASCRIPT_ClassBodyWrapper_H_
#define _JAVASCRIPT_ClassBodyWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class ClassBodyWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::structure::ClassBody* ClassBody;
      static void Init(v8::Handle<v8::Object> exports);
      ClassBodyWrapper(const ClassBodyWrapper&);
      ClassBodyWrapper(Factory* fact);
      virtual ~ClassBodyWrapper();
    ...
    private:
      ...
      static void addBodyMethodDefinition(const v8::FunctionCallbackInfo<v8::Value>& args);
