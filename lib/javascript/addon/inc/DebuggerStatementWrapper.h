...
#ifndef _JAVASCRIPT_DebuggerStatementWrapper_H_
#define _JAVASCRIPT_DebuggerStatementWrapper_H_
...
namespace columbus { namespace javascript { namespace asg { namespace addon {
  ...
  class DebuggerStatementWrapper : public node::ObjectWrap {
    public:
      columbus::javascript::asg::statement::DebuggerStatement* DebuggerStatement;
      static void Init(v8::Handle<v8::Object> exports);
      DebuggerStatementWrapper(const DebuggerStatementWrapper&);
      DebuggerStatementWrapper(Factory* fact);
      virtual ~DebuggerStatementWrapper();
...
}; //end of DebuggerStatementWrapper
