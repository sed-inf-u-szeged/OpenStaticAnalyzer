...
napi_ref PropertyWrapper::constructor;

PropertyWrapper::PropertyWrapper(): env_(nullptr), wrapper_(nullptr) {}

PropertyWrapper::~PropertyWrapper(){ napi_delete_reference(env_, wrapper_); }

void PropertyWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  PropertyWrapper* obj = reinterpret_cast<PropertyWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~PropertyWrapper();
}
napi_value PropertyWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  ...
  napi_value cons;
  status = napi_define_class(env, "PropertyWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value PropertyWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  PropertyWrapper* obj = new PropertyWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), PropertyWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status PropertyWrapper::NewInstance(napi_env env, expression::Property* arg, napi_value* instance) {
...
napi_value PropertyWrapper::setValue(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::expression::Property* source = dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj);
  columbus::javascript::asg::base::Positioned* target = dynamic_cast<columbus::javascript::asg::base::Positioned*>(param->_nativeObj);

  if(source == nullptr){
    status = napi_throw_error(env, nullptr, "Cannot cast expression::Property" );
  }
  if(target == nullptr){
...
napi_value PropertyWrapper::setKey(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setKind(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setMethod(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setShorthand(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setComputed(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value PropertyWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
