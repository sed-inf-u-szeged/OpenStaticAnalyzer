...
napi_ref AssignmentPropertyWrapper::constructor;

AssignmentPropertyWrapper::AssignmentPropertyWrapper(): env_(nullptr), wrapper_(nullptr) {}

AssignmentPropertyWrapper::~AssignmentPropertyWrapper(){ napi_delete_reference(env_, wrapper_); }

void AssignmentPropertyWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  AssignmentPropertyWrapper* obj = reinterpret_cast<AssignmentPropertyWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~AssignmentPropertyWrapper();
}
napi_value AssignmentPropertyWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  napi_property_descriptor props [] = {
  DECLARE_NAPI_METHOD( "setValue", setValue),
  DECLARE_NAPI_METHOD( "setKey", setKey),
  DECLARE_NAPI_METHOD( "addComments", addComments),
    DECLARE_NAPI_METHOD("setKind", setKind),
    DECLARE_NAPI_METHOD("setMethod", setMethod),
    DECLARE_NAPI_METHOD("setShorthand", setShorthand),
  ...
  napi_value cons;
  status = napi_define_class(env, "AssignmentPropertyWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value AssignmentPropertyWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  AssignmentPropertyWrapper* obj = new AssignmentPropertyWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), AssignmentPropertyWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status AssignmentPropertyWrapper::NewInstance(napi_env env, expression::AssignmentProperty* arg, napi_value* instance) {
  ...
  AssignmentPropertyWrapper* obj;
  status = napi_unwrap(env, *instance, reinterpret_cast<void**>(&obj));
  obj->_nativeObj = arg;
  return napi_ok;
}

napi_value AssignmentPropertyWrapper::setValue(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::expression::AssignmentProperty* source = dynamic_cast<columbus::javascript::asg::expression::AssignmentProperty*>(obj->_nativeObj);
  columbus::javascript::asg::base::Positioned* target = dynamic_cast<columbus::javascript::asg::base::Positioned*>(param->_nativeObj);

  if(source == nullptr){
    status = napi_throw_error(env, nullptr, "Cannot cast expression::AssignmentProperty" );
  }
  if(target == nullptr){
...
napi_value AssignmentPropertyWrapper::setKey(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value AssignmentPropertyWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value AssignmentPropertyWrapper::setKind(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  if( param == "pkInit" ){
    dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setKind( pkInit );
  }
  if( param == "pkGet" ){
    dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setKind( pkGet );
  }
  if( param == "pkSet" ){
    dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setKind( pkSet );
  }
  return nullptr;
}
napi_value AssignmentPropertyWrapper::setMethod(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setMethod( b );
  return nullptr;
}
napi_value AssignmentPropertyWrapper::setShorthand(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  status = napi_get_value_bool(env, args[0], &b);
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setShorthand( b );
  return nullptr;
}
napi_value AssignmentPropertyWrapper::setComputed(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  status = napi_get_value_bool(env, args[0], &b);
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::expression::Property*>(obj->_nativeObj)->setComputed( b );
  return nullptr;
}
napi_value AssignmentPropertyWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value AssignmentPropertyWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
