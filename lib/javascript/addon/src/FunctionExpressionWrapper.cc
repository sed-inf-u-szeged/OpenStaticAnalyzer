...
napi_ref FunctionExpressionWrapper::constructor;

FunctionExpressionWrapper::FunctionExpressionWrapper(): env_(nullptr), wrapper_(nullptr) {}

FunctionExpressionWrapper::~FunctionExpressionWrapper(){ napi_delete_reference(env_, wrapper_); }

void FunctionExpressionWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  FunctionExpressionWrapper* obj = reinterpret_cast<FunctionExpressionWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~FunctionExpressionWrapper();
}
napi_value FunctionExpressionWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  ...
  napi_value cons;
  status = napi_define_class(env, "FunctionExpressionWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value FunctionExpressionWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  FunctionExpressionWrapper* obj = new FunctionExpressionWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), FunctionExpressionWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status FunctionExpressionWrapper::NewInstance(napi_env env, expression::FunctionExpression* arg, napi_value* instance) {
  ...
  FunctionExpressionWrapper* obj;
  status = napi_unwrap(env, *instance, reinterpret_cast<void**>(&obj));
  obj->_nativeObj = arg;
  return napi_ok;
}

napi_value FunctionExpressionWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::expression::FunctionExpression* source = dynamic_cast<columbus::javascript::asg::expression::FunctionExpression*>(obj->_nativeObj);
  columbus::javascript::asg::base::Comment* target = dynamic_cast<columbus::javascript::asg::base::Comment*>(param->_nativeObj);

  if(source == nullptr){
    status = napi_throw_error(env, nullptr, "Cannot cast expression::FunctionExpression" );
  }
  if(target == nullptr){
...
napi_value FunctionExpressionWrapper::addParams(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value FunctionExpressionWrapper::setBody(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value FunctionExpressionWrapper::setIdentifier(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value FunctionExpressionWrapper::setExpression(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::expression::FunctionExpression*>(obj->_nativeObj)->setExpression( b );
  return nullptr;
}
napi_value FunctionExpressionWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value FunctionExpressionWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
...
napi_value FunctionExpressionWrapper::setGenerator(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value FunctionExpressionWrapper::setAsync(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
