...
napi_ref VariableDeclaratorWrapper::constructor;

VariableDeclaratorWrapper::VariableDeclaratorWrapper(): env_(nullptr), wrapper_(nullptr) {}

VariableDeclaratorWrapper::~VariableDeclaratorWrapper(){ napi_delete_reference(env_, wrapper_); }

void VariableDeclaratorWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  VariableDeclaratorWrapper* obj = reinterpret_cast<VariableDeclaratorWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~VariableDeclaratorWrapper();
}
napi_value VariableDeclaratorWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  napi_property_descriptor props [] = {
  DECLARE_NAPI_METHOD( "setIdentifier", setIdentifier),
  DECLARE_NAPI_METHOD( "setInit", setInit),
  ...
  napi_value cons;
  status = napi_define_class(env, "VariableDeclaratorWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value VariableDeclaratorWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  VariableDeclaratorWrapper* obj = new VariableDeclaratorWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), VariableDeclaratorWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status VariableDeclaratorWrapper::NewInstance(napi_env env, declaration::VariableDeclarator* arg, napi_value* instance) {
  ...
  VariableDeclaratorWrapper* obj;
  status = napi_unwrap(env, *instance, reinterpret_cast<void**>(&obj));
  obj->_nativeObj = arg;
  return napi_ok;
}

napi_value VariableDeclaratorWrapper::setIdentifier(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::declaration::VariableDeclarator* source = dynamic_cast<columbus::javascript::asg::declaration::VariableDeclarator*>(obj->_nativeObj);
...
napi_value VariableDeclaratorWrapper::setInit(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  source->setInit(target);
  return nullptr;
}
napi_value VariableDeclaratorWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value VariableDeclaratorWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value VariableDeclaratorWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
