...
napi_ref ExportSpecifierWrapper::constructor;

ExportSpecifierWrapper::ExportSpecifierWrapper(): env_(nullptr), wrapper_(nullptr) {}

ExportSpecifierWrapper::~ExportSpecifierWrapper(){ napi_delete_reference(env_, wrapper_); }

void ExportSpecifierWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  ExportSpecifierWrapper* obj = reinterpret_cast<ExportSpecifierWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~ExportSpecifierWrapper();
}
napi_value ExportSpecifierWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  ...
  napi_value cons;
  status = napi_define_class(env, "ExportSpecifierWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value ExportSpecifierWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  ExportSpecifierWrapper* obj = new ExportSpecifierWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), ExportSpecifierWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status ExportSpecifierWrapper::NewInstance(napi_env env, structure::ExportSpecifier* arg, napi_value* instance) {
  ...
  ExportSpecifierWrapper* obj;
  status = napi_unwrap(env, *instance, reinterpret_cast<void**>(&obj));
  obj->_nativeObj = arg;
  return napi_ok;
}

napi_value ExportSpecifierWrapper::setExported(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::structure::ExportSpecifier* source = dynamic_cast<columbus::javascript::asg::structure::ExportSpecifier*>(obj->_nativeObj);
...
napi_value ExportSpecifierWrapper::setLocal(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value ExportSpecifierWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value ExportSpecifierWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value ExportSpecifierWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
