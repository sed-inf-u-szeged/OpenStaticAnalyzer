...
napi_ref MethodDefinitionWrapper::constructor;

MethodDefinitionWrapper::MethodDefinitionWrapper(): env_(nullptr), wrapper_(nullptr) {}

MethodDefinitionWrapper::~MethodDefinitionWrapper(){ napi_delete_reference(env_, wrapper_); }

void MethodDefinitionWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  MethodDefinitionWrapper* obj = reinterpret_cast<MethodDefinitionWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~MethodDefinitionWrapper();
}
napi_value MethodDefinitionWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  ...
  napi_value cons;
  status = napi_define_class(env, "MethodDefinitionWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value MethodDefinitionWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  MethodDefinitionWrapper* obj = new MethodDefinitionWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), MethodDefinitionWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status MethodDefinitionWrapper::NewInstance(napi_env env, structure::MethodDefinition* arg, napi_value* instance) {
  ...
  MethodDefinitionWrapper* obj;
  status = napi_unwrap(env, *instance, reinterpret_cast<void**>(&obj));
  obj->_nativeObj = arg;
  return napi_ok;
}

napi_value MethodDefinitionWrapper::setKey(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value MethodDefinitionWrapper::setValue(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  columbus::javascript::asg::structure::MethodDefinition* source = dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj);
  columbus::javascript::asg::expression::FunctionExpression* target = dynamic_cast<columbus::javascript::asg::expression::FunctionExpression*>(param->_nativeObj);
...
napi_value MethodDefinitionWrapper::addComments(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value MethodDefinitionWrapper::setKind(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  if( param == "mdkConstructor" ){
    dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setKind( mdkConstructor );
  }
  if( param == "mdkMethod" ){
    dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setKind( mdkMethod );
  }
  if( param == "mdkGet" ){
    dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setKind( mdkGet );
  }
  if( param == "mdkSet" ){
    dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setKind( mdkSet );
  }
  return nullptr;
}
napi_value MethodDefinitionWrapper::setComputed(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setComputed( b );
  return nullptr;
}
napi_value MethodDefinitionWrapper::setStatic(napi_env env, napi_callback_info info){ 
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
  ...
  status = napi_get_value_bool(env, args[0], &b);
  assert(status == napi_ok);
  dynamic_cast<columbus::javascript::asg::structure::MethodDefinition*>(obj->_nativeObj)->setStatic( b );
  return nullptr;
}
napi_value MethodDefinitionWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value MethodDefinitionWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
