...
napi_ref ExportAllDeclarationWrapper::constructor;

ExportAllDeclarationWrapper::ExportAllDeclarationWrapper(): env_(nullptr), wrapper_(nullptr) {}

ExportAllDeclarationWrapper::~ExportAllDeclarationWrapper(){ napi_delete_reference(env_, wrapper_); }

void ExportAllDeclarationWrapper::Destructor(napi_env env, void* nativeObject, void* ){
  ExportAllDeclarationWrapper* obj = reinterpret_cast<ExportAllDeclarationWrapper*>(nativeObject);
  //delete obj->_nativeObj;
  obj->~ExportAllDeclarationWrapper();
}
napi_value ExportAllDeclarationWrapper::Init(napi_env env, napi_value& exports) {
  napi_status status;
  ...
  napi_value cons;
  status = napi_define_class(env, "ExportAllDeclarationWrapper", NAPI_AUTO_LENGTH, New, nullptr, sizeof(props) / sizeof(*props), props, &cons );
...
napi_value ExportAllDeclarationWrapper::New(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  ...
  ExportAllDeclarationWrapper* obj = new ExportAllDeclarationWrapper();
  obj->env_ = env;
  status = napi_wrap(env, jsthis, reinterpret_cast<void*>(obj), ExportAllDeclarationWrapper::Destructor, nullptr, &obj->wrapper_);
  assert(status == napi_ok);
...
napi_status ExportAllDeclarationWrapper::NewInstance(napi_env env, declaration::ExportAllDeclaration* arg, napi_value* instance) {
...
napi_value ExportAllDeclarationWrapper::setSource(napi_env env, napi_callback_info info){
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value ExportAllDeclarationWrapper::setPath(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 1;
  napi_value args[1];
...
napi_value ExportAllDeclarationWrapper::setPosition(napi_env env, napi_callback_info info) {
  napi_status status;
  napi_value jsthis;
  size_t argc = 8;
  napi_value args[8];
