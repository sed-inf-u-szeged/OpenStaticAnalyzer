...
#ifndef _JAVASCRIPT_ExportSpecifier_H_
#define _JAVASCRIPT_ExportSpecifier_H_

#include "javascript/inc/javascript.h"

/**
* \file ExportSpecifier.h
* \brief Contains declaration of the structure::ExportSpecifier class.
...
namespace structure {
  ...
  /**
  * \brief ExportSpecifier class, which represents the structure::ExportSpecifier node.
  * (missing)
  * 
  * Edges:
  *   - hasExported (expression::Identifier, single) : (missing)
  */
  class ExportSpecifier : public ModuleSpecifier {
    protected:
      /**
      * \internal
      ...
      */
      ExportSpecifier(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ExportSpecifier();

    private:
      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ExportSpecifier & operator=(const ExportSpecifier&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ExportSpecifier(const ExportSpecifier&);
