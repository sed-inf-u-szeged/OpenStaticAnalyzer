...
#ifndef _JAVASCRIPT_ImpSpecifier_H_
#define _JAVASCRIPT_ImpSpecifier_H_

#include "javascript/inc/javascript.h"

/**
* \file ImpSpecifier.h
* \brief Contains declaration of the structure::ImpSpecifier class.
...
namespace structure {
  ...
  /**
  * \brief ImpSpecifier class, which represents the structure::ImpSpecifier node.
  * (missing)
  */
  class ImpSpecifier : public ModuleSpecifier {
    protected:
      /**
      * \internal
      ...
      */
      ImpSpecifier(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ImpSpecifier();
