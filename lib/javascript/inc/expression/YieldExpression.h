...
#ifndef _JAVASCRIPT_YieldExpression_H_
#define _JAVASCRIPT_YieldExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file YieldExpression.h
* \brief Contains declaration of the expression::YieldExpression class.
  ...
  */
  class YieldExpression : public Expression {
    protected:
      ...
      */
      YieldExpression(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~YieldExpression();

    private:
      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      YieldExpression & operator=(const YieldExpression&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      YieldExpression(const YieldExpression&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the delegate of the node.
      * \return Returns with the delegate.
      */
      ...
      /**
      * \internal
      * \brief Sets the delegate of the node.
      * \param delegate [in] The new value of the delegate.
      */
      void setDelegate(bool _delegate);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief The value of the `delegate`. */
      bool m_delegate : 1;
