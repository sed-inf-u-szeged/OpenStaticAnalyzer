...
#ifndef _JAVASCRIPT_Expression_H_
#define _JAVASCRIPT_Expression_H_

#include "javascript/inc/javascript.h"

/**
* \file Expression.h
* \brief Contains declaration of the expression::Expression class.
...
namespace expression {
  ...
  /**
  * \brief Expression class, which represents the expression::Expression node.
  * (missing)
  */
  class Expression : public virtual base::Positioned {
    protected:
      /**
      * \internal
