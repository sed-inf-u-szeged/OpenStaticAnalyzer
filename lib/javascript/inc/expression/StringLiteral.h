...
#ifndef _JAVASCRIPT_StringLiteral_H_
#define _JAVASCRIPT_StringLiteral_H_

#include "javascript/inc/javascript.h"

/**
* \file StringLiteral.h
* \brief Contains declaration of the expression::StringLiteral class.
...
namespace expression {
  ...
  /**
  * \brief StringLiteral class, which represents the expression::StringLiteral node.
  * (missing)
  * 
  * Attributes:
