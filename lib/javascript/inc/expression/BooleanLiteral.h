...
#ifndef _JAVASCRIPT_BooleanLiteral_H_
#define _JAVASCRIPT_BooleanLiteral_H_

#include "javascript/inc/javascript.h"

/**
* \file BooleanLiteral.h
* \brief Contains declaration of the expression::BooleanLiteral class.
...
namespace expression {
  ...
  /**
  * \brief BooleanLiteral class, which represents the expression::BooleanLiteral node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class BooleanLiteral : public Literal {
    ...
    protected:
      ...
      /** \internal \brief The value of the `value`. */
      bool m_value : 1;
