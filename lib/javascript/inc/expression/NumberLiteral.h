...
#ifndef _JAVASCRIPT_NumberLiteral_H_
#define _JAVASCRIPT_NumberLiteral_H_

#include "javascript/inc/javascript.h"

/**
* \file NumberLiteral.h
* \brief Contains declaration of the expression::NumberLiteral class.
...
namespace expression {
  ...
  /**
  * \brief NumberLiteral class, which represents the expression::NumberLiteral node.
  * (missing)
  * 
  * Attributes:
