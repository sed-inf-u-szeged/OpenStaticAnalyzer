...
#ifndef _JAVASCRIPT_ChainExpression_H_
#define _JAVASCRIPT_ChainExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file ChainExpression.h
* \brief Contains declaration of the expression::ChainExpression class.
...
namespace expression {
  ...
  /**
  * \brief ChainExpression class, which represents the expression::ChainExpression node.
  * (missing)
  * 
  * Edges:
  *   - hasExpression (expression::ChainElement, single) : (missing)
  */
  class ChainExpression : public Expression {
    protected:
      ...
      */
      ChainExpression(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ChainExpression & operator=(const ChainExpression&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      ChainExpression(const ChainExpression&);
    ...
    public:
      ...
      */
      expression::ChainElement* getExpression() const;
      ...
      */
      void setExpression(ChainElement *node);
