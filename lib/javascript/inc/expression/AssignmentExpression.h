...
#ifndef _JAVASCRIPT_AssignmentExpression_H_
#define _JAVASCRIPT_AssignmentExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file AssignmentExpression.h
* \brief Contains declaration of the expression::AssignmentExpression class.
...
namespace expression {
  ...
  /**
  * \brief AssignmentExpression class, which represents the expression::AssignmentExpression node.
  * (missing)
  * 
  * Attributes:
  *   - operator (AssignmentOperator) : (missing)
  * 
  * Edges:
  ...
  */
  class AssignmentExpression : public Expression {
    protected:
      ...
      */
      AssignmentExpression(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      AssignmentExpression & operator=(const AssignmentExpression&);
    ...
    protected:
      ...
      /** \internal \brief The AssignmentOperator of the node. */
