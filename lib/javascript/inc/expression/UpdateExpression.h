...
#ifndef _JAVASCRIPT_UpdateExpression_H_
#define _JAVASCRIPT_UpdateExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file UpdateExpression.h
* \brief Contains declaration of the expression::UpdateExpression class.
...
namespace expression {
  ...
  /**
  * \brief UpdateExpression class, which represents the expression::UpdateExpression node.
  * (missing)
  * 
  * Attributes:
  *   - operator (UpdateOperator) : (missing)
  *   - prefix (boolean) : (missing)
  * 
  * Edges:
  ...
  */
  class UpdateExpression : public Expression {
    protected:
      ...
      */
      UpdateExpression(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      UpdateExpression & operator=(const UpdateExpression&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      UpdateExpression(const UpdateExpression&);
    ...
    public:
      ...
      */
      UpdateOperator getOperator() const;

      /**
      * \brief Gives back the prefix of the node.
      * \return Returns with the prefix.
      */
      ...
      */
      void setOperator(UpdateOperator _operator);

      /**
      * \internal
      * \brief Sets the prefix of the node.
      * \param prefix [in] The new value of the prefix.
      */
      void setPrefix(bool _prefix);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief The value of the `prefix`. */
      bool m_prefix : 1;

      /** \internal \brief The UpdateOperator of the node. */
