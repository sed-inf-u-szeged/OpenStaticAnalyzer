...
#ifndef _JAVASCRIPT_UnaryExpression_H_
#define _JAVASCRIPT_UnaryExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file UnaryExpression.h
* \brief Contains declaration of the expression::UnaryExpression class.
...
namespace expression {
  ...
  /**
  * \brief UnaryExpression class, which represents the expression::UnaryExpression node.
  * (missing)
  * 
  * Attributes:
  *   - operator (UnaryOperator) : (missing)
  ...
  */
  class UnaryExpression : public Expression {
    protected:
      ...
      */
      UnaryExpression(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      void setOperator(UnaryOperator _operator);
    ...
    protected:
      ...
      /** \internal \brief The UnaryOperator of the node. */
