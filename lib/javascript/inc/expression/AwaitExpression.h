...
#ifndef _JAVASCRIPT_AwaitExpression_H_
#define _JAVASCRIPT_AwaitExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file AwaitExpression.h
* \brief Contains declaration of the expression::AwaitExpression class.
...
namespace expression {
  ...
  /**
  * \brief AwaitExpression class, which represents the expression::AwaitExpression node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class AwaitExpression : public Expression {
    protected:
      ...
      */
      AwaitExpression(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      AwaitExpression & operator=(const AwaitExpression&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      AwaitExpression(const AwaitExpression&);
