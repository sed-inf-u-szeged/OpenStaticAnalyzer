...
#ifndef _JAVASCRIPT_BinaryExpression_H_
#define _JAVASCRIPT_BinaryExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file BinaryExpression.h
* \brief Contains declaration of the expression::BinaryExpression class.
...
namespace expression {
  ...
  /**
  * \brief BinaryExpression class, which represents the expression::BinaryExpression node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class BinaryExpression : public Expression {
    protected:
      ...
      */
      BinaryExpression(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      void setOperator(BinaryOperator _operator);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief The BinaryOperator of the node. */
