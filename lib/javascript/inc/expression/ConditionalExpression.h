...
#ifndef _JAVASCRIPT_ConditionalExpression_H_
#define _JAVASCRIPT_ConditionalExpression_H_

#include "javascript/inc/javascript.h"

/**
* \file ConditionalExpression.h
* \brief Contains declaration of the expression::ConditionalExpression class.
...
namespace expression {
  ...
  /**
  * \brief ConditionalExpression class, which represents the expression::ConditionalExpression node.
  * &#60;p&#62;Ternary operator.&#60;&#47;p&#62;&#60;p&#62;Condition ? expr1 : expr2&#60;&#47;p&#62;&#60;p&#62;Eg.:&#60;&#47;p&#62;&#60;p&#62;'The fee is' + (isMember ? '$2.00' : '$10.00');&#60;&#47;p&#62;
  * 
  * Edges:
  *   - hasAlternate (expression::Expression, single) : (missing)
  *   - hasConsequent (expression::Expression, single) : (missing)
  ...
  */
  class ConditionalExpression : public Expression {
    protected:
      ...
      */
      ConditionalExpression(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      expression::Expression* getAlternate() const;
      ...
      */
      expression::Expression* getConsequent() const;
      ...
      */
      void setAlternate(Expression *node);
      ...
      */
      void setConsequent(Expression *node);
