...
#ifndef _JAVASCRIPT_Identifier_H_
#define _JAVASCRIPT_Identifier_H_

#include "javascript/inc/javascript.h"

/**
* \file Identifier.h
* \brief Contains declaration of the expression::Identifier class.
...
namespace expression {
  ...
  /**
  * \brief Identifier class, which represents the expression::Identifier node.
  * (missing)
  * 
  * Edges:
  *   - refersTo (base::Positioned, single) : (missing)
  */
  class Identifier : public Expression, public statement::Pattern, public base::Named {
    protected:
      /**
      * \internal
      ...
      */
      Identifier(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      base::Positioned* getRefersTo() const;
      ...
      */
      void setRefersTo(base::Positioned *node);
