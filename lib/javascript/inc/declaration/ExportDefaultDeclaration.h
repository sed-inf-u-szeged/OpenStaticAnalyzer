...
#ifndef _JAVASCRIPT_ExportDefaultDeclaration_H_
#define _JAVASCRIPT_ExportDefaultDeclaration_H_

#include "javascript/inc/javascript.h"

/**
* \file ExportDefaultDeclaration.h
* \brief Contains declaration of the declaration::ExportDefaultDeclaration class.
...
namespace declaration {
  ...
  /**
  * \brief ExportDefaultDeclaration class, which represents the declaration::ExportDefaultDeclaration node.
  * (missing)
  * 
  * Edges:
  *   - hasDeclaration (base::Positioned, single) : (missing)
  */
  class ExportDefaultDeclaration : public Declaration {
    protected:
      ...
      */
      ExportDefaultDeclaration(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ExportDefaultDeclaration();

    private:
      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ExportDefaultDeclaration & operator=(const ExportDefaultDeclaration&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ExportDefaultDeclaration(const ExportDefaultDeclaration&);
