...
#ifndef _JAVASCRIPT_ModuleDeclaration_H_
#define _JAVASCRIPT_ModuleDeclaration_H_

#include "javascript/inc/javascript.h"

/**
* \file ModuleDeclaration.h
* \brief Contains declaration of the declaration::ModuleDeclaration class.
...
namespace declaration {
  ...
  /**
  * \brief ModuleDeclaration class, which represents the declaration::ModuleDeclaration node.
  * (missing)
  */
