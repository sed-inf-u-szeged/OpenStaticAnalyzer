...
#ifndef _JAVASCRIPT_ExportAllDeclaration_H_
#define _JAVASCRIPT_ExportAllDeclaration_H_

#include "javascript/inc/javascript.h"

/**
* \file ExportAllDeclaration.h
* \brief Contains declaration of the declaration::ExportAllDeclaration class.
...
namespace declaration {
  ...
  /**
  * \brief ExportAllDeclaration class, which represents the declaration::ExportAllDeclaration node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ExportAllDeclaration : public Declaration {
    protected:
      ...
      */
      ExportAllDeclaration(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ExportAllDeclaration();

    private:
      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      ExportAllDeclaration & operator=(const ExportAllDeclaration&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      ExportAllDeclaration(const ExportAllDeclaration&);
