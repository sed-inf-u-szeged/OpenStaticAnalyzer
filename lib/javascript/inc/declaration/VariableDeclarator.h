...
#ifndef _JAVASCRIPT_VariableDeclarator_H_
#define _JAVASCRIPT_VariableDeclarator_H_

#include "javascript/inc/javascript.h"

/**
* \file VariableDeclarator.h
* \brief Contains declaration of the declaration::VariableDeclarator class.
...
namespace declaration {
  ...
  /**
  * \brief VariableDeclarator class, which represents the declaration::VariableDeclarator node.
  * (missing)
  * 
  * Edges:
  *   - hasIdentifier (statement::Pattern, single) : (missing)
  *   - hasInit (expression::Expression, single) : (missing)
  */
  class VariableDeclarator : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      VariableDeclarator(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      VariableDeclarator & operator=(const VariableDeclarator&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      VariableDeclarator(const VariableDeclarator&);
    ...
    public:
      ...
      */
      void setIdentifier(statement::Pattern *node);
      ...
      */
      void setInit(expression::Expression *node);
