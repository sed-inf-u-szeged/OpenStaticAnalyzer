...
#ifndef _JAVASCRIPT_Declaration_H_
#define _JAVASCRIPT_Declaration_H_

#include "javascript/inc/javascript.h"

/**
* \file Declaration.h
* \brief Contains declaration of the declaration::Declaration class.
...
namespace declaration {
  ...
  /**
  * \brief Declaration class, which represents the declaration::Declaration node.
  * (missing)
  */
  class Declaration : public statement::Statement {
    protected:
      /**
      * \internal
