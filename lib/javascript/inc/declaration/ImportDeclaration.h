...
#ifndef _JAVASCRIPT_ImportDeclaration_H_
#define _JAVASCRIPT_ImportDeclaration_H_

#include "javascript/inc/javascript.h"

/**
* \file ImportDeclaration.h
* \brief Contains declaration of the declaration::ImportDeclaration class.
...
namespace declaration {
  ...
  /**
  * \brief ImportDeclaration class, which represents the declaration::ImportDeclaration node.
  * (missing)
  * 
  * Edges:
  *   - hasSpecifiers (structure::ImpSpecifier, multiple) : (missing)
  *   - hasSource (expression::Literal, single) : (missing)
  */
  class ImportDeclaration : public ModuleDeclaration {
    protected:
      /**
      * \internal
      ...
      */
      ImportDeclaration(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ImportDeclaration & operator=(const ImportDeclaration&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      ImportDeclaration(const ImportDeclaration&);
    ...
    public:
      ...
      */
      ListIterator<structure::ImpSpecifier> getSpecifiersListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the hasSpecifiers edges.
      * \return Returns an iterator for the hasSpecifiers edges.
      */
      ListIterator<structure::ImpSpecifier> getSpecifiersListIteratorEnd() const;
      ...
      */
      void addSpecifiers(const structure::ImpSpecifier *node);
      ...
      */
      void removeSpecifiers(structure::ImpSpecifier *node);
    ...
    protected:
      ...
      ListIterator<structure::ImpSpecifier>::Container hasSpecifiersContainer;
