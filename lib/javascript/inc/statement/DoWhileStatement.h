...
#ifndef _JAVASCRIPT_DoWhileStatement_H_
#define _JAVASCRIPT_DoWhileStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file DoWhileStatement.h
* \brief Contains declaration of the statement::DoWhileStatement class.
...
namespace statement {
  ...
  /**
  * \brief DoWhileStatement class, which represents the statement::DoWhileStatement node.
  * (missing)
  */
  class DoWhileStatement : public WhileStatement {
    protected:
      ...
      */
      DoWhileStatement(NodeId nodeId, Factory *factory);
