...
#ifndef _JAVASCRIPT_Statement_H_
#define _JAVASCRIPT_Statement_H_

#include "javascript/inc/javascript.h"

/**
* \file Statement.h
* \brief Contains declaration of the statement::Statement class.
...
namespace statement {
  ...
  /**
  * \brief Statement class, which represents the statement::Statement node.
  * (missing)
  */
  class Statement : public virtual base::Positioned {
    protected:
      /**
      * \internal
