...
#ifndef _JAVASCRIPT_RestElement_H_
#define _JAVASCRIPT_RestElement_H_

#include "javascript/inc/javascript.h"

/**
* \file RestElement.h
* \brief Contains declaration of the statement::RestElement class.
...
namespace statement {
  ...
  /**
  * \brief RestElement class, which represents the statement::RestElement node.
  * (missing)
  * 
  * Edges:
  *   - hasArgument (statement::Pattern, single) : (missing)
  */
  class RestElement : public Pattern {
    protected:
      ...
      */
      RestElement(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      RestElement & operator=(const RestElement&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      RestElement(const RestElement&);
    ...
    public:
      ...
      */
      statement::Pattern* getArgument() const;
