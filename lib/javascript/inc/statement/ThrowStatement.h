...
#ifndef _JAVASCRIPT_ThrowStatement_H_
#define _JAVASCRIPT_ThrowStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file ThrowStatement.h
* \brief Contains declaration of the statement::ThrowStatement class.
...
namespace statement {
  ...
  /**
  * \brief ThrowStatement class, which represents the statement::ThrowStatement node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ThrowStatement : public Statement {
    protected:
      ...
      */
      ThrowStatement(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ThrowStatement & operator=(const ThrowStatement&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ThrowStatement(const ThrowStatement&);
    ...
    public:
      ...
      */
      void setArgument(expression::Expression *node);
