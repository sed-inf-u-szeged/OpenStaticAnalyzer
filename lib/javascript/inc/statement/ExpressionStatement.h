...
#ifndef _JAVASCRIPT_ExpressionStatement_H_
#define _JAVASCRIPT_ExpressionStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file ExpressionStatement.h
* \brief Contains declaration of the statement::ExpressionStatement class.
...
namespace statement {
  ...
  /**
  * \brief ExpressionStatement class, which represents the statement::ExpressionStatement node.
  * (missing)
  * 
  * Edges:
