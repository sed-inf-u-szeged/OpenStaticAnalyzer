...
#ifndef _JAVASCRIPT_LabeledStatement_H_
#define _JAVASCRIPT_LabeledStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file LabeledStatement.h
* \brief Contains declaration of the statement::LabeledStatement class.
...
namespace statement {
  ...
  /**
  * \brief LabeledStatement class, which represents the statement::LabeledStatement node.
  * (missing)
  * 
  * Edges:
