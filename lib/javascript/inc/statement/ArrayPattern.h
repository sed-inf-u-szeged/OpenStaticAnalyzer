...
#ifndef _JAVASCRIPT_ArrayPattern_H_
#define _JAVASCRIPT_ArrayPattern_H_

#include "javascript/inc/javascript.h"

/**
* \file ArrayPattern.h
* \brief Contains declaration of the statement::ArrayPattern class.
...
namespace statement {
  ...
  /**
  * \brief ArrayPattern class, which represents the statement::ArrayPattern node.
  * (missing)
  * 
  * Edges:
  *   - hasElements (statement::Pattern, multiple) : (missing)
  */
  class ArrayPattern : public Pattern {
    protected:
      ...
      */
      ArrayPattern(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ArrayPattern();

    private:
      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ArrayPattern & operator=(const ArrayPattern&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ArrayPattern(const ArrayPattern&);
    ...
    public:
      ...
      */
      ListIterator<statement::Pattern> getElementsListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the hasElements edges.
      * \return Returns an iterator for the hasElements edges.
      */
      ListIterator<statement::Pattern> getElementsListIteratorEnd() const;
      ...
      */
      void addElements(const Pattern *node);
      ...
      */
      void removeElements(Pattern *node);
    ...
    protected:
      ...
      ListIterator<statement::Pattern>::Container hasElementsContainer;
