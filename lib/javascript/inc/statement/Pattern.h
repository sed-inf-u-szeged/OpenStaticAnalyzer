...
#ifndef _JAVASCRIPT_Pattern_H_
#define _JAVASCRIPT_Pattern_H_

#include "javascript/inc/javascript.h"

/**
* \file Pattern.h
* \brief Contains declaration of the statement::Pattern class.
...
namespace statement {
  ...
  /**
  * \brief Pattern class, which represents the statement::Pattern node.
  * (missing)
  */
  class Pattern : public virtual base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      Pattern(NodeId nodeId, Factory *factory);
