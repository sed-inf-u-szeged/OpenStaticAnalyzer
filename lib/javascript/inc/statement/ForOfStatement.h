...
#ifndef _JAVASCRIPT_ForOfStatement_H_
#define _JAVASCRIPT_ForOfStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file ForOfStatement.h
* \brief Contains declaration of the statement::ForOfStatement class.
  ...
  */
  class ForOfStatement : public ForInStatement {
    protected:
      ...
      */
      ForOfStatement(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ForOfStatement();
