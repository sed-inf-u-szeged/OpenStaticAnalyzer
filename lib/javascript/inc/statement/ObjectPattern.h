...
#ifndef _JAVASCRIPT_ObjectPattern_H_
#define _JAVASCRIPT_ObjectPattern_H_

#include "javascript/inc/javascript.h"

/**
* \file ObjectPattern.h
* \brief Contains declaration of the statement::ObjectPattern class.
...
namespace statement {
  ...
  /**
  * \brief ObjectPattern class, which represents the statement::ObjectPattern node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ObjectPattern : public Pattern {
    protected:
      ...
      */
      ObjectPattern(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ObjectPattern & operator=(const ObjectPattern&);

      /**
      * \brief This function always throws a JavaScriptException due to copying is not allowed!
      */
      ObjectPattern(const ObjectPattern&);
    ...
    public:
      ...
      */
      void addProperties(const expression::Property *node);
      ...
      */
      void removeProperties(expression::Property *node);
