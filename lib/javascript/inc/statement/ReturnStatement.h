...
#ifndef _JAVASCRIPT_ReturnStatement_H_
#define _JAVASCRIPT_ReturnStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file ReturnStatement.h
* \brief Contains declaration of the statement::ReturnStatement class.
...
namespace statement {
  ...
  /**
  * \brief ReturnStatement class, which represents the statement::ReturnStatement node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ReturnStatement : public Statement {
    protected:
      ...
      */
      ReturnStatement(NodeId nodeId, Factory *factory);
