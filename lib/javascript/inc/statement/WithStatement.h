...
#ifndef _JAVASCRIPT_WithStatement_H_
#define _JAVASCRIPT_WithStatement_H_

#include "javascript/inc/javascript.h"

/**
* \file WithStatement.h
* \brief Contains declaration of the statement::WithStatement class.
...
namespace statement {
  ...
  /**
  * \brief WithStatement class, which represents the statement::WithStatement node.
  * (missing)
  * 
  * Edges:
  *   - hasObject (expression::Expression, single) : (missing)
  ...
  */
  class WithStatement : public Statement {
    protected:
      ...
      */
      WithStatement(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      WithStatement & operator=(const WithStatement&);

      /**
      * \brief This function always throws a JavascriptException due to copying is not allowed!
      */
      WithStatement(const WithStatement&);
    ...
    public:
      ...
      */
      expression::Expression* getObject() const;
      ...
      */
      void setObject(expression::Expression *node);
