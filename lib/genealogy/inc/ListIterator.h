...
#ifndef _GENEALOGY_ListIterator_H_
#define _GENEALOGY_ListIterator_H_
  ...
  */
  ...
  class ListIteratorBase {
    ...
    public:
      ...
      * \param otherIt                           [in] The other ListIteratorBase which initializes this one.
      * \throw GenealogyInvalidIteratorException If the other iterator is invalid GenealogyInvalidIteratorException is thrown.
      ...
      * \throw GenealogyInvalidIteratorException If the iterator is invalid GenealogyInvalidIteratorException is thrown.
    ...
    private:
      ...
      * \throw GenealogyNoSuchElementException   If the iteration has no next element GenealogyNoSuchElementException is thrown.
      * \throw GenealogyInvalidIteratorException If the iterator is invalid GenealogyInvalidIteratorException is thrown.
      ...
      * \throw GenealogyNoSuchElementException   If the iteration has no previous element GenealogyNoSuchElementException is thrown.
      * \throw GenealogyInvalidIteratorException If the iterator is invalid GenealogyInvalidIteratorException is thrown.
