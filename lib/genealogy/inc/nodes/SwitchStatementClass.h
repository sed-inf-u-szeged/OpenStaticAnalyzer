...
#ifndef _GENEALOGY_SwitchStatementClass_H_
#define _GENEALOGY_SwitchStatementClass_H_

#include "genealogy/inc/genealogy.h"

/**
* \file SwitchStatementClass.h
* \brief Contains declaration of the SwitchStatementClass class.
* \brief The it get atributes from 
*/

namespace columbus { namespace genealogy { 
  /**
  * \brief SwitchStatementClass class, which represents the SwitchStatementClass node.
  * (missing)
  * 
  * Edges:
  *   - items (SwitchStatement, multiple) : (missing)
  */
  class SwitchStatementClass : public StructuralClone {
    protected:
      /**
      * \internal
      ...
      */
      SwitchStatementClass(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~SwitchStatementClass();

    private:
      /**
      * \brief This function always throws a GenealogyException due to copying is not allowed!
      */
      SwitchStatementClass & operator=(const SwitchStatementClass&);

      /**
      * \brief This function always throws a GenealogyException due to copying is not allowed!
      */
      SwitchStatementClass(const SwitchStatementClass&);
    ...
    public:
      ...
      */
      ListIterator<SwitchStatement> getItemsListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the items edges.
      * \return Returns an iterator for the items edges.
      */
      ListIterator<SwitchStatement> getItemsListIteratorEnd() const;
      ...
      */
      void addItems(const SwitchStatement *node);
      ...
      */
      void removeItems(SwitchStatement *node);
    ...
    protected:
      ...
      ListIterator<SwitchStatement>::Container itemsContainer;
