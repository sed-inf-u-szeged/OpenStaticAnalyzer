...
/**
* \file Base.h
* \brief Contains declaration of the base::Base class.
...
namespace base {
  ...
  /**
  * \brief Base class, which represents the base::Base node.
  * (missing)
  * 
  * Attributes:
  *   - id (int) : (missing)
  */
  class Base  {
    ...
    protected:
      ...
      */
      void setParentEdge(const base::Base *childNode,EdgeKind) const ;
      ...
      * \param childNode [in] The node whose parent is removed.
      */
      void removeParentEdge(base::Base *childNode) const ;
      ...
      */
      void setParent(const base::Base* parentNode,EdgeKind edgeKind) const;
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Base& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      bool setEdge(EdgeKind edgeKind, base::Base* edgeEnd);
      ...
      * \return Return true if setting was success.
      */
      bool setEdge(EdgeKind edgeKind, base::Base* edgeEnd, const std::string& acValue);
      ...
      * \return Return true if setting was success.
      */
      bool setEdge(EdgeKind edgeKind, base::Base* edgeEnd, TypeArgumentConstraintKind acValue);
      ...
      * \return Return true if setting was success.
      */
      bool setEdge(EdgeKind edgeKind, base::Base* edgeEnd, const SourcePosition& acValue);
      ...
      * \return Return true if setting was success.
      */
      bool setEdge(EdgeKind edgeKind, base::Base* edgeEnd, ParameterKind acValue);
    ...
    public:
      ...
      */
      bool removeEdge(EdgeKind edgeKind, base::Base* edgeEnd);
