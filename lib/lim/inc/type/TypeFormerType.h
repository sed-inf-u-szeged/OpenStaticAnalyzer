...
#ifndef _LIM_TypeFormerType_H_
#define _LIM_TypeFormerType_H_

#include "lim/inc/lim.h"

/**
* \file TypeFormerType.h
* \brief Contains declaration of the type::TypeFormerType class.
...
namespace type {
  ...
  /**
  * \brief TypeFormerType class, which represents the type::TypeFormerType node.
  * (missing)
  * 
  * Edges:
  *   - refersTo (base::Base, single) : (missing)
  */
  class TypeFormerType : public TypeFormer {
    protected:
      /**
      * \internal
      ...
      */
      TypeFormerType(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeFormerType();

    private:
      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      TypeFormerType & operator=(const TypeFormerType&);

      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      TypeFormerType(const TypeFormerType&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const TypeFormerType& other, bool tryOnVirtualParent);
