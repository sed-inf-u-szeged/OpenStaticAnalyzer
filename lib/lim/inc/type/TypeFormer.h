...
#ifndef _LIM_TypeFormer_H_
#define _LIM_TypeFormer_H_

#include "lim/inc/lim.h"

/**
* \file TypeFormer.h
* \brief Contains declaration of the type::TypeFormer class.
...
namespace type {
  ...
  /**
  * \brief TypeFormer class, which represents the type::TypeFormer node.
  * (missing)
  */
  class TypeFormer : public base::Base {
    protected:
      /**
      * \internal
      ...
      */
      TypeFormer(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      TypeFormer & operator=(const TypeFormer&);

      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      TypeFormer(const TypeFormer&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const TypeFormer& other, bool tryOnVirtualParent);
