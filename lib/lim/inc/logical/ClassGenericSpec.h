...
#ifndef _LIM_ClassGenericSpec_H_
#define _LIM_ClassGenericSpec_H_

#include "lim/inc/lim.h"

/**
* \file ClassGenericSpec.h
* \brief Contains declaration of the logical::ClassGenericSpec class.
...
namespace logical {
  ...
  /**
  * \brief ClassGenericSpec class, which represents the logical::ClassGenericSpec node.
  * (missing)
  * 
  * Edges:
  *   - hasArguments (type::Type, multiple) : (missing)
  *   - specialize (logical::ClassGeneric, single) : (missing)
  */
  class ClassGenericSpec : public ClassGeneric {
    protected:
      /**
      * \internal
      ...
      */
      ClassGenericSpec(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ClassGenericSpec();

    private:
      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      ClassGenericSpec & operator=(const ClassGenericSpec&);

      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      ClassGenericSpec(const ClassGenericSpec&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ClassGenericSpec& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      logical::ClassGeneric* getSpecialize() const;
      ...
      */
      void setSpecialize(ClassGeneric *node);
