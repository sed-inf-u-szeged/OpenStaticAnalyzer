...
#ifndef _LIM_MethodGeneric_H_
#define _LIM_MethodGeneric_H_

#include "lim/inc/lim.h"

/**
* \file MethodGeneric.h
* \brief Contains declaration of the logical::MethodGeneric class.
...
namespace logical {
  ...
  /**
  * \brief MethodGeneric class, which represents the logical::MethodGeneric node.
  * (missing)
  * 
  * Edges:
  *   - hasGenericParameter (logical::GenericParameter, multiple) : (missing)
  */
  class MethodGeneric : public Method {
    protected:
      /**
      * \internal
