...
#ifndef _LIM_ClassGenericInstance_H_
#define _LIM_ClassGenericInstance_H_

#include "lim/inc/lim.h"

/**
* \file ClassGenericInstance.h
* \brief Contains declaration of the logical::ClassGenericInstance class.
...
namespace logical {
  ...
  /**
  * \brief ClassGenericInstance class, which represents the logical::ClassGenericInstance node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class ClassGenericInstance : public Class {
    protected:
      /**
      * \internal
      ...
      */
      ClassGenericInstance(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ClassGenericInstance();

    private:
      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      ClassGenericInstance & operator=(const ClassGenericInstance&);

      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      ClassGenericInstance(const ClassGenericInstance&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ClassGenericInstance& other, bool tryOnVirtualParent);
