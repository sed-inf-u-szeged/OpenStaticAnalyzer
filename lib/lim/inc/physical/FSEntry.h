...
#ifndef _LIM_FSEntry_H_
#define _LIM_FSEntry_H_

#include "lim/inc/lim.h"

/**
* \file FSEntry.h
* \brief Contains declaration of the physical::FSEntry class.
...
namespace physical {
  ...
  /**
  * \brief FSEntry class, which represents the physical::FSEntry node.
  * (missing)
  */
  class FSEntry : public base::Named {
    protected:
      /**
      * \internal
      ...
      */
      FSEntry(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      FSEntry & operator=(const FSEntry&);

      /**
      * \brief This function always throws a LimException due to copying is not allowed!
      */
      FSEntry(const FSEntry&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const FSEntry& other, bool tryOnVirtualParent);
