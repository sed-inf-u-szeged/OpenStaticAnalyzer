...
#ifndef _LIM_ListIterator_H_
#define _LIM_ListIterator_H_
  ...
  */
  ...
  class ListIteratorBase {
    ...
    private:
      ...
      * \throw LimNoSuchElementException   If the iteration has no next element LimNoSuchElementException is thrown.
      * \throw LimInvalidIteratorException If the iterator is invalid LimInvalidIteratorException is thrown.
      ...
      * \throw LimNoSuchElementException   If the iteration has no previous element LimNoSuchElementException is thrown.
      * \throw LimInvalidIteratorException If the iterator is invalid LimInvalidIteratorException is thrown.
