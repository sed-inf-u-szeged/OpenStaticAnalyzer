...
#ifndef _LIM_VISITORSIMPLEEDGE_H_
#define _LIM_VISITORSIMPLEEDGE_H_
  ...
  */
  class VisitorSimpleEdge: public Visitor {
    public:
      ...
      */
      virtual void visitAllEdge(const base::Base& begin, const base::Base& end,const void* ac, AssocClassType kind) = 0;
      ...
      * \param kind  [in] The kind of the association class.
      */
      virtual void visitAllEdgeEnd(const base::Base& begin, const base::Base& end,const void* ac, AssocClassType kind) = 0;
