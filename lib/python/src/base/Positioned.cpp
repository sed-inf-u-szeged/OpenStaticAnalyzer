...
namespace base { 
  ...
  int Positioned::compareByPosition(const Positioned& other) const {
    ...
    if (m_position.posInfo.line != other.m_position.posInfo.line) {
      return (m_position.posInfo.line < other.m_position.posInfo.line) ? -1 :1 ;
    };
    if (m_position.posInfo.col != other.m_position.posInfo.col) {
      return (m_position.posInfo.col < other.m_position.posInfo.col) ? -1 :1 ;
    };
    if (m_position.posInfo.endLine != other.m_position.posInfo.endLine) {
      return (m_position.posInfo.endLine > other.m_position.posInfo.endLine) ? -1 :1 ;
    };
    if (m_position.posInfo.endCol != other.m_position.posInfo.endCol) {
      return (m_position.posInfo.endCol > other.m_position.posInfo.endCol) ? -1 :1 ;
    };
