...
namespace columbus { namespace python { namespace asg {
  ...
  template class ListIterator<expression::Keyword>;
  template class ListIterator<expression::Generator>;
  template class ListIterator<expression::KeyValue>;
  template class ListIterator<expression::Expression>;
  template class ListIterator<expression::Slicing>;
  template class ListIterator<module::Object>;
  template class ListIterator<statement::Parameter>;
  template class ListIterator<base::Positioned>;
  template class ListIterator<type::Type>;
  template class ListIterator<module::Module>;
  template class ListIterator<module::Package>;
  template class ListIterator<statement::BaseSpecifier>;
