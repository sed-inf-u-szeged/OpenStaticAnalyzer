  ...
  class Base  {
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the originKind of the node.
      * \return Returns with the originKind.
      */
      OriginKind getOriginKind() const;
      ...
      */
      ...
      /**
      * \internal
      * \brief Sets the originKind of the node.
      * \param originKind [in] The new value of the originKind.
      */
      void setOriginKind(OriginKind _originKind);
    ...
    protected:
      ...
      /** \internal \brief The id of the `id`. */
      NodeId m_id;

      /** \internal \brief The OriginKind of the node. */
      OriginKind m_originKind;
