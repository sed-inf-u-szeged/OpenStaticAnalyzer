...
#ifndef _PYTHON_NamedExpr_H_
#define _PYTHON_NamedExpr_H_

#include "python/inc/python.h"

/**
* \file NamedExpr.h
* \brief Contains declaration of the expression::NamedExpr class.
...
namespace expression {
  ...
  /**
  * \brief NamedExpr class, which represents the expression::NamedExpr node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class NamedExpr : public Expression {
    protected:
      ...
      */
      NamedExpr(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      NamedExpr & operator=(const NamedExpr&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      NamedExpr(const NamedExpr&);
