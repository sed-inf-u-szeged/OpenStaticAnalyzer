...
#ifndef _PYTHON_FloatNumber_H_
#define _PYTHON_FloatNumber_H_

#include "python/inc/python.h"

/**
* \file FloatNumber.h
* \brief Contains declaration of the expression::FloatNumber class.
...
namespace expression {
  ...
  /**
  * \brief FloatNumber class, which represents the expression::FloatNumber node.
  * (missing)
  * 
  * Attributes:
  *   - value (double) : (missing)
  */
  class FloatNumber : public Literal {
    protected:
      /**
      * \internal
      ...
      */
      FloatNumber(NodeId nodeId, Factory *factory);
