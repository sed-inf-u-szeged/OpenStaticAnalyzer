...
#ifndef _PYTHON_Await_H_
#define _PYTHON_Await_H_

#include "python/inc/python.h"

/**
* \file Await.h
* \brief Contains declaration of the expression::Await class.
...
namespace expression {
  ...
  /**
  * \brief Await class, which represents the expression::Await node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Await : public Expression {
    protected:
      ...
      */
      Await(NodeId nodeId, Factory *factory);
