...
#ifndef _PYTHON_StringConversion_H_
#define _PYTHON_StringConversion_H_

#include "python/inc/python.h"

/**
* \file StringConversion.h
* \brief Contains declaration of the expression::StringConversion class.
...
namespace expression {
  ...
  /**
  * \brief StringConversion class, which represents the expression::StringConversion node.
  * (missing)
  * 
  * Edges:
  *   - hasExpressionList (expression::ExpressionList, single) : (missing)
  */
  class StringConversion : public Expression {
    protected:
      /**
      * \internal
      ...
      */
      StringConversion(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      StringConversion & operator=(const StringConversion&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      StringConversion(const StringConversion&);
    ...
    public:
      ...
      */
      void setExpressionList(ExpressionList *node);
