...
#ifndef _PYTHON_LongInteger_H_
#define _PYTHON_LongInteger_H_

#include "python/inc/python.h"

/**
* \file LongInteger.h
* \brief Contains declaration of the expression::LongInteger class.
...
namespace expression {
  ...
  /**
  * \brief LongInteger class, which represents the expression::LongInteger node.
  * (missing)
  * 
  * Attributes:
  *   - value (int) : (missing)
  */
  class LongInteger : public Literal {
    protected:
      /**
      * \internal
      ...
      */
      LongInteger(NodeId nodeId, Factory *factory);
