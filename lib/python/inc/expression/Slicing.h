...
#ifndef _PYTHON_Slicing_H_
#define _PYTHON_Slicing_H_

#include "python/inc/python.h"

/**
* \file Slicing.h
* \brief Contains declaration of the expression::Slicing class.
...
namespace expression {
  ...
  /**
  * \brief Slicing class, which represents the expression::Slicing node.
  * (missing)
  */
  class Slicing : public Unary {
    protected:
      /**
      * \internal
      ...
      */
      Slicing(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      Slicing & operator=(const Slicing&);
