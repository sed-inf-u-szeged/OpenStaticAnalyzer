...
/**
* \file List.h
* \brief Contains declaration of the expression::List class.
...
namespace expression {
  ...
  /**
  * \brief List class, which represents the expression::List node.
  * (missing)
  * 
  * Attributes:
  *   - isTuple (boolean) : (missing)
  * 
  * Edges:
  ...
  */
  class List : public Expression {
    protected:
      ...
      */
      List(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the isTuple of the node.
      * \return Returns with the isTuple.
      */
      bool getIsTuple() const;
      ...
      /**
      * \internal
      * \brief Sets the isTuple of the node.
      * \param isTuple [in] The new value of the isTuple.
      */
      void setIsTuple(bool _isTuple);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief Stores whether the node is `Tuple` or not. */
      bool m_isTuple : 1;
