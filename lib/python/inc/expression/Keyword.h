...
#ifndef _PYTHON_Keyword_H_
#define _PYTHON_Keyword_H_

#include "python/inc/python.h"

/**
* \file Keyword.h
* \brief Contains declaration of the expression::Keyword class.
...
namespace expression {
  ...
  /**
  * \brief Keyword class, which represents the expression::Keyword node.
  * (missing)
  * 
  * Edges:
  *   - hasKey (expression::Identifier, single) : (missing)
  *   - hasValue (expression::Expression, single) : (missing)
  */
  class Keyword : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      Keyword(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      expression::Identifier* getKey() const;
