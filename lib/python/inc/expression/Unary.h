...
#ifndef _PYTHON_Unary_H_
#define _PYTHON_Unary_H_

#include "python/inc/python.h"

/**
* \file Unary.h
* \brief Contains declaration of the expression::Unary class.
...
namespace expression {
  ...
  /**
  * \brief Unary class, which represents the expression::Unary node.
  * (missing)
  * 
  * Edges:
