...
#ifndef _PYTHON_Starred_H_
#define _PYTHON_Starred_H_

#include "python/inc/python.h"

/**
* \file Starred.h
* \brief Contains declaration of the expression::Starred class.
...
namespace expression {
  ...
  /**
  * \brief Starred class, which represents the expression::Starred node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Starred : public Expression {
    protected:
      ...
      */
      Starred(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      Starred & operator=(const Starred&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      Starred(const Starred&);
