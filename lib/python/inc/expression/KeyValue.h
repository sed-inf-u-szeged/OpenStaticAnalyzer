...
#ifndef _PYTHON_KeyValue_H_
#define _PYTHON_KeyValue_H_

#include "python/inc/python.h"

/**
* \file KeyValue.h
* \brief Contains declaration of the expression::KeyValue class.
...
namespace expression {
  ...
  /**
  * \brief KeyValue class, which represents the expression::KeyValue node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class KeyValue : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      KeyValue(NodeId nodeId, Factory *factory);
