...
#ifndef _PYTHON_ExpressionList_H_
#define _PYTHON_ExpressionList_H_

#include "python/inc/python.h"

/**
* \file ExpressionList.h
* \brief Contains declaration of the expression::ExpressionList class.
...
namespace expression {
  ...
  /**
  * \brief ExpressionList class, which represents the expression::ExpressionList node.
  * (missing)
  * 
  * Attributes:
  *   - isYieldExpression (boolean) : (missing)
  * 
  * Edges:
  ...
  */
  class ExpressionList : public Expression {
    protected:
      ...
      */
      ExpressionList(NodeId nodeId, Factory *factory);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the isYieldExpression of the node.
      * \return Returns with the isYieldExpression.
      */
      bool getIsYieldExpression() const;
      ...
      /**
      * \internal
      * \brief Sets the isYieldExpression of the node.
      * \param isYieldExpression [in] The new value of the isYieldExpression.
      */
      void setIsYieldExpression(bool _isYieldExpression);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief Stores whether the node is `YieldExpression` or not. */
      bool m_isYieldExpression : 1;
