...
#ifndef _PYTHON_IntegerLiteral_H_
#define _PYTHON_IntegerLiteral_H_

#include "python/inc/python.h"

/**
* \file IntegerLiteral.h
* \brief Contains declaration of the expression::IntegerLiteral class.
...
namespace expression {
  ...
  /**
  * \brief IntegerLiteral class, which represents the expression::IntegerLiteral node.
  * (missing)
  * 
  * Attributes:
  *   - value (int) : (missing)
