  ...
  class VisitorPYTHONML : public Visitor {
    public:
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::Await node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::Await& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::Await node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::BytesLiteral node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::BytesLiteral& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::BytesLiteral node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::FormattedValue node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::FormattedValue& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::FormattedValue node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::JoinedStr node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::JoinedStr& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::JoinedStr node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::NamedExpr node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::NamedExpr& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::NamedExpr node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the expression::Starred node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::Starred& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the expression::Starred node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the statement::AnnAssign node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::AnnAssign& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the statement::AnnAssign node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the statement::Nonlocal node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::Nonlocal& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the statement::Nonlocal node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the statement::Try node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::Try& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the statement::Try node into the output file.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Writes the XML representation of the statement::WithItem node into the output file.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::WithItem& node, bool callVirtualBase = true);

      /**
      * \brief Writes the end part of XML representation of the statement::WithItem node into the output file.
      * \param node [in] The node which is visited.
      */
    ...
    protected:
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::Await node.
      */
      virtual void writeAttributes(const expression::Await& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::BytesLiteral node.
      */
      virtual void writeAttributes(const expression::BytesLiteral& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::FormattedValue node.
      */
      virtual void writeAttributes(const expression::FormattedValue& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::JoinedStr node.
      */
      virtual void writeAttributes(const expression::JoinedStr& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::NamedExpr node.
      */
      virtual void writeAttributes(const expression::NamedExpr& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the expression::Starred node.
      */
      virtual void writeAttributes(const expression::Starred& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the statement::AnnAssign node.
      */
      virtual void writeAttributes(const statement::AnnAssign& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the statement::Nonlocal node.
      */
      virtual void writeAttributes(const statement::Nonlocal& node, bool composite, bool bWithParent = true);
      ...
      */
      ...
      /**
      * \internal
      * \brief Writes out the attributes of the statement::WithItem node.
      */
      virtual void writeAttributes(const statement::WithItem& node, bool composite, bool bWithParent = true);
