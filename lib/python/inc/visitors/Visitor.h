  ...
  class Visitor {
    public:
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::Await node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::Await& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::Await node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::BytesLiteral node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::BytesLiteral& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::BytesLiteral node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::FormattedValue node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::FormattedValue& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::FormattedValue node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::JoinedStr node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::JoinedStr& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::JoinedStr node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::NamedExpr node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::NamedExpr& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::NamedExpr node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::Starred node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::Starred& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::Starred node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::AnnAssign node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::AnnAssign& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::AnnAssign node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::Nonlocal node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::Nonlocal& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::Nonlocal node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::Try node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::Try& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::Try node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::WithItem node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::WithItem& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::WithItem node visiting.
      * \param node [in] The node which is visited.
      */
