...
#ifndef _PYTHON_Break_H_
#define _PYTHON_Break_H_

#include "python/inc/python.h"

/**
* \file Break.h
* \brief Contains declaration of the statement::Break class.
...
namespace statement {
  ...
  /**
  * \brief Break class, which represents the statement::Break node.
  * (missing)
  */
