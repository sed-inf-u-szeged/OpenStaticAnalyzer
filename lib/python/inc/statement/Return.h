...
#ifndef _PYTHON_Return_H_
#define _PYTHON_Return_H_

#include "python/inc/python.h"

/**
* \file Return.h
* \brief Contains declaration of the statement::Return class.
...
namespace statement {
  ...
  /**
  * \brief Return class, which represents the statement::Return node.
  * (missing)
  * 
  * Edges:
