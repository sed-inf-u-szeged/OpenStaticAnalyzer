...
#ifndef _PYTHON_While_H_
#define _PYTHON_While_H_

#include "python/inc/python.h"

/**
* \file While.h
* \brief Contains declaration of the statement::While class.
...
namespace statement {
  ...
  /**
  * \brief While class, which represents the statement::While node.
  * (missing)
  * 
  * Edges:
