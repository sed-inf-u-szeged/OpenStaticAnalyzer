...
#ifndef _PYTHON_AnnAssign_H_
#define _PYTHON_AnnAssign_H_

#include "python/inc/python.h"

/**
* \file AnnAssign.h
* \brief Contains declaration of the statement::AnnAssign class.
...
namespace statement {
  ...
  /**
  * \brief AnnAssign class, which represents the statement::AnnAssign node.
  * (missing)
  * 
  * Attributes:
  *   - isSimple (boolean) : (missing)
  * 
  * Edges:
  *   - hasAnnotation (expression::Expression, single) : (missing)
  */
  class AnnAssign : public Assign {
    protected:
      /**
      * \internal
      ...
      */
      AnnAssign(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      AnnAssign & operator=(const AnnAssign&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      AnnAssign(const AnnAssign&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the isSimple of the node.
      * \return Returns with the isSimple.
      */
      ...
      /**
      * \internal
      * \brief Sets the isSimple of the node.
      * \param isSimple [in] The new value of the isSimple.
      */
      void setIsSimple(bool _isSimple);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief Stores whether the node is `Simple` or not. */
      bool m_isSimple : 1;
