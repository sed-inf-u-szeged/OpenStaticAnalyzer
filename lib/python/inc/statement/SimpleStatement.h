...
#ifndef _PYTHON_SimpleStatement_H_
#define _PYTHON_SimpleStatement_H_

#include "python/inc/python.h"

/**
* \file SimpleStatement.h
* \brief Contains declaration of the statement::SimpleStatement class.
...
namespace statement {
  ...
  /**
  * \brief SimpleStatement class, which represents the statement::SimpleStatement node.
  * (missing)
  */
  class SimpleStatement : public Statement {
    protected:
      ...
      */
      SimpleStatement(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      SimpleStatement & operator=(const SimpleStatement&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      SimpleStatement(const SimpleStatement&);
