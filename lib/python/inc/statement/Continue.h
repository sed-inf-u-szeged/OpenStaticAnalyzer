...
#ifndef _PYTHON_Continue_H_
#define _PYTHON_Continue_H_

#include "python/inc/python.h"

/**
* \file Continue.h
* \brief Contains declaration of the statement::Continue class.
...
namespace statement {
  ...
  /**
  * \brief Continue class, which represents the statement::Continue node.
  * (missing)
  */
