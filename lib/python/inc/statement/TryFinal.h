...
#ifndef _PYTHON_TryFinal_H_
#define _PYTHON_TryFinal_H_

#include "python/inc/python.h"

/**
* \file TryFinal.h
* \brief Contains declaration of the statement::TryFinal class.
...
namespace statement {
  ...
  /**
  * \brief TryFinal class, which represents the statement::TryFinal node.
  * (missing)
  * 
  * Edges:
  *   - hasFinallyBody (statement::Suite, single) : (missing)
  */
  class TryFinal : public Try {
    protected:
      /**
      * \internal
      ...
      */
      TryFinal(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      TryFinal & operator=(const TryFinal&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      TryFinal(const TryFinal&);
