...
#ifndef _PYTHON_Delete_H_
#define _PYTHON_Delete_H_

#include "python/inc/python.h"

/**
* \file Delete.h
* \brief Contains declaration of the statement::Delete class.
...
namespace statement {
  ...
  /**
  * \brief Delete class, which represents the statement::Delete node.
  * (missing)
  * 
  * Edges:
  *   - hasTargetList (statement::TargetList, single) : (missing)
  */
  class Delete : public SimpleStatement {
    protected:
      /**
      * \internal
      ...
      */
      Delete(NodeId nodeId, Factory *factory);
