...
#ifndef _PYTHON_Iteration_H_
#define _PYTHON_Iteration_H_

#include "python/inc/python.h"

/**
* \file Iteration.h
* \brief Contains declaration of the statement::Iteration class.
...
namespace statement {
  ...
  /**
  * \brief Iteration class, which represents the statement::Iteration node.
  * (missing)
  * 
  * Edges:
  *   - hasElseBody (statement::Suite, single) : (missing)
  */
  class Iteration : public CompoundStatement {
    protected:
      /**
      * \internal
