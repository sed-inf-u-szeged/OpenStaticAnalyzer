...
#ifndef _PYTHON_Global_H_
#define _PYTHON_Global_H_

#include "python/inc/python.h"

/**
* \file Global.h
* \brief Contains declaration of the statement::Global class.
...
namespace statement {
  ...
  /**
  * \brief Global class, which represents the statement::Global node.
  * (missing)
  * 
  * Edges:
  *   - hasIdentifier (expression::Identifier, multiple) : (missing)
  */
  class Global : public SimpleStatement {
    protected:
      /**
      * \internal
      ...
      */
      Global(NodeId nodeId, Factory *factory);
