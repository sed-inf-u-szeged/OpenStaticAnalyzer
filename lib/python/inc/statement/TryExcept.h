...
#ifndef _PYTHON_TryExcept_H_
#define _PYTHON_TryExcept_H_

#include "python/inc/python.h"

/**
* \file TryExcept.h
* \brief Contains declaration of the statement::TryExcept class.
...
namespace statement {
  ...
  /**
  * \brief TryExcept class, which represents the statement::TryExcept node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class TryExcept : public Try {
    protected:
      ...
      */
      TryExcept(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      TryExcept & operator=(const TryExcept&);

      /**
      * \brief This function always throws a PythonException due to copying is not allowed!
      */
      TryExcept(const TryExcept&);
