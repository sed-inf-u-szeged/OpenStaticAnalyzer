...
#ifndef _PYTHON_DictType_H_
#define _PYTHON_DictType_H_

#include "python/inc/python.h"

/**
* \file DictType.h
* \brief Contains declaration of the type::DictType class.
...
namespace type {
  ...
  /**
  * \brief DictType class, which represents the type::DictType node.
  * (missing)
  */
  class DictType : public Type {
    protected:
      ...
      */
      DictType(NodeId nodeId, Factory *factory);
