...
#ifndef _PYTHON_ReferenceType_H_
#define _PYTHON_ReferenceType_H_

#include "python/inc/python.h"

/**
* \file ReferenceType.h
* \brief Contains declaration of the type::ReferenceType class.
...
namespace type {
  ...
  /**
  * \brief ReferenceType class, which represents the type::ReferenceType node.
  * (missing)
  * 
  * Attributes:
  *   - name (String) : (missing)
  ...
  */
  class ReferenceType : public Type {
    protected:
      ...
      */
      ReferenceType(NodeId nodeId, Factory *factory);
