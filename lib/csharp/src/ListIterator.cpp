...
namespace columbus { namespace csharp { namespace asg {
  ...
  ListIteratorBase<B,T>& ListIteratorBase<B,T>::operator=(const ListIteratorBase& otherIt) {
    ...
    if (otherIt.invalid)
      throw CsharpInvalidIteratorException(COLUMBUS_LOCATION, CMSG_EX_THE_ITERATOR_IS_INVALID);
  ...
  template class ListIterator<structure::AnonymousObjectMemberDeclaratorSyntax>;
  template class ListIterator<structure::ArrayRankSpecifierSyntax>;
  template class ListIterator<structure::AccessorDeclarationSyntax>;
  template class ListIterator<expression::ExpressionSyntax>;
  template class ListIterator<structure::InterpolatedStringContentSyntax>;
  template class ListIterator<structure::SwitchExpressionArmSyntax>;
  template class ListIterator<structure::ArgumentSyntax>;
  template class ListIterator<structure::TupleElementSyntax>;
  template class ListIterator<statement::StatementSyntax>;
  template class ListIterator<structure::TypeParameterConstraintClauseSyntax>;
  template class ListIterator<structure::AttributeListSyntax>;
  template class ListIterator<structure::SwitchSectionSyntax>;
  template class ListIterator<structure::CatchClauseSyntax>;
  template class ListIterator<structure::AttributeArgumentSyntax>;
  template class ListIterator<structure::AttributeSyntax>;
  template class ListIterator<structure::CrefParameterSyntax>;
  template class ListIterator<structure::BaseTypeSyntax>;
  template class ListIterator<structure::EnumMemberDeclarationSyntax>;
  template class ListIterator<structure::ParameterSyntax>;
  template class ListIterator<structure::ExternAliasDirectiveSyntax>;
  template class ListIterator<structure::MemberDeclarationSyntax>;
  template class ListIterator<structure::UsingDirectiveSyntax>;
  template class ListIterator<structure::OrderingSyntax>;
  template class ListIterator<structure::VariableDesignationSyntax>;
  template class ListIterator<structure::SubpatternSyntax>;
  template class ListIterator<structure::QueryClauseSyntax>;
  template class ListIterator<structure::SwitchLabelSyntax>;
  template class ListIterator<expression::TypeSyntax>;
  template class ListIterator<structure::TypeParameterConstraintSyntax>;
  template class ListIterator<structure::TypeParameterSyntax>;
  template class ListIterator<structure::VariableDeclaratorSyntax>;
  template class ListIterator<structure::XmlAttributeSyntax>;
  template class ListIterator<structure::XmlNodeSyntax>;
