...
namespace columbus { namespace csharp { namespace asg {
  ...
  namespace expression {
    ...
    class ImplicitStackAllocArrayCreationExpressionSyntax;
  ...
  namespace statement {
    ...
    class CommonForEachStatementSyntax;
    ...
    class LocalFunctionStatementSyntax;
  ...
  namespace structure {
    ...
    class ParenthesizedVariableDesignationSyntax;
    class PatternSyntax;
    class PositionalPatternClauseSyntax;
    ...
    class SingleVariableDesignationSyntax;
    ...
    class VariableDesignationSyntax;
