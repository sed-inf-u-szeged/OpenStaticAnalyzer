  ...
  class Visitor {
    public:
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::DeclarationExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::DeclarationExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::DeclarationExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::ImplicitStackAllocArrayCreationExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::ImplicitStackAllocArrayCreationExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::ImplicitStackAllocArrayCreationExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::IsPatternExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::IsPatternExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::IsPatternExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::RangeExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::RangeExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::RangeExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const expression::RangeExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the expression::RefExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::RefExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::RefExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::RefTypeSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::RefTypeSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::RefTypeSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::SwitchExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::SwitchExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::SwitchExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the expression::ThrowExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::ThrowExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::ThrowExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const expression::ThrowExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the expression::TupleExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::TupleExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::TupleExpressionSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const expression::TupleExpressionSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the expression::TupleTypeSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const expression::TupleTypeSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the expression::TupleTypeSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::ForEachVariableStatementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::ForEachVariableStatementSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::ForEachVariableStatementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the statement::LocalFunctionStatementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const statement::LocalFunctionStatementSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the statement::LocalFunctionStatementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::CasePatternSwitchLabelSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::CasePatternSwitchLabelSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::CasePatternSwitchLabelSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::ConstantPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::ConstantPatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::ConstantPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::DeclarationPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::DeclarationPatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::DeclarationPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::DiscardDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::DiscardDesignationSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::DiscardDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const structure::DiscardDesignationSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the structure::DiscardPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::DiscardPatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::DiscardPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::ParenthesizedVariableDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::ParenthesizedVariableDesignationSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::ParenthesizedVariableDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const structure::ParenthesizedVariableDesignationSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the structure::PositionalPatternClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::PositionalPatternClauseSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::PositionalPatternClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::PropertyPatternClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::PropertyPatternClauseSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::PropertyPatternClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::RecursivePatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::RecursivePatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::RecursivePatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::SingleVariableDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::SingleVariableDesignationSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::SingleVariableDesignationSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::SubpatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::SubpatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::SubpatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visitEnd(const structure::SubpatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the beginning of the structure::SwitchExpressionArmSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::SwitchExpressionArmSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::SwitchExpressionArmSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::TupleElementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::TupleElementSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::TupleElementSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::VarPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::VarPatternSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::VarPatternSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      ...
      */
      ...
      /**
      * \brief Visitor which is called at the beginning of the structure::WhenClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
      virtual void visit(const structure::WhenClauseSyntax& node , bool callVirtualBase = true);

      /**
      * \brief Visitor which is called at the end of the structure::WhenClauseSyntax node visiting.
      * \param node [in] The node which is visited.
      */
