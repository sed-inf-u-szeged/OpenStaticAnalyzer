...
#ifndef _CSHARP_FixedStatementSyntax_H_
#define _CSHARP_FixedStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file FixedStatementSyntax.h
* \brief Contains declaration of the statement::FixedStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief FixedStatementSyntax class, which represents the statement::FixedStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class FixedStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      FixedStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~FixedStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FixedStatementSyntax & operator=(const FixedStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FixedStatementSyntax(const FixedStatementSyntax&);
