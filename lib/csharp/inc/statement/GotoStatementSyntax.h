...
#ifndef _CSHARP_GotoStatementSyntax_H_
#define _CSHARP_GotoStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file GotoStatementSyntax.h
* \brief Contains declaration of the statement::GotoStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief GotoStatementSyntax class, which represents the statement::GotoStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class GotoStatementSyntax : public StatementSyntax {
    protected:
      ...
      */
      GotoStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~GotoStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      GotoStatementSyntax & operator=(const GotoStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      GotoStatementSyntax(const GotoStatementSyntax&);
