...
#ifndef _CSHARP_IfStatementSyntax_H_
#define _CSHARP_IfStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file IfStatementSyntax.h
* \brief Contains declaration of the statement::IfStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief IfStatementSyntax class, which represents the statement::IfStatementSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Condition (expression::ExpressionSyntax, single) : (missing)
  *   - Else (structure::ElseClauseSyntax, single) : (missing)
  ...
  */
  class IfStatementSyntax : public StatementSyntax {
    protected:
      ...
      */
      IfStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~IfStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IfStatementSyntax & operator=(const IfStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IfStatementSyntax(const IfStatementSyntax&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the pointer of the node the Else edge points to.
      * \return Returns the end point of the Else edge.
      */
      structure::ElseClauseSyntax* getElse() const;
      ...
      */
      ...
      /**
      * \brief Sets the Else edge.
      * \param id [in] The new end point of the Else edge.
      */
      void setElse(NodeId id);

      /**
      * \brief Sets the Else edge.
      * \param node [in] The new end point of the Else edge.
      */
      void setElse(structure::ElseClauseSyntax *node);

      /**
      * \brief remove the Else edge.
      */
      void removeElse();
    ...
    protected:
      ...
      /** \internal \brief The id of the node the Else edge points to. */
      NodeId m_Else;
