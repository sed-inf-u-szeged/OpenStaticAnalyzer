...
#ifndef _CSHARP_CheckedStatementSyntax_H_
#define _CSHARP_CheckedStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CheckedStatementSyntax.h
* \brief Contains declaration of the statement::CheckedStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief CheckedStatementSyntax class, which represents the statement::CheckedStatementSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Block (statement::BlockSyntax, single) : (missing)
  */
  class CheckedStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      CheckedStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~CheckedStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CheckedStatementSyntax & operator=(const CheckedStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CheckedStatementSyntax(const CheckedStatementSyntax&);
