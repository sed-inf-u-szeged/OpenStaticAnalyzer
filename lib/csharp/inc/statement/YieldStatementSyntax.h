...
#ifndef _CSHARP_YieldStatementSyntax_H_
#define _CSHARP_YieldStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file YieldStatementSyntax.h
* \brief Contains declaration of the statement::YieldStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief YieldStatementSyntax class, which represents the statement::YieldStatementSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class YieldStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      YieldStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~YieldStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      YieldStatementSyntax & operator=(const YieldStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      YieldStatementSyntax(const YieldStatementSyntax&);
