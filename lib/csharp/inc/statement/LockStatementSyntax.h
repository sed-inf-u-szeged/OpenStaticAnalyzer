...
#ifndef _CSHARP_LockStatementSyntax_H_
#define _CSHARP_LockStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file LockStatementSyntax.h
* \brief Contains declaration of the statement::LockStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief LockStatementSyntax class, which represents the statement::LockStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class LockStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      LockStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~LockStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LockStatementSyntax & operator=(const LockStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LockStatementSyntax(const LockStatementSyntax&);
