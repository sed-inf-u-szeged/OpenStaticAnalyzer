...
#ifndef _CSHARP_CommonForEachStatementSyntax_H_
#define _CSHARP_CommonForEachStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CommonForEachStatementSyntax.h
* \brief Contains declaration of the statement::CommonForEachStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief CommonForEachStatementSyntax class, which represents the statement::CommonForEachStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class CommonForEachStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      CommonForEachStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~CommonForEachStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CommonForEachStatementSyntax & operator=(const CommonForEachStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CommonForEachStatementSyntax(const CommonForEachStatementSyntax&);
