...
#ifndef _CSHARP_BlockSyntax_H_
#define _CSHARP_BlockSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BlockSyntax.h
* \brief Contains declaration of the statement::BlockSyntax class.
...
namespace statement {
  ...
  /**
  * \brief BlockSyntax class, which represents the statement::BlockSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class BlockSyntax : public StatementSyntax {
    protected:
      ...
      */
      BlockSyntax(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      BlockSyntax & operator=(const BlockSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BlockSyntax(const BlockSyntax&);
    ...
    public:
      ...
      */
      void addStatements(const StatementSyntax *node);
      ...
      */
      void removeStatements(StatementSyntax *node);
