...
#ifndef _CSHARP_LabeledStatementSyntax_H_
#define _CSHARP_LabeledStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file LabeledStatementSyntax.h
* \brief Contains declaration of the statement::LabeledStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief LabeledStatementSyntax class, which represents the statement::LabeledStatementSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class LabeledStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      LabeledStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~LabeledStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LabeledStatementSyntax & operator=(const LabeledStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LabeledStatementSyntax(const LabeledStatementSyntax&);
