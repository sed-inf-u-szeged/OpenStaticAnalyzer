...
#ifndef _CSHARP_LocalDeclarationStatementSyntax_H_
#define _CSHARP_LocalDeclarationStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file LocalDeclarationStatementSyntax.h
* \brief Contains declaration of the statement::LocalDeclarationStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief LocalDeclarationStatementSyntax class, which represents the statement::LocalDeclarationStatementSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Declaration (structure::VariableDeclarationSyntax, single) : (missing)
  */
  class LocalDeclarationStatementSyntax : public StatementSyntax {
    protected:
      /**
      * \internal
      ...
      */
      LocalDeclarationStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~LocalDeclarationStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LocalDeclarationStatementSyntax & operator=(const LocalDeclarationStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LocalDeclarationStatementSyntax(const LocalDeclarationStatementSyntax&);
