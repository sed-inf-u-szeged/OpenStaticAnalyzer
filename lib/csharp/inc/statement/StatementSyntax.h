...
#ifndef _CSHARP_StatementSyntax_H_
#define _CSHARP_StatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file StatementSyntax.h
* \brief Contains declaration of the statement::StatementSyntax class.
  ...
  */
  class StatementSyntax : public base::Positioned {
    protected:
      ...
      */
      StatementSyntax(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      StatementSyntax & operator=(const StatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      StatementSyntax(const StatementSyntax&);
