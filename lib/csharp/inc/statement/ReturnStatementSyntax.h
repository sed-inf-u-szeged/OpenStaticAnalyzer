...
#ifndef _CSHARP_ReturnStatementSyntax_H_
#define _CSHARP_ReturnStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ReturnStatementSyntax.h
* \brief Contains declaration of the statement::ReturnStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief ReturnStatementSyntax class, which represents the statement::ReturnStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ReturnStatementSyntax : public StatementSyntax {
    protected:
      ...
      */
      ReturnStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ReturnStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ReturnStatementSyntax & operator=(const ReturnStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ReturnStatementSyntax(const ReturnStatementSyntax&);
