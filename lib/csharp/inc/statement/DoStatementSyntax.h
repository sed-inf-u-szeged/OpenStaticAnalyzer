...
#ifndef _CSHARP_DoStatementSyntax_H_
#define _CSHARP_DoStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file DoStatementSyntax.h
* \brief Contains declaration of the statement::DoStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief DoStatementSyntax class, which represents the statement::DoStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class DoStatementSyntax : public StatementSyntax {
    protected:
      ...
      */
      DoStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~DoStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      DoStatementSyntax & operator=(const DoStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      DoStatementSyntax(const DoStatementSyntax&);
