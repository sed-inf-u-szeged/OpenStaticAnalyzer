...
#ifndef _CSHARP_ExpressionStatementSyntax_H_
#define _CSHARP_ExpressionStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ExpressionStatementSyntax.h
* \brief Contains declaration of the statement::ExpressionStatementSyntax class.
...
namespace statement {
  ...
  /**
  * \brief ExpressionStatementSyntax class, which represents the statement::ExpressionStatementSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ExpressionStatementSyntax : public StatementSyntax {
    protected:
      ...
      */
      ExpressionStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ExpressionStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ExpressionStatementSyntax & operator=(const ExpressionStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ExpressionStatementSyntax(const ExpressionStatementSyntax&);
