...
#ifndef _CSHARP_CheckedExpressionSyntax_H_
#define _CSHARP_CheckedExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CheckedExpressionSyntax.h
* \brief Contains declaration of the expression::CheckedExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief CheckedExpressionSyntax class, which represents the expression::CheckedExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class CheckedExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      CheckedExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~CheckedExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CheckedExpressionSyntax & operator=(const CheckedExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CheckedExpressionSyntax(const CheckedExpressionSyntax&);
