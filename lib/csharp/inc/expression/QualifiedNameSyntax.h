...
#ifndef _CSHARP_QualifiedNameSyntax_H_
#define _CSHARP_QualifiedNameSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file QualifiedNameSyntax.h
* \brief Contains declaration of the expression::QualifiedNameSyntax class.
...
namespace expression {
  ...
  /**
  * \brief QualifiedNameSyntax class, which represents the expression::QualifiedNameSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Left (expression::NameSyntax, single) : (missing)
  *   - Right (expression::SimpleNameSyntax, single) : (missing)
  */
  class QualifiedNameSyntax : public NameSyntax {
    protected:
      ...
      */
      QualifiedNameSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~QualifiedNameSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      QualifiedNameSyntax & operator=(const QualifiedNameSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      QualifiedNameSyntax(const QualifiedNameSyntax&);
    ...
    public:
      ...
      */
      void setRight(SimpleNameSyntax *node);
