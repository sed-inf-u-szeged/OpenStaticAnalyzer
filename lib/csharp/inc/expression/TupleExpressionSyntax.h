...
#ifndef _CSHARP_TupleExpressionSyntax_H_
#define _CSHARP_TupleExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TupleExpressionSyntax.h
* \brief Contains declaration of the expression::TupleExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief TupleExpressionSyntax class, which represents the expression::TupleExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Arguments (structure::ArgumentSyntax, multiple) : (missing)
  */
  class TupleExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      TupleExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TupleExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TupleExpressionSyntax & operator=(const TupleExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TupleExpressionSyntax(const TupleExpressionSyntax&);
    ...
    public:
      ...
      */
      ListIterator<structure::ArgumentSyntax> getArgumentsListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the Arguments edges.
      * \return Returns an iterator for the Arguments edges.
      */
      ListIterator<structure::ArgumentSyntax> getArgumentsListIteratorEnd() const;
      ...
      */
      void addArguments(const structure::ArgumentSyntax *node);
      ...
      */
      void removeArguments(structure::ArgumentSyntax *node);
    ...
    protected:
      ...
      ListIterator<structure::ArgumentSyntax>::Container ArgumentsContainer;
