...
#ifndef _CSHARP_ImplicitArrayCreationExpressionSyntax_H_
#define _CSHARP_ImplicitArrayCreationExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ImplicitArrayCreationExpressionSyntax.h
* \brief Contains declaration of the expression::ImplicitArrayCreationExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ImplicitArrayCreationExpressionSyntax class, which represents the expression::ImplicitArrayCreationExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Initializer (expression::InitializerExpressionSyntax, single) : (missing)
  */
  class ImplicitArrayCreationExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ImplicitArrayCreationExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ImplicitArrayCreationExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ImplicitArrayCreationExpressionSyntax & operator=(const ImplicitArrayCreationExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ImplicitArrayCreationExpressionSyntax(const ImplicitArrayCreationExpressionSyntax&);
