...
#ifndef _CSHARP_MemberAccessExpressionSyntax_H_
#define _CSHARP_MemberAccessExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file MemberAccessExpressionSyntax.h
* \brief Contains declaration of the expression::MemberAccessExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief MemberAccessExpressionSyntax class, which represents the expression::MemberAccessExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class MemberAccessExpressionSyntax : public ExpressionSyntax {
    protected:
      ...
      */
      MemberAccessExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~MemberAccessExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MemberAccessExpressionSyntax & operator=(const MemberAccessExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MemberAccessExpressionSyntax(const MemberAccessExpressionSyntax&);
