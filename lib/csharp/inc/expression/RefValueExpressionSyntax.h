...
#ifndef _CSHARP_RefValueExpressionSyntax_H_
#define _CSHARP_RefValueExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file RefValueExpressionSyntax.h
* \brief Contains declaration of the expression::RefValueExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief RefValueExpressionSyntax class, which represents the expression::RefValueExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class RefValueExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      RefValueExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~RefValueExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefValueExpressionSyntax & operator=(const RefValueExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefValueExpressionSyntax(const RefValueExpressionSyntax&);
