...
#ifndef _CSHARP_NullableTypeSyntax_H_
#define _CSHARP_NullableTypeSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file NullableTypeSyntax.h
* \brief Contains declaration of the expression::NullableTypeSyntax class.
...
namespace expression {
  ...
  /**
  * \brief NullableTypeSyntax class, which represents the expression::NullableTypeSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class NullableTypeSyntax : public TypeSyntax {
    protected:
      ...
      */
      NullableTypeSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~NullableTypeSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NullableTypeSyntax & operator=(const NullableTypeSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NullableTypeSyntax(const NullableTypeSyntax&);
