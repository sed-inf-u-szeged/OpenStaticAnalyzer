...
#ifndef _CSHARP_AwaitExpressionSyntax_H_
#define _CSHARP_AwaitExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file AwaitExpressionSyntax.h
* \brief Contains declaration of the expression::AwaitExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief AwaitExpressionSyntax class, which represents the expression::AwaitExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class AwaitExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      AwaitExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~AwaitExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      AwaitExpressionSyntax & operator=(const AwaitExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      AwaitExpressionSyntax(const AwaitExpressionSyntax&);
