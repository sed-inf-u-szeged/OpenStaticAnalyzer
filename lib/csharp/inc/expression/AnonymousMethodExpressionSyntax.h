...
#ifndef _CSHARP_AnonymousMethodExpressionSyntax_H_
#define _CSHARP_AnonymousMethodExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file AnonymousMethodExpressionSyntax.h
* \brief Contains declaration of the expression::AnonymousMethodExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief AnonymousMethodExpressionSyntax class, which represents the expression::AnonymousMethodExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - ParameterList (structure::ParameterListSyntax, single) : (missing)
  */
  class AnonymousMethodExpressionSyntax : public AnonymousFunctionExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      AnonymousMethodExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~AnonymousMethodExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      AnonymousMethodExpressionSyntax & operator=(const AnonymousMethodExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      AnonymousMethodExpressionSyntax(const AnonymousMethodExpressionSyntax&);
