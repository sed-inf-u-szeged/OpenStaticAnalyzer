...
#ifndef _CSHARP_DefaultExpressionSyntax_H_
#define _CSHARP_DefaultExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file DefaultExpressionSyntax.h
* \brief Contains declaration of the expression::DefaultExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief DefaultExpressionSyntax class, which represents the expression::DefaultExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class DefaultExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      DefaultExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~DefaultExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      DefaultExpressionSyntax & operator=(const DefaultExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      DefaultExpressionSyntax(const DefaultExpressionSyntax&);
