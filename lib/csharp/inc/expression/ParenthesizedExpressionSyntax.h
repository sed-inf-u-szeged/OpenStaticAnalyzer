...
#ifndef _CSHARP_ParenthesizedExpressionSyntax_H_
#define _CSHARP_ParenthesizedExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ParenthesizedExpressionSyntax.h
* \brief Contains declaration of the expression::ParenthesizedExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ParenthesizedExpressionSyntax class, which represents the expression::ParenthesizedExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ParenthesizedExpressionSyntax : public ExpressionSyntax {
    protected:
      ...
      */
      ParenthesizedExpressionSyntax(NodeId nodeId, Factory *factory);
