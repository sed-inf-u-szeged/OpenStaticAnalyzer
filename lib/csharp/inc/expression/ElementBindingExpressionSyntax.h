...
#ifndef _CSHARP_ElementBindingExpressionSyntax_H_
#define _CSHARP_ElementBindingExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ElementBindingExpressionSyntax.h
* \brief Contains declaration of the expression::ElementBindingExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ElementBindingExpressionSyntax class, which represents the expression::ElementBindingExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - ArgumentList (structure::BracketedArgumentListSyntax, single) : (missing)
  */
  class ElementBindingExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ElementBindingExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ElementBindingExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ElementBindingExpressionSyntax & operator=(const ElementBindingExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ElementBindingExpressionSyntax(const ElementBindingExpressionSyntax&);
