...
#ifndef _CSHARP_PointerTypeSyntax_H_
#define _CSHARP_PointerTypeSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file PointerTypeSyntax.h
* \brief Contains declaration of the expression::PointerTypeSyntax class.
...
namespace expression {
  ...
  /**
  * \brief PointerTypeSyntax class, which represents the expression::PointerTypeSyntax node.
  * (missing)
  * 
  * Edges:
  *   - ElementType (expression::TypeSyntax, single) : (missing)
  */
  class PointerTypeSyntax : public TypeSyntax {
    protected:
      /**
      * \internal
      ...
      */
      PointerTypeSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~PointerTypeSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PointerTypeSyntax & operator=(const PointerTypeSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PointerTypeSyntax(const PointerTypeSyntax&);
