...
#ifndef _CSHARP_SizeOfExpressionSyntax_H_
#define _CSHARP_SizeOfExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file SizeOfExpressionSyntax.h
* \brief Contains declaration of the expression::SizeOfExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief SizeOfExpressionSyntax class, which represents the expression::SizeOfExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class SizeOfExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      SizeOfExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~SizeOfExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SizeOfExpressionSyntax & operator=(const SizeOfExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SizeOfExpressionSyntax(const SizeOfExpressionSyntax&);
