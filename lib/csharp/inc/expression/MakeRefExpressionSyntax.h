...
#ifndef _CSHARP_MakeRefExpressionSyntax_H_
#define _CSHARP_MakeRefExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file MakeRefExpressionSyntax.h
* \brief Contains declaration of the expression::MakeRefExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief MakeRefExpressionSyntax class, which represents the expression::MakeRefExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class MakeRefExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      MakeRefExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~MakeRefExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MakeRefExpressionSyntax & operator=(const MakeRefExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MakeRefExpressionSyntax(const MakeRefExpressionSyntax&);
