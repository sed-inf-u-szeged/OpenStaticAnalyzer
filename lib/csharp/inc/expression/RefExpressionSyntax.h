...
#ifndef _CSHARP_RefExpressionSyntax_H_
#define _CSHARP_RefExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file RefExpressionSyntax.h
* \brief Contains declaration of the expression::RefExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief RefExpressionSyntax class, which represents the expression::RefExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class RefExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      RefExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~RefExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefExpressionSyntax & operator=(const RefExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefExpressionSyntax(const RefExpressionSyntax&);
