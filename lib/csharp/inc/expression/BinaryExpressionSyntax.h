...
#ifndef _CSHARP_BinaryExpressionSyntax_H_
#define _CSHARP_BinaryExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BinaryExpressionSyntax.h
* \brief Contains declaration of the expression::BinaryExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief BinaryExpressionSyntax class, which represents the expression::BinaryExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class BinaryExpressionSyntax : public ExpressionSyntax {
    protected:
      ...
      */
      BinaryExpressionSyntax(NodeId nodeId, Factory *factory);
