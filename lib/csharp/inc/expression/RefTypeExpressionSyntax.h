...
#ifndef _CSHARP_RefTypeExpressionSyntax_H_
#define _CSHARP_RefTypeExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file RefTypeExpressionSyntax.h
* \brief Contains declaration of the expression::RefTypeExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief RefTypeExpressionSyntax class, which represents the expression::RefTypeExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class RefTypeExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      RefTypeExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~RefTypeExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefTypeExpressionSyntax & operator=(const RefTypeExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      RefTypeExpressionSyntax(const RefTypeExpressionSyntax&);
