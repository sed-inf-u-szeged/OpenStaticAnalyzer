...
#ifndef _CSHARP_TypeOfExpressionSyntax_H_
#define _CSHARP_TypeOfExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TypeOfExpressionSyntax.h
* \brief Contains declaration of the expression::TypeOfExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief TypeOfExpressionSyntax class, which represents the expression::TypeOfExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class TypeOfExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      TypeOfExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeOfExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeOfExpressionSyntax & operator=(const TypeOfExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeOfExpressionSyntax(const TypeOfExpressionSyntax&);
