...
#ifndef _CSHARP_ParenthesizedLambdaExpressionSyntax_H_
#define _CSHARP_ParenthesizedLambdaExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ParenthesizedLambdaExpressionSyntax.h
* \brief Contains declaration of the expression::ParenthesizedLambdaExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ParenthesizedLambdaExpressionSyntax class, which represents the expression::ParenthesizedLambdaExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - ParameterList (structure::ParameterListSyntax, single) : (missing)
  */
  class ParenthesizedLambdaExpressionSyntax : public LambdaExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ParenthesizedLambdaExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ParenthesizedLambdaExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ParenthesizedLambdaExpressionSyntax & operator=(const ParenthesizedLambdaExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ParenthesizedLambdaExpressionSyntax(const ParenthesizedLambdaExpressionSyntax&);
