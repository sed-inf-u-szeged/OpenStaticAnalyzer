...
#ifndef _CSHARP_SimpleNameSyntax_H_
#define _CSHARP_SimpleNameSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file SimpleNameSyntax.h
* \brief Contains declaration of the expression::SimpleNameSyntax class.
...
namespace expression {
  ...
  /**
  * \brief SimpleNameSyntax class, which represents the expression::SimpleNameSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class SimpleNameSyntax : public NameSyntax {
    protected:
      ...
      */
      SimpleNameSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~SimpleNameSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SimpleNameSyntax & operator=(const SimpleNameSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SimpleNameSyntax(const SimpleNameSyntax&);
