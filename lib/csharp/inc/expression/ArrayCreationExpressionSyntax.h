...
#ifndef _CSHARP_ArrayCreationExpressionSyntax_H_
#define _CSHARP_ArrayCreationExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ArrayCreationExpressionSyntax.h
* \brief Contains declaration of the expression::ArrayCreationExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ArrayCreationExpressionSyntax class, which represents the expression::ArrayCreationExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Initializer (expression::InitializerExpressionSyntax, single) : (missing)
  *   - Type (expression::ArrayTypeSyntax, single) : (missing)
  */
  class ArrayCreationExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ArrayCreationExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ArrayCreationExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ArrayCreationExpressionSyntax & operator=(const ArrayCreationExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ArrayCreationExpressionSyntax(const ArrayCreationExpressionSyntax&);
    ...
    public:
      ...
      */
      expression::ArrayTypeSyntax* getType() const;
      ...
      */
      void setType(ArrayTypeSyntax *node);
