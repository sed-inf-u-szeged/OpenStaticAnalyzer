...
#ifndef _CSHARP_ThrowExpressionSyntax_H_
#define _CSHARP_ThrowExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ThrowExpressionSyntax.h
* \brief Contains declaration of the expression::ThrowExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ThrowExpressionSyntax class, which represents the expression::ThrowExpressionSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class ThrowExpressionSyntax : public ExpressionSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ThrowExpressionSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ThrowExpressionSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ThrowExpressionSyntax & operator=(const ThrowExpressionSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ThrowExpressionSyntax(const ThrowExpressionSyntax&);
