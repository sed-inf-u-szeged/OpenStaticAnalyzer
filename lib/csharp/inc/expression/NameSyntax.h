...
#ifndef _CSHARP_NameSyntax_H_
#define _CSHARP_NameSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file NameSyntax.h
* \brief Contains declaration of the expression::NameSyntax class.
...
namespace expression {
  ...
  /**
  * \brief NameSyntax class, which represents the expression::NameSyntax node.
  * (missing)
  */
  class NameSyntax : public TypeSyntax {
    protected:
      ...
      */
      NameSyntax(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      NameSyntax & operator=(const NameSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NameSyntax(const NameSyntax&);
