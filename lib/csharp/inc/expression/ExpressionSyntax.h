...
#ifndef _CSHARP_ExpressionSyntax_H_
#define _CSHARP_ExpressionSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ExpressionSyntax.h
* \brief Contains declaration of the expression::ExpressionSyntax class.
...
namespace expression {
  ...
  /**
  * \brief ExpressionSyntax class, which represents the expression::ExpressionSyntax node.
  * (missing)
  */
  class ExpressionSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ExpressionSyntax(NodeId nodeId, Factory *factory);
