...
#ifndef _CSHARP_TypeParameterSyntax_H_
#define _CSHARP_TypeParameterSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TypeParameterSyntax.h
* \brief Contains declaration of the structure::TypeParameterSyntax class.
...
namespace structure {
  ...
  /**
  * \brief TypeParameterSyntax class, which represents the structure::TypeParameterSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class TypeParameterSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      TypeParameterSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeParameterSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeParameterSyntax & operator=(const TypeParameterSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeParameterSyntax(const TypeParameterSyntax&);
