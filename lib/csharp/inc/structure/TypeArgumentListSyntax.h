...
#ifndef _CSHARP_TypeArgumentListSyntax_H_
#define _CSHARP_TypeArgumentListSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TypeArgumentListSyntax.h
* \brief Contains declaration of the structure::TypeArgumentListSyntax class.
...
namespace structure {
  ...
  /**
  * \brief TypeArgumentListSyntax class, which represents the structure::TypeArgumentListSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Arguments (expression::TypeSyntax, multiple) : (missing)
  */
  class TypeArgumentListSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      TypeArgumentListSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeArgumentListSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeArgumentListSyntax & operator=(const TypeArgumentListSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeArgumentListSyntax(const TypeArgumentListSyntax&);
    ...
    public:
      ...
      */
      ListIterator<expression::TypeSyntax> getArgumentsListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the Arguments edges.
      * \return Returns an iterator for the Arguments edges.
      */
      ListIterator<expression::TypeSyntax> getArgumentsListIteratorEnd() const;
      ...
      */
      void addArguments(const expression::TypeSyntax *node);
      ...
      */
      void removeArguments(expression::TypeSyntax *node);
    ...
    protected:
      ...
      ListIterator<expression::TypeSyntax>::Container ArgumentsContainer;
