...
#ifndef _CSHARP_MemberCrefSyntax_H_
#define _CSHARP_MemberCrefSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file MemberCrefSyntax.h
* \brief Contains declaration of the structure::MemberCrefSyntax class.
...
namespace structure {
  ...
  /**
  * \brief MemberCrefSyntax class, which represents the structure::MemberCrefSyntax node.
  * (missing)
  */
  class MemberCrefSyntax : public CrefSyntax {
    protected:
      /**
      * \internal
      ...
      */
      MemberCrefSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~MemberCrefSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MemberCrefSyntax & operator=(const MemberCrefSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MemberCrefSyntax(const MemberCrefSyntax&);
