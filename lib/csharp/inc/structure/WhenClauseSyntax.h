...
#ifndef _CSHARP_WhenClauseSyntax_H_
#define _CSHARP_WhenClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file WhenClauseSyntax.h
* \brief Contains declaration of the structure::WhenClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief WhenClauseSyntax class, which represents the structure::WhenClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Condition (expression::ExpressionSyntax, single) : (missing)
  */
  class WhenClauseSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      WhenClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~WhenClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      WhenClauseSyntax & operator=(const WhenClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      WhenClauseSyntax(const WhenClauseSyntax&);
