...
#ifndef _CSHARP_FromClauseSyntax_H_
#define _CSHARP_FromClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file FromClauseSyntax.h
* \brief Contains declaration of the structure::FromClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief FromClauseSyntax class, which represents the structure::FromClauseSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class FromClauseSyntax : public QueryClauseSyntax {
    protected:
      /**
      * \internal
      ...
      */
      FromClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~FromClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FromClauseSyntax & operator=(const FromClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FromClauseSyntax(const FromClauseSyntax&);
