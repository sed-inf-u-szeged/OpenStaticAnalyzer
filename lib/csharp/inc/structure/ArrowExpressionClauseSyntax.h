...
#ifndef _CSHARP_ArrowExpressionClauseSyntax_H_
#define _CSHARP_ArrowExpressionClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ArrowExpressionClauseSyntax.h
* \brief Contains declaration of the structure::ArrowExpressionClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ArrowExpressionClauseSyntax class, which represents the structure::ArrowExpressionClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class ArrowExpressionClauseSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ArrowExpressionClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ArrowExpressionClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ArrowExpressionClauseSyntax & operator=(const ArrowExpressionClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ArrowExpressionClauseSyntax(const ArrowExpressionClauseSyntax&);
