...
#ifndef _CSHARP_ConstructorInitializerSyntax_H_
#define _CSHARP_ConstructorInitializerSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ConstructorInitializerSyntax.h
* \brief Contains declaration of the structure::ConstructorInitializerSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ConstructorInitializerSyntax class, which represents the structure::ConstructorInitializerSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ConstructorInitializerSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ConstructorInitializerSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ConstructorInitializerSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstructorInitializerSyntax & operator=(const ConstructorInitializerSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstructorInitializerSyntax(const ConstructorInitializerSyntax&);
    ...
    public:
      ...
      */
      void setArgumentList(ArgumentListSyntax *node);
      ...
      */
      void setConstructorCall(ConstructorDeclarationSyntax *node);
