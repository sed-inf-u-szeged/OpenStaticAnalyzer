...
#ifndef _CSHARP_GlobalStatementSyntax_H_
#define _CSHARP_GlobalStatementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file GlobalStatementSyntax.h
* \brief Contains declaration of the structure::GlobalStatementSyntax class.
...
namespace structure {
  ...
  /**
  * \brief GlobalStatementSyntax class, which represents the structure::GlobalStatementSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Statement (statement::StatementSyntax, single) : (missing)
  */
  class GlobalStatementSyntax : public MemberDeclarationSyntax {
    protected:
      /**
      * \internal
      ...
      */
      GlobalStatementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~GlobalStatementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      GlobalStatementSyntax & operator=(const GlobalStatementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      GlobalStatementSyntax(const GlobalStatementSyntax&);
    ...
    public:
      ...
      */
      void setStatement(statement::StatementSyntax *node);
