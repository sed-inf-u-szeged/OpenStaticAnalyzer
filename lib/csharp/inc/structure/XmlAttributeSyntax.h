...
#ifndef _CSHARP_XmlAttributeSyntax_H_
#define _CSHARP_XmlAttributeSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file XmlAttributeSyntax.h
* \brief Contains declaration of the structure::XmlAttributeSyntax class.
...
namespace structure {
  ...
  /**
  * \brief XmlAttributeSyntax class, which represents the structure::XmlAttributeSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Name (structure::XmlNameSyntax, single) : (missing)
  */
  class XmlAttributeSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      XmlAttributeSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~XmlAttributeSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlAttributeSyntax & operator=(const XmlAttributeSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlAttributeSyntax(const XmlAttributeSyntax&);
