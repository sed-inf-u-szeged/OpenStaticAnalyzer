...
#ifndef _CSHARP_TypeConstraintSyntax_H_
#define _CSHARP_TypeConstraintSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TypeConstraintSyntax.h
* \brief Contains declaration of the structure::TypeConstraintSyntax class.
...
namespace structure {
  ...
  /**
  * \brief TypeConstraintSyntax class, which represents the structure::TypeConstraintSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class TypeConstraintSyntax : public TypeParameterConstraintSyntax {
    protected:
      /**
      * \internal
      ...
      */
      TypeConstraintSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeConstraintSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeConstraintSyntax & operator=(const TypeConstraintSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeConstraintSyntax(const TypeConstraintSyntax&);
