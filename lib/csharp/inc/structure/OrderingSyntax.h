...
#ifndef _CSHARP_OrderingSyntax_H_
#define _CSHARP_OrderingSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file OrderingSyntax.h
* \brief Contains declaration of the structure::OrderingSyntax class.
...
namespace structure {
  ...
  /**
  * \brief OrderingSyntax class, which represents the structure::OrderingSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class OrderingSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      OrderingSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~OrderingSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      OrderingSyntax & operator=(const OrderingSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      OrderingSyntax(const OrderingSyntax&);
