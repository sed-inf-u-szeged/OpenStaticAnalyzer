...
#ifndef _CSHARP_ConstantPatternSyntax_H_
#define _CSHARP_ConstantPatternSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ConstantPatternSyntax.h
* \brief Contains declaration of the structure::ConstantPatternSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ConstantPatternSyntax class, which represents the structure::ConstantPatternSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class ConstantPatternSyntax : public PatternSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ConstantPatternSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ConstantPatternSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstantPatternSyntax & operator=(const ConstantPatternSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstantPatternSyntax(const ConstantPatternSyntax&);
