...
#ifndef _CSHARP_FinallyClauseSyntax_H_
#define _CSHARP_FinallyClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file FinallyClauseSyntax.h
* \brief Contains declaration of the structure::FinallyClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief FinallyClauseSyntax class, which represents the structure::FinallyClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Block (statement::BlockSyntax, single) : (missing)
  */
  class FinallyClauseSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      FinallyClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~FinallyClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FinallyClauseSyntax & operator=(const FinallyClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      FinallyClauseSyntax(const FinallyClauseSyntax&);
