...
#ifndef _CSHARP_PropertyDeclarationSyntax_H_
#define _CSHARP_PropertyDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file PropertyDeclarationSyntax.h
* \brief Contains declaration of the structure::PropertyDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief PropertyDeclarationSyntax class, which represents the structure::PropertyDeclarationSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class PropertyDeclarationSyntax : public BasePropertyDeclarationSyntax {
    protected:
      /**
      * \internal
      ...
      */
      PropertyDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~PropertyDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PropertyDeclarationSyntax & operator=(const PropertyDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PropertyDeclarationSyntax(const PropertyDeclarationSyntax&);
