...
#ifndef _CSHARP_ElseClauseSyntax_H_
#define _CSHARP_ElseClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ElseClauseSyntax.h
* \brief Contains declaration of the structure::ElseClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ElseClauseSyntax class, which represents the structure::ElseClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Statement (statement::StatementSyntax, single) : (missing)
  */
  class ElseClauseSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ElseClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ElseClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ElseClauseSyntax & operator=(const ElseClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ElseClauseSyntax(const ElseClauseSyntax&);
