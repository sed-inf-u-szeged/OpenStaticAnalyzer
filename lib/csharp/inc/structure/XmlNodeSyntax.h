...
#ifndef _CSHARP_XmlNodeSyntax_H_
#define _CSHARP_XmlNodeSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file XmlNodeSyntax.h
* \brief Contains declaration of the structure::XmlNodeSyntax class.
...
namespace structure {
  ...
  /**
  * \brief XmlNodeSyntax class, which represents the structure::XmlNodeSyntax node.
  * (missing)
  */
  class XmlNodeSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      XmlNodeSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~XmlNodeSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlNodeSyntax & operator=(const XmlNodeSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlNodeSyntax(const XmlNodeSyntax&);
