...
#ifndef _CSHARP_WhereClauseSyntax_H_
#define _CSHARP_WhereClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file WhereClauseSyntax.h
* \brief Contains declaration of the structure::WhereClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief WhereClauseSyntax class, which represents the structure::WhereClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Condition (expression::ExpressionSyntax, single) : (missing)
  */
  class WhereClauseSyntax : public QueryClauseSyntax {
    protected:
      /**
      * \internal
      ...
      */
      WhereClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~WhereClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      WhereClauseSyntax & operator=(const WhereClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      WhereClauseSyntax(const WhereClauseSyntax&);
