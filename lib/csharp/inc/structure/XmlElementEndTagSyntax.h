...
#ifndef _CSHARP_XmlElementEndTagSyntax_H_
#define _CSHARP_XmlElementEndTagSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file XmlElementEndTagSyntax.h
* \brief Contains declaration of the structure::XmlElementEndTagSyntax class.
...
namespace structure {
  ...
  /**
  * \brief XmlElementEndTagSyntax class, which represents the structure::XmlElementEndTagSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Name (structure::XmlNameSyntax, single) : (missing)
  */
  class XmlElementEndTagSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      XmlElementEndTagSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~XmlElementEndTagSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlElementEndTagSyntax & operator=(const XmlElementEndTagSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlElementEndTagSyntax(const XmlElementEndTagSyntax&);
