...
#ifndef _CSHARP_IncompleteMemberSyntax_H_
#define _CSHARP_IncompleteMemberSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file IncompleteMemberSyntax.h
* \brief Contains declaration of the structure::IncompleteMemberSyntax class.
...
namespace structure {
  ...
  /**
  * \brief IncompleteMemberSyntax class, which represents the structure::IncompleteMemberSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class IncompleteMemberSyntax : public MemberDeclarationSyntax {
    protected:
      /**
      * \internal
      ...
      */
      IncompleteMemberSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~IncompleteMemberSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IncompleteMemberSyntax & operator=(const IncompleteMemberSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IncompleteMemberSyntax(const IncompleteMemberSyntax&);
