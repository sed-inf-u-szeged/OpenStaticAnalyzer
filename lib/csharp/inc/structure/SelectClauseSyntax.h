...
#ifndef _CSHARP_SelectClauseSyntax_H_
#define _CSHARP_SelectClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file SelectClauseSyntax.h
* \brief Contains declaration of the structure::SelectClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief SelectClauseSyntax class, which represents the structure::SelectClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Expression (expression::ExpressionSyntax, single) : (missing)
  */
  class SelectClauseSyntax : public SelectOrGroupClauseSyntax {
    protected:
      /**
      * \internal
      ...
      */
      SelectClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~SelectClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SelectClauseSyntax & operator=(const SelectClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      SelectClauseSyntax(const SelectClauseSyntax&);
