...
#ifndef _CSHARP_IndexerDeclarationSyntax_H_
#define _CSHARP_IndexerDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file IndexerDeclarationSyntax.h
* \brief Contains declaration of the structure::IndexerDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief IndexerDeclarationSyntax class, which represents the structure::IndexerDeclarationSyntax node.
  * (missing)
  * 
  * Edges:
  *   - ExpressionBody (structure::ArrowExpressionClauseSyntax, single) : (missing)
  *   - ParameterList (structure::BracketedParameterListSyntax, single) : (missing)
  */
  class IndexerDeclarationSyntax : public BasePropertyDeclarationSyntax {
    protected:
      /**
      * \internal
      ...
      */
      IndexerDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~IndexerDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IndexerDeclarationSyntax & operator=(const IndexerDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      IndexerDeclarationSyntax(const IndexerDeclarationSyntax&);
    ...
    public:
      ...
      */
      structure::BracketedParameterListSyntax* getParameterList() const;
      ...
      */
      void setParameterList(BracketedParameterListSyntax *node);
