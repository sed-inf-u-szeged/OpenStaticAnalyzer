...
#ifndef _CSHARP_ConversionOperatorDeclarationSyntax_H_
#define _CSHARP_ConversionOperatorDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ConversionOperatorDeclarationSyntax.h
* \brief Contains declaration of the structure::ConversionOperatorDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ConversionOperatorDeclarationSyntax class, which represents the structure::ConversionOperatorDeclarationSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ConversionOperatorDeclarationSyntax : public BaseMethodDeclarationSyntax {
    protected:
      ...
      */
      ConversionOperatorDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ConversionOperatorDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConversionOperatorDeclarationSyntax & operator=(const ConversionOperatorDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConversionOperatorDeclarationSyntax(const ConversionOperatorDeclarationSyntax&);
