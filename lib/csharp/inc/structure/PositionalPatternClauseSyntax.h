...
#ifndef _CSHARP_PositionalPatternClauseSyntax_H_
#define _CSHARP_PositionalPatternClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file PositionalPatternClauseSyntax.h
* \brief Contains declaration of the structure::PositionalPatternClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief PositionalPatternClauseSyntax class, which represents the structure::PositionalPatternClauseSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Subpatterns (structure::SubpatternSyntax, multiple) : (missing)
  */
  class PositionalPatternClauseSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      PositionalPatternClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~PositionalPatternClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PositionalPatternClauseSyntax & operator=(const PositionalPatternClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PositionalPatternClauseSyntax(const PositionalPatternClauseSyntax&);
