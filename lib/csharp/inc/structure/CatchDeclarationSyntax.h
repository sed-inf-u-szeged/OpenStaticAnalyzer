...
#ifndef _CSHARP_CatchDeclarationSyntax_H_
#define _CSHARP_CatchDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CatchDeclarationSyntax.h
* \brief Contains declaration of the structure::CatchDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief CatchDeclarationSyntax class, which represents the structure::CatchDeclarationSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class CatchDeclarationSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      CatchDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~CatchDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CatchDeclarationSyntax & operator=(const CatchDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CatchDeclarationSyntax(const CatchDeclarationSyntax&);
