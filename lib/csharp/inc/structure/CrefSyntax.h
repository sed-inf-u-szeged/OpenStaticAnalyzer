...
#ifndef _CSHARP_CrefSyntax_H_
#define _CSHARP_CrefSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CrefSyntax.h
* \brief Contains declaration of the structure::CrefSyntax class.
...
namespace structure {
  ...
  /**
  * \brief CrefSyntax class, which represents the structure::CrefSyntax node.
  * (missing)
  */
  class CrefSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      CrefSyntax(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      CrefSyntax & operator=(const CrefSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CrefSyntax(const CrefSyntax&);
