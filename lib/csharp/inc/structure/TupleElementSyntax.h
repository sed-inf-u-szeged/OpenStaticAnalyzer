...
#ifndef _CSHARP_TupleElementSyntax_H_
#define _CSHARP_TupleElementSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TupleElementSyntax.h
* \brief Contains declaration of the structure::TupleElementSyntax class.
...
namespace structure {
  ...
  /**
  * \brief TupleElementSyntax class, which represents the structure::TupleElementSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class TupleElementSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      TupleElementSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TupleElementSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TupleElementSyntax & operator=(const TupleElementSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TupleElementSyntax(const TupleElementSyntax&);
