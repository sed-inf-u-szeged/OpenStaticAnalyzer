...
#ifndef _CSHARP_LetClauseSyntax_H_
#define _CSHARP_LetClauseSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file LetClauseSyntax.h
* \brief Contains declaration of the structure::LetClauseSyntax class.
...
namespace structure {
  ...
  /**
  * \brief LetClauseSyntax class, which represents the structure::LetClauseSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class LetClauseSyntax : public QueryClauseSyntax {
    protected:
      /**
      * \internal
      ...
      */
      LetClauseSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~LetClauseSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LetClauseSyntax & operator=(const LetClauseSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      LetClauseSyntax(const LetClauseSyntax&);
