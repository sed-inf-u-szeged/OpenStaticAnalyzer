...
#ifndef _CSHARP_BaseTypeSyntax_H_
#define _CSHARP_BaseTypeSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BaseTypeSyntax.h
* \brief Contains declaration of the structure::BaseTypeSyntax class.
...
namespace structure {
  ...
  /**
  * \brief BaseTypeSyntax class, which represents the structure::BaseTypeSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class BaseTypeSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      BaseTypeSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~BaseTypeSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseTypeSyntax & operator=(const BaseTypeSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseTypeSyntax(const BaseTypeSyntax&);
