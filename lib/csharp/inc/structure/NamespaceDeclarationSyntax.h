...
#ifndef _CSHARP_NamespaceDeclarationSyntax_H_
#define _CSHARP_NamespaceDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file NamespaceDeclarationSyntax.h
* \brief Contains declaration of the structure::NamespaceDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief NamespaceDeclarationSyntax class, which represents the structure::NamespaceDeclarationSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class NamespaceDeclarationSyntax : public MemberDeclarationSyntax {
    protected:
      ...
      */
      NamespaceDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~NamespaceDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NamespaceDeclarationSyntax & operator=(const NamespaceDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NamespaceDeclarationSyntax(const NamespaceDeclarationSyntax&);
