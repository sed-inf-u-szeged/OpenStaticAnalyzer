...
#ifndef _CSHARP_BaseArgumentListSyntax_H_
#define _CSHARP_BaseArgumentListSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BaseArgumentListSyntax.h
* \brief Contains declaration of the structure::BaseArgumentListSyntax class.
...
namespace structure {
  ...
  /**
  * \brief BaseArgumentListSyntax class, which represents the structure::BaseArgumentListSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Arguments (structure::ArgumentSyntax, multiple) : (missing)
  */
  class BaseArgumentListSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      BaseArgumentListSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~BaseArgumentListSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseArgumentListSyntax & operator=(const BaseArgumentListSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseArgumentListSyntax(const BaseArgumentListSyntax&);
    ...
    public:
      ...
      */
      void addArguments(const ArgumentSyntax *node);
      ...
      */
      void removeArguments(ArgumentSyntax *node);
