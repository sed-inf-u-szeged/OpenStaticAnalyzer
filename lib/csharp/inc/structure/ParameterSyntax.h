...
#ifndef _CSHARP_ParameterSyntax_H_
#define _CSHARP_ParameterSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ParameterSyntax.h
* \brief Contains declaration of the structure::ParameterSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ParameterSyntax class, which represents the structure::ParameterSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  *   - Default (structure::EqualsValueClauseSyntax, single) : (missing)
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class ParameterSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ParameterSyntax(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ParameterSyntax & operator=(const ParameterSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ParameterSyntax(const ParameterSyntax&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the pointer of the node the Default edge points to.
      * \return Returns the end point of the Default edge.
      */
      structure::EqualsValueClauseSyntax* getDefault() const;
      ...
      */
      ...
      /**
      * \brief Sets the Default edge.
      * \param id [in] The new end point of the Default edge.
      */
      void setDefault(NodeId id);

      /**
      * \brief Sets the Default edge.
      * \param node [in] The new end point of the Default edge.
      */
      void setDefault(EqualsValueClauseSyntax *node);

      /**
      * \brief remove the Default edge.
      */
      void removeDefault();
    ...
    protected:
      ...
      /** \internal \brief The id of the node the Default edge points to. */
      NodeId m_Default;
