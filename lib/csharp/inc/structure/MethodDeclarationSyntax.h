...
#ifndef _CSHARP_MethodDeclarationSyntax_H_
#define _CSHARP_MethodDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file MethodDeclarationSyntax.h
* \brief Contains declaration of the structure::MethodDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief MethodDeclarationSyntax class, which represents the structure::MethodDeclarationSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  */
  class MethodDeclarationSyntax : public BaseMethodDeclarationSyntax {
    protected:
      ...
      */
      MethodDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~MethodDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MethodDeclarationSyntax & operator=(const MethodDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      MethodDeclarationSyntax(const MethodDeclarationSyntax&);
