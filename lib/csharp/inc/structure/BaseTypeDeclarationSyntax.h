...
#ifndef _CSHARP_BaseTypeDeclarationSyntax_H_
#define _CSHARP_BaseTypeDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BaseTypeDeclarationSyntax.h
* \brief Contains declaration of the structure::BaseTypeDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief BaseTypeDeclarationSyntax class, which represents the structure::BaseTypeDeclarationSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  *   - BaseList (structure::BaseListSyntax, single) : (missing)
  */
  class BaseTypeDeclarationSyntax : public MemberDeclarationSyntax {
    protected:
      ...
      */
      BaseTypeDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~BaseTypeDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseTypeDeclarationSyntax & operator=(const BaseTypeDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseTypeDeclarationSyntax(const BaseTypeDeclarationSyntax&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the pointer of the node the BaseList edge points to.
      * \return Returns the end point of the BaseList edge.
      */
      structure::BaseListSyntax* getBaseList() const;
      ...
      */
      ...
      /**
      * \brief Sets the BaseList edge.
      * \param id [in] The new end point of the BaseList edge.
      */
      void setBaseList(NodeId id);

      /**
      * \brief Sets the BaseList edge.
      * \param node [in] The new end point of the BaseList edge.
      */
      void setBaseList(BaseListSyntax *node);

      /**
      * \brief remove the BaseList edge.
      */
      void removeBaseList();
    ...
    protected:
      ...
      /** \internal \brief The id of the node the BaseList edge points to. */
      NodeId m_BaseList;
