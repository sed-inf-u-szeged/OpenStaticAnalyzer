...
#ifndef _CSHARP_ConversionOperatorMemberCrefSyntax_H_
#define _CSHARP_ConversionOperatorMemberCrefSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ConversionOperatorMemberCrefSyntax.h
* \brief Contains declaration of the structure::ConversionOperatorMemberCrefSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ConversionOperatorMemberCrefSyntax class, which represents the structure::ConversionOperatorMemberCrefSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ConversionOperatorMemberCrefSyntax : public MemberCrefSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ConversionOperatorMemberCrefSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ConversionOperatorMemberCrefSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConversionOperatorMemberCrefSyntax & operator=(const ConversionOperatorMemberCrefSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConversionOperatorMemberCrefSyntax(const ConversionOperatorMemberCrefSyntax&);
