...
#ifndef _CSHARP_XmlElementStartTagSyntax_H_
#define _CSHARP_XmlElementStartTagSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file XmlElementStartTagSyntax.h
* \brief Contains declaration of the structure::XmlElementStartTagSyntax class.
...
namespace structure {
  ...
  /**
  * \brief XmlElementStartTagSyntax class, which represents the structure::XmlElementStartTagSyntax node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class XmlElementStartTagSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      XmlElementStartTagSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~XmlElementStartTagSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlElementStartTagSyntax & operator=(const XmlElementStartTagSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      XmlElementStartTagSyntax(const XmlElementStartTagSyntax&);
