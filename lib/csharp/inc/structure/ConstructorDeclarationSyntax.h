...
#ifndef _CSHARP_ConstructorDeclarationSyntax_H_
#define _CSHARP_ConstructorDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ConstructorDeclarationSyntax.h
* \brief Contains declaration of the structure::ConstructorDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ConstructorDeclarationSyntax class, which represents the structure::ConstructorDeclarationSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  * 
  * Edges:
  *   - Initializer (structure::ConstructorInitializerSyntax, single) : (missing)
  */
  class ConstructorDeclarationSyntax : public BaseMethodDeclarationSyntax {
    protected:
      /**
      * \internal
      ...
      */
      ConstructorDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ConstructorDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstructorDeclarationSyntax & operator=(const ConstructorDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ConstructorDeclarationSyntax(const ConstructorDeclarationSyntax&);
    ...
    public:
      ...
      */
      structure::ConstructorInitializerSyntax* getInitializer() const;
      ...
      */
      void setInitializer(ConstructorInitializerSyntax *node);
