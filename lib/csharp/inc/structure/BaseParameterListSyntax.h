...
#ifndef _CSHARP_BaseParameterListSyntax_H_
#define _CSHARP_BaseParameterListSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file BaseParameterListSyntax.h
* \brief Contains declaration of the structure::BaseParameterListSyntax class.
...
namespace structure {
  ...
  /**
  * \brief BaseParameterListSyntax class, which represents the structure::BaseParameterListSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Parameters (structure::ParameterSyntax, multiple) : (missing)
  */
  class BaseParameterListSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      BaseParameterListSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~BaseParameterListSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseParameterListSyntax & operator=(const BaseParameterListSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      BaseParameterListSyntax(const BaseParameterListSyntax&);
    ...
    public:
      ...
      */
      ListIterator<structure::ParameterSyntax> getParametersListIteratorBegin() const;

      /**
      * \brief Gives back iterator for the Parameters edges.
      * \return Returns an iterator for the Parameters edges.
      */
      ListIterator<structure::ParameterSyntax> getParametersListIteratorEnd() const;
      ...
      */
      void addParameters(const ParameterSyntax *node);
      ...
      */
      void removeParameters(ParameterSyntax *node);
    ...
    protected:
      ...
      ListIterator<structure::ParameterSyntax>::Container ParametersContainer;
