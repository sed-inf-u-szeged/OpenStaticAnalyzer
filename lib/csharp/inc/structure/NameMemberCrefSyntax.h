...
#ifndef _CSHARP_NameMemberCrefSyntax_H_
#define _CSHARP_NameMemberCrefSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file NameMemberCrefSyntax.h
* \brief Contains declaration of the structure::NameMemberCrefSyntax class.
...
namespace structure {
  ...
  /**
  * \brief NameMemberCrefSyntax class, which represents the structure::NameMemberCrefSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Name (expression::TypeSyntax, single) : (missing)
  *   - Parameters (structure::CrefParameterListSyntax, single) : (missing)
  */
  class NameMemberCrefSyntax : public MemberCrefSyntax {
    protected:
      /**
      * \internal
      ...
      */
      NameMemberCrefSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~NameMemberCrefSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NameMemberCrefSyntax & operator=(const NameMemberCrefSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      NameMemberCrefSyntax(const NameMemberCrefSyntax&);
    ...
    public:
      ...
      */
      expression::TypeSyntax* getName() const;
      ...
      */
      void setName(expression::TypeSyntax *node);
