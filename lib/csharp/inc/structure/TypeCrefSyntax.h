...
#ifndef _CSHARP_TypeCrefSyntax_H_
#define _CSHARP_TypeCrefSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file TypeCrefSyntax.h
* \brief Contains declaration of the structure::TypeCrefSyntax class.
...
namespace structure {
  ...
  /**
  * \brief TypeCrefSyntax class, which represents the structure::TypeCrefSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class TypeCrefSyntax : public CrefSyntax {
    protected:
      /**
      * \internal
      ...
      */
      TypeCrefSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~TypeCrefSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeCrefSyntax & operator=(const TypeCrefSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      TypeCrefSyntax(const TypeCrefSyntax&);
