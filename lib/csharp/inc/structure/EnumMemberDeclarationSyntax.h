...
#ifndef _CSHARP_EnumMemberDeclarationSyntax_H_
#define _CSHARP_EnumMemberDeclarationSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file EnumMemberDeclarationSyntax.h
* \brief Contains declaration of the structure::EnumMemberDeclarationSyntax class.
...
namespace structure {
  ...
  /**
  * \brief EnumMemberDeclarationSyntax class, which represents the structure::EnumMemberDeclarationSyntax node.
  * (missing)
  * 
  * Attributes:
  ...
  *   - EqualsValue (structure::EqualsValueClauseSyntax, single) : (missing)
  */
  class EnumMemberDeclarationSyntax : public MemberDeclarationSyntax {
    protected:
      ...
      */
      EnumMemberDeclarationSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~EnumMemberDeclarationSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      EnumMemberDeclarationSyntax & operator=(const EnumMemberDeclarationSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      EnumMemberDeclarationSyntax(const EnumMemberDeclarationSyntax&);
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the pointer of the node the EqualsValue edge points to.
      * \return Returns the end point of the EqualsValue edge.
      */
      structure::EqualsValueClauseSyntax* getEqualsValue() const;
      ...
      */
      ...
      /**
      * \brief Sets the EqualsValue edge.
      * \param id [in] The new end point of the EqualsValue edge.
      */
      void setEqualsValue(NodeId id);

      /**
      * \brief Sets the EqualsValue edge.
      * \param node [in] The new end point of the EqualsValue edge.
      */
      void setEqualsValue(EqualsValueClauseSyntax *node);

      /**
      * \brief remove the EqualsValue edge.
      */
      void removeEqualsValue();
    ...
    protected:
      ...
      /** \internal \brief The id of the node the EqualsValue edge points to. */
      NodeId m_EqualsValue;
