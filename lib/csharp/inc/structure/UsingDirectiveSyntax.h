...
#ifndef _CSHARP_UsingDirectiveSyntax_H_
#define _CSHARP_UsingDirectiveSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file UsingDirectiveSyntax.h
* \brief Contains declaration of the structure::UsingDirectiveSyntax class.
...
namespace structure {
  ...
  /**
  * \brief UsingDirectiveSyntax class, which represents the structure::UsingDirectiveSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Alias (structure::NameEqualsSyntax, single) : (missing)
  *   - Name (expression::NameSyntax, single) : (missing)
  */
  class UsingDirectiveSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      UsingDirectiveSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~UsingDirectiveSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      UsingDirectiveSyntax & operator=(const UsingDirectiveSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      UsingDirectiveSyntax(const UsingDirectiveSyntax&);
    ...
    public:
      ...
      */
      structure::NameEqualsSyntax* getAlias() const;
      ...
      */
      void setAlias(NameEqualsSyntax *node);
