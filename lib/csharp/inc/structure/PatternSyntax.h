...
#ifndef _CSHARP_PatternSyntax_H_
#define _CSHARP_PatternSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file PatternSyntax.h
* \brief Contains declaration of the structure::PatternSyntax class.
...
namespace structure {
  ...
  /**
  * \brief PatternSyntax class, which represents the structure::PatternSyntax node.
  * (missing)
  */
  class PatternSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      PatternSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~PatternSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PatternSyntax & operator=(const PatternSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      PatternSyntax(const PatternSyntax&);
