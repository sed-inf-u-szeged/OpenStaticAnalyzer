...
#ifndef _CSHARP_ExternAliasDirectiveSyntax_H_
#define _CSHARP_ExternAliasDirectiveSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file ExternAliasDirectiveSyntax.h
* \brief Contains declaration of the structure::ExternAliasDirectiveSyntax class.
...
namespace structure {
  ...
  /**
  * \brief ExternAliasDirectiveSyntax class, which represents the structure::ExternAliasDirectiveSyntax node.
  * (missing)
  * 
  * Attributes:
  *   - identifier (String) : (missing)
  */
  class ExternAliasDirectiveSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ExternAliasDirectiveSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ExternAliasDirectiveSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ExternAliasDirectiveSyntax & operator=(const ExternAliasDirectiveSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      ExternAliasDirectiveSyntax(const ExternAliasDirectiveSyntax&);
