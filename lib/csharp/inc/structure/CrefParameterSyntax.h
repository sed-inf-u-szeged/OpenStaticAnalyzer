...
#ifndef _CSHARP_CrefParameterSyntax_H_
#define _CSHARP_CrefParameterSyntax_H_

#include "csharp/inc/csharp.h"

/**
* \file CrefParameterSyntax.h
* \brief Contains declaration of the structure::CrefParameterSyntax class.
...
namespace structure {
  ...
  /**
  * \brief CrefParameterSyntax class, which represents the structure::CrefParameterSyntax node.
  * (missing)
  * 
  * Edges:
  *   - Type (expression::TypeSyntax, single) : (missing)
  */
  class CrefParameterSyntax : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      CrefParameterSyntax(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~CrefParameterSyntax();

    private:
      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CrefParameterSyntax & operator=(const CrefParameterSyntax&);

      /**
      * \brief This function always throws a CsharpException due to copying is not allowed!
      */
      CrefParameterSyntax(const CrefParameterSyntax&);
