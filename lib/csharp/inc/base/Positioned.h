...
#ifndef _CSHARP_Positioned_H_
#define _CSHARP_Positioned_H_
...
namespace base {
  ...
  * 
  * Attributes:
  *   - position (SourcePosition) : (missing)
  */
  class Positioned : public Base {
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the position member of the node.
      ...
      */
      void setPosition(const SourcePosition& _position);

    protected:

      // ---------- Attribute(s) ----------

      /** \internal \brief The value of the `position`. */
