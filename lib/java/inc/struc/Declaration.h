...
#ifndef _JAVA_Declaration_H_
#define _JAVA_Declaration_H_

#include "java/inc/java.h"

/**
* \file Declaration.h
* \brief Contains declaration of the struc::Declaration class.
...
namespace struc {
  ...
  /**
  * \brief Declaration class, which represents the struc::Declaration node.
  * (missing)
  */
  class Declaration : public virtual Member, public statm::Statement {
    protected:
      /**
      * \internal
      ...
      */
      Declaration(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Declaration& other, bool tryOnVirtualParent);
