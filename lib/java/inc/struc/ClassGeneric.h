...
#ifndef _JAVA_ClassGeneric_H_
#define _JAVA_ClassGeneric_H_

#include "java/inc/java.h"

/**
* \file ClassGeneric.h
* \brief Contains declaration of the struc::ClassGeneric class.
...
namespace struc {
  ...
  /**
  * \brief ClassGeneric class, which represents the struc::ClassGeneric node.
  * (missing)
  */
  class ClassGeneric : public ClassDeclaration, public GenericDeclaration {
    protected:
      /**
      * \internal
