...
#ifndef _JAVA_InterfaceDeclaration_H_
#define _JAVA_InterfaceDeclaration_H_

#include "java/inc/java.h"

/**
* \file InterfaceDeclaration.h
* \brief Contains declaration of the struc::InterfaceDeclaration class.
...
namespace struc {
  ...
  /**
  * \brief InterfaceDeclaration class, which represents the struc::InterfaceDeclaration node.
  * (missing)
  */
  class InterfaceDeclaration : public TypeDeclaration {
    protected:
      ...
      */
      InterfaceDeclaration(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      InterfaceDeclaration & operator=(const InterfaceDeclaration&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      InterfaceDeclaration(const InterfaceDeclaration&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const InterfaceDeclaration& other, bool tryOnVirtualParent);
