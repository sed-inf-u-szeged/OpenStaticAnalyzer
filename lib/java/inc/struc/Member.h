...
#ifndef _JAVA_Member_H_
#define _JAVA_Member_H_

#include "java/inc/java.h"

/**
* \file Member.h
* \brief Contains declaration of the struc::Member class.
...
namespace struc {
  ...
  /**
  * \brief Member class, which represents the struc::Member node.
  * (missing)
  */
  class Member : public virtual base::Commentable, public AnnotatedElement {
    protected:
      /**
      * \internal
