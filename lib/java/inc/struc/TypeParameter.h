...
#ifndef _JAVA_TypeParameter_H_
#define _JAVA_TypeParameter_H_

#include "java/inc/java.h"

/**
* \file TypeParameter.h
* \brief Contains declaration of the struc::TypeParameter class.
...
namespace struc {
  ...
  /**
  * \brief TypeParameter class, which represents the struc::TypeParameter node.
  * (missing)
  * 
  * Edges:
  *   - hasBounds (expr::TypeExpression, multiple) : (missing)
  */
  class TypeParameter : public base::Positioned, public base::Named {
    protected:
      /**
      * \internal
      ...
      */
      TypeParameter(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const TypeParameter& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      void addBounds(const expr::TypeExpression *node);
      ...
      */
      void removeBounds(expr::TypeExpression *node);
