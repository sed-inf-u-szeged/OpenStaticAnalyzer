...
#ifndef _JAVA_ClassDeclaration_H_
#define _JAVA_ClassDeclaration_H_

#include "java/inc/java.h"

/**
* \file ClassDeclaration.h
* \brief Contains declaration of the struc::ClassDeclaration class.
...
namespace struc {
  ...
  /**
  * \brief ClassDeclaration class, which represents the struc::ClassDeclaration node.
  * (missing)
  */
  class ClassDeclaration : public TypeDeclaration {
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ClassDeclaration& other, bool tryOnVirtualParent);
