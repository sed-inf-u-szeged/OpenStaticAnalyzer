...
#ifndef _JAVA_Comment_H_
#define _JAVA_Comment_H_
...
namespace base {
  ...
  *   - text (String) : (missing)
  */
  class Comment : public PositionedWithoutComment {
    protected:
      /**
      * \internal
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Comment& other, bool tryOnVirtualParent);
