...
#ifndef _JAVA_NonJavadocComment_H_
#define _JAVA_NonJavadocComment_H_

#include "java/inc/java.h"

/**
* \file NonJavadocComment.h
* \brief Contains declaration of the base::NonJavadocComment class.
...
namespace base {
  ...
  /**
  * \brief NonJavadocComment class, which represents the base::NonJavadocComment node.
  * (missing)
  */
  class NonJavadocComment : public Comment {
    protected:
      /**
      * \internal
      ...
      */
      NonJavadocComment(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~NonJavadocComment();

    private:
      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      NonJavadocComment & operator=(const NonJavadocComment&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      NonJavadocComment(const NonJavadocComment&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const NonJavadocComment& other, bool tryOnVirtualParent);
