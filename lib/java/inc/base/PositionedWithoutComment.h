...
#ifndef _JAVA_PositionedWithoutComment_H_
#define _JAVA_PositionedWithoutComment_H_

#include "java/inc/java.h"

/**
* \file PositionedWithoutComment.h
* \brief Contains declaration of the base::PositionedWithoutComment class.
...
namespace base {
  ...
  /**
  * \brief PositionedWithoutComment class, which represents the base::PositionedWithoutComment node.
  * (missing)
  * 
  * Attributes:
  *   - position (Range) : (missing)
  */
  class PositionedWithoutComment : public virtual Base {
    protected:
      /**
      * \internal
      ...
      */
      PositionedWithoutComment(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~PositionedWithoutComment();

    private:
      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      PositionedWithoutComment & operator=(const PositionedWithoutComment&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      PositionedWithoutComment(const PositionedWithoutComment&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const PositionedWithoutComment& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      virtual int compareByPosition(const PositionedWithoutComment& other) const;
