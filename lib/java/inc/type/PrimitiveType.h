...
#ifndef _JAVA_PrimitiveType_H_
#define _JAVA_PrimitiveType_H_

#include "java/inc/java.h"

/**
* \file PrimitiveType.h
* \brief Contains declaration of the type::PrimitiveType class.
...
namespace type {
  ...
  /**
  * \brief PrimitiveType class, which represents the type::PrimitiveType node.
  * (missing)
  */
  class PrimitiveType : public Type {
    protected:
      ...
      */
      PrimitiveType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const PrimitiveType& other, bool tryOnVirtualParent);
