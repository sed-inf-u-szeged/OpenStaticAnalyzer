...
#ifndef _JAVA_BooleanType_H_
#define _JAVA_BooleanType_H_

#include "java/inc/java.h"

/**
* \file BooleanType.h
* \brief Contains declaration of the type::BooleanType class.
...
namespace type {
  ...
  /**
  * \brief BooleanType class, which represents the type::BooleanType node.
  * (missing)
  */
  class BooleanType : public PrimitiveType {
    protected:
      ...
      */
      BooleanType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const BooleanType& other, bool tryOnVirtualParent);
