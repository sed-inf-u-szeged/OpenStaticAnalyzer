...
#ifndef _JAVA_ErrorType_H_
#define _JAVA_ErrorType_H_

#include "java/inc/java.h"

/**
* \file ErrorType.h
* \brief Contains declaration of the type::ErrorType class.
...
namespace type {
  ...
  /**
  * \brief ErrorType class, which represents the type::ErrorType node.
  * (missing)
  */
  class ErrorType : public Type {
    protected:
      ...
      */
      ErrorType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ErrorType& other, bool tryOnVirtualParent);
