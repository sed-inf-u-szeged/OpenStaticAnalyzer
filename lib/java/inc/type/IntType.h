...
#ifndef _JAVA_IntType_H_
#define _JAVA_IntType_H_

#include "java/inc/java.h"

/**
* \file IntType.h
* \brief Contains declaration of the type::IntType class.
...
namespace type {
  ...
  /**
  * \brief IntType class, which represents the type::IntType node.
  * (missing)
  */
  class IntType : public PrimitiveType {
    protected:
      ...
      */
      IntType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const IntType& other, bool tryOnVirtualParent);
