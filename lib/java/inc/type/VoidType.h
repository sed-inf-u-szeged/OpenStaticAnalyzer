...
#ifndef _JAVA_VoidType_H_
#define _JAVA_VoidType_H_

#include "java/inc/java.h"

/**
* \file VoidType.h
* \brief Contains declaration of the type::VoidType class.
...
namespace type {
  ...
  /**
  * \brief VoidType class, which represents the type::VoidType node.
  * (missing)
  */
  class VoidType : public PrimitiveType {
    protected:
      ...
      */
      VoidType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const VoidType& other, bool tryOnVirtualParent);
