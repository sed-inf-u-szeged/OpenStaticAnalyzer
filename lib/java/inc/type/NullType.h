...
#ifndef _JAVA_NullType_H_
#define _JAVA_NullType_H_

#include "java/inc/java.h"

/**
* \file NullType.h
* \brief Contains declaration of the type::NullType class.
...
namespace type {
  ...
  /**
  * \brief NullType class, which represents the type::NullType node.
  * (missing)
  */
  class NullType : public Type {
    protected:
      ...
      */
      NullType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const NullType& other, bool tryOnVirtualParent);
