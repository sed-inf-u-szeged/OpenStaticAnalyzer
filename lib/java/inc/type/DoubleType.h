...
#ifndef _JAVA_DoubleType_H_
#define _JAVA_DoubleType_H_

#include "java/inc/java.h"

/**
* \file DoubleType.h
* \brief Contains declaration of the type::DoubleType class.
...
namespace type {
  ...
  /**
  * \brief DoubleType class, which represents the type::DoubleType node.
  * (missing)
  */
  class DoubleType : public PrimitiveType {
    protected:
      ...
      */
      DoubleType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const DoubleType& other, bool tryOnVirtualParent);
