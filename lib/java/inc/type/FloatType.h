...
#ifndef _JAVA_FloatType_H_
#define _JAVA_FloatType_H_

#include "java/inc/java.h"

/**
* \file FloatType.h
* \brief Contains declaration of the type::FloatType class.
...
namespace type {
  ...
  /**
  * \brief FloatType class, which represents the type::FloatType node.
  * (missing)
  */
  class FloatType : public PrimitiveType {
    protected:
      ...
      */
      FloatType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const FloatType& other, bool tryOnVirtualParent);
