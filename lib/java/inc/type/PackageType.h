...
#ifndef _JAVA_PackageType_H_
#define _JAVA_PackageType_H_

#include "java/inc/java.h"

/**
* \file PackageType.h
* \brief Contains declaration of the type::PackageType class.
...
namespace type {
  ...
  /**
  * \brief PackageType class, which represents the type::PackageType node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class PackageType : public Type {
    protected:
      ...
      */
      PackageType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const PackageType& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      void setRefersTo(struc::Package *node);
