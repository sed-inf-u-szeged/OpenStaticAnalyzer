...
#ifndef _JAVA_NoType_H_
#define _JAVA_NoType_H_

#include "java/inc/java.h"

/**
* \file NoType.h
* \brief Contains declaration of the type::NoType class.
...
namespace type {
  ...
  /**
  * \brief NoType class, which represents the type::NoType node.
  * (missing)
  */
  class NoType : public Type {
    protected:
      ...
      */
      NoType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const NoType& other, bool tryOnVirtualParent);
