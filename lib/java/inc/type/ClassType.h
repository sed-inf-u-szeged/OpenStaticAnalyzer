...
#ifndef _JAVA_ClassType_H_
#define _JAVA_ClassType_H_

#include "java/inc/java.h"

/**
* \file ClassType.h
* \brief Contains declaration of the type::ClassType class.
...
namespace type {
  ...
  /**
  * \brief ClassType class, which represents the type::ClassType node.
  * (missing)
  * 
  * Edges:
  *   - refersTo (struc::TypeDeclaration, single) : (missing)
  */
  class ClassType : public ScopedType {
    protected:
      /**
      * \internal
      ...
      */
      ClassType(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ClassType& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      struc::TypeDeclaration* getRefersTo() const;
      ...
      */
      void setRefersTo(struc::TypeDeclaration *node);
