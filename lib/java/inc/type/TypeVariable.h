...
#ifndef _JAVA_TypeVariable_H_
#define _JAVA_TypeVariable_H_

#include "java/inc/java.h"

/**
* \file TypeVariable.h
* \brief Contains declaration of the type::TypeVariable class.
...
namespace type {
  ...
  /**
  * \brief TypeVariable class, which represents the type::TypeVariable node.
  * (missing)
  * 
  * Edges:
  *   - refersTo (struc::TypeParameter, single) : (missing)
  */
  class TypeVariable : public Type {
    protected:
      ...
      */
      TypeVariable(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      TypeVariable & operator=(const TypeVariable&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const TypeVariable& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      struc::TypeParameter* getRefersTo() const;
      ...
      */
      void setRefersTo(struc::TypeParameter *node);
