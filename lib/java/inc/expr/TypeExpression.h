...
#ifndef _JAVA_TypeExpression_H_
#define _JAVA_TypeExpression_H_

#include "java/inc/java.h"

/**
* \file TypeExpression.h
* \brief Contains declaration of the expr::TypeExpression class.
...
namespace expr {
  ...
  /**
  * \brief TypeExpression class, which represents the expr::TypeExpression node.
  * (missing)
  */
  class TypeExpression : public Expression {
    protected:
      ...
      */
      TypeExpression(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      TypeExpression & operator=(const TypeExpression&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      TypeExpression(const TypeExpression&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const TypeExpression& other, bool tryOnVirtualParent);
