...
#ifndef _JAVA_InstanceOf_H_
#define _JAVA_InstanceOf_H_

#include "java/inc/java.h"

/**
* \file InstanceOf.h
* \brief Contains declaration of the expr::InstanceOf class.
...
namespace expr {
  ...
  /**
  * \brief InstanceOf class, which represents the expr::InstanceOf node.
  * (missing)
  * 
  * Edges:
  *   - hasTypeOperand (expr::TypeExpression, single) : (missing)
  */
  class InstanceOf : public Unary {
    protected:
      /**
      * \internal
      ...
      */
      InstanceOf(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      InstanceOf & operator=(const InstanceOf&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const InstanceOf& other, bool tryOnVirtualParent);
