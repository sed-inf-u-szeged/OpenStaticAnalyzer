...
#ifndef _JAVA_Identifier_H_
#define _JAVA_Identifier_H_

#include "java/inc/java.h"

/**
* \file Identifier.h
* \brief Contains declaration of the expr::Identifier class.
...
namespace expr {
  ...
  /**
  * \brief Identifier class, which represents the expr::Identifier node.
  * (missing)
  * 
  * Attributes:
  *   - name (String) : (missing)
  * 
  * Edges:
  *   - refersTo (base::Named, single) : (missing)
  */
  class Identifier : public Expression {
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Identifier& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      void setRefersTo(base::Named *node);
