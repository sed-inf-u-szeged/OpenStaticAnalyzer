...
#ifndef _JAVA_Literal_H_
#define _JAVA_Literal_H_

#include "java/inc/java.h"

/**
* \file Literal.h
* \brief Contains declaration of the expr::Literal class.
...
namespace expr {
  ...
  /**
  * \brief Literal class, which represents the expr::Literal node.
  * (missing)
  */
  class Literal : public Expression {
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Literal& other, bool tryOnVirtualParent);
