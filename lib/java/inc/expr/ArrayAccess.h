...
#ifndef _JAVA_ArrayAccess_H_
#define _JAVA_ArrayAccess_H_

#include "java/inc/java.h"

/**
* \file ArrayAccess.h
* \brief Contains declaration of the expr::ArrayAccess class.
...
namespace expr {
  ...
  /**
  * \brief ArrayAccess class, which represents the expr::ArrayAccess node.
  * (missing)
  */
  class ArrayAccess : public Binary {
    protected:
      /**
      * \internal
      ...
      */
      ArrayAccess(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ArrayAccess& other, bool tryOnVirtualParent);
