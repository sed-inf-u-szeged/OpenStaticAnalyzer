...
#ifndef _JAVA_ClassLiteral_H_
#define _JAVA_ClassLiteral_H_

#include "java/inc/java.h"

/**
* \file ClassLiteral.h
* \brief Contains declaration of the expr::ClassLiteral class.
...
namespace expr {
  ...
  /**
  * \brief ClassLiteral class, which represents the expr::ClassLiteral node.
  * (missing)
  * 
  * Edges:
  *   - hasComponentType (expr::TypeExpression, single) : (missing)
  */
  class ClassLiteral : public Literal {
    protected:
      /**
      * \internal
      ...
      */
      ClassLiteral(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      ClassLiteral & operator=(const ClassLiteral&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      ClassLiteral(const ClassLiteral&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ClassLiteral& other, bool tryOnVirtualParent);
