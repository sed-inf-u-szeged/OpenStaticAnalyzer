...
#ifndef _JAVA_Expression_H_
#define _JAVA_Expression_H_

#include "java/inc/java.h"

/**
* \file Expression.h
* \brief Contains declaration of the expr::Expression class.
...
namespace expr {
  ...
  /**
  * \brief Expression class, which represents the expr::Expression node.
  * (missing)
  * 
  * Edges:
  *   - type (type::Type, single) : (missing)
  */
  class Expression : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      Expression(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Expression& other, bool tryOnVirtualParent);
