...
#ifndef _JAVA_Super_H_
#define _JAVA_Super_H_

#include "java/inc/java.h"

/**
* \file Super.h
* \brief Contains declaration of the expr::Super class.
...
namespace expr {
  ...
  /**
  * \brief Super class, which represents the expr::Super node.
  * (missing)
  */
  class Super : public Expression {
    protected:
      ...
      */
      Super(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Super& other, bool tryOnVirtualParent);
