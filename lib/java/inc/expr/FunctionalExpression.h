...
#ifndef _JAVA_FunctionalExpression_H_
#define _JAVA_FunctionalExpression_H_

#include "java/inc/java.h"

/**
* \file FunctionalExpression.h
* \brief Contains declaration of the expr::FunctionalExpression class.
...
namespace expr {
  ...
  /**
  * \brief FunctionalExpression class, which represents the expr::FunctionalExpression node.
  * (missing)
  * 
  * Edges:
  *   - target (type::Type, single) : (missing)
  */
  class FunctionalExpression : public PolyExpression {
    protected:
      /**
      * \internal
      ...
      */
      FunctionalExpression(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~FunctionalExpression();

    private:
      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      FunctionalExpression & operator=(const FunctionalExpression&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      FunctionalExpression(const FunctionalExpression&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const FunctionalExpression& other, bool tryOnVirtualParent);
