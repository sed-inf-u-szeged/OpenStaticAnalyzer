...
#ifndef _JAVA_This_H_
#define _JAVA_This_H_

#include "java/inc/java.h"

/**
* \file This.h
* \brief Contains declaration of the expr::This class.
...
namespace expr {
  ...
  /**
  * \brief This class, which represents the expr::This node.
  * (missing)
  */
  class This : public Expression {
    protected:
      ...
      */
      This(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const This& other, bool tryOnVirtualParent);
