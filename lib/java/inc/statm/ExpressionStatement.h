...
#ifndef _JAVA_ExpressionStatement_H_
#define _JAVA_ExpressionStatement_H_

#include "java/inc/java.h"

/**
* \file ExpressionStatement.h
* \brief Contains declaration of the statm::ExpressionStatement class.
...
namespace statm {
  ...
  /**
  * \brief ExpressionStatement class, which represents the statm::ExpressionStatement node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class ExpressionStatement : public Statement {
    protected:
      ...
      */
      ExpressionStatement(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ExpressionStatement& other, bool tryOnVirtualParent);
