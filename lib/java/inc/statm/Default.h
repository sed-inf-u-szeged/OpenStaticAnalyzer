...
#ifndef _JAVA_Default_H_
#define _JAVA_Default_H_

#include "java/inc/java.h"

/**
* \file Default.h
* \brief Contains declaration of the statm::Default class.
...
namespace statm {
  ...
  /**
  * \brief Default class, which represents the statm::Default node.
  * (missing)
  */
  class Default : public SwitchLabel {
    protected:
      ...
      */
      Default(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Default& other, bool tryOnVirtualParent);
