...
#ifndef _JAVA_Case_H_
#define _JAVA_Case_H_

#include "java/inc/java.h"

/**
* \file Case.h
* \brief Contains declaration of the statm::Case class.
...
namespace statm {
  ...
  /**
  * \brief Case class, which represents the statm::Case node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Case : public SwitchLabel {
    protected:
      ...
      */
      Case(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Case& other, bool tryOnVirtualParent);
