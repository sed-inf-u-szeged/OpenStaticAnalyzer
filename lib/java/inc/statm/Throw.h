...
#ifndef _JAVA_Throw_H_
#define _JAVA_Throw_H_

#include "java/inc/java.h"

/**
* \file Throw.h
* \brief Contains declaration of the statm::Throw class.
...
namespace statm {
  ...
  /**
  * \brief Throw class, which represents the statm::Throw node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Throw : public Statement {
    protected:
      ...
      */
      Throw(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Throw& other, bool tryOnVirtualParent);
