...
#ifndef _JAVA_EnhancedFor_H_
#define _JAVA_EnhancedFor_H_

#include "java/inc/java.h"

/**
* \file EnhancedFor.h
* \brief Contains declaration of the statm::EnhancedFor class.
...
namespace statm {
  ...
  /**
  * \brief EnhancedFor class, which represents the statm::EnhancedFor node.
  * (missing)
  * 
  * Attributes:
  ...
  *   - hasExpression (expr::Expression, single) : (missing)
  */
  class EnhancedFor : public For {
    protected:
      /**
      * \internal
      ...
      */
      EnhancedFor(NodeId nodeId, Factory *factory);
    ...
    private:
      ...
      */
      EnhancedFor & operator=(const EnhancedFor&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      EnhancedFor(const EnhancedFor&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const EnhancedFor& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      virtual int compareByColonPosition(const EnhancedFor& other) const;
    ...
    public:
      ...
      */
      expr::Expression* getExpression() const;
      ...
      */
      void setExpression(expr::Expression *node);
