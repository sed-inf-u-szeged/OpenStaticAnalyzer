...
#ifndef _JAVA_Break_H_
#define _JAVA_Break_H_

#include "java/inc/java.h"

/**
* \file Break.h
* \brief Contains declaration of the statm::Break class.
...
namespace statm {
  ...
  /**
  * \brief Break class, which represents the statm::Break node.
  * (missing)
  */
  class Break : public Jump {
    protected:
      ...
      */
      Break(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Break& other, bool tryOnVirtualParent);
