...
#ifndef _JAVA_Assert_H_
#define _JAVA_Assert_H_

#include "java/inc/java.h"

/**
* \file Assert.h
* \brief Contains declaration of the statm::Assert class.
...
namespace statm {
  ...
  /**
  * \brief Assert class, which represents the statm::Assert node.
  * (missing)
  * 
  * Attributes:
  ...
  *   - hasDetail (expr::Expression, single) : (missing)
  */
  class Assert : public Statement {
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Assert& other, bool tryOnVirtualParent);
    ...
    public:
      ...
      */
      virtual int compareByColonPosition(const Assert& other) const;
    ...
    public:
      ...
      */
      ...
      /**
      * \brief Gives back the pointer of the node the hasDetail edge points to.
      * \return Returns the end point of the hasDetail edge.
      */
      expr::Expression* getDetail() const;
      ...
      */
      ...
      /**
      * \brief Sets the hasDetail edge.
      * \param id [in] The new end point of the hasDetail edge.
      */
      void setDetail(NodeId id);

      /**
      * \brief Sets the hasDetail edge.
      * \param node [in] The new end point of the hasDetail edge.
      */
      void setDetail(expr::Expression *node);

      /**
      * \brief remove the hasDetail edge.
      */
      void removeDetail();
    ...
    protected:
      ...
      /** \internal \brief The id of the node the hasDetail edge points to. */
      NodeId m_hasDetail;
