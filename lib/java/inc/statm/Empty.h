...
#ifndef _JAVA_Empty_H_
#define _JAVA_Empty_H_

#include "java/inc/java.h"

/**
* \file Empty.h
* \brief Contains declaration of the statm::Empty class.
...
namespace statm {
  ...
  /**
  * \brief Empty class, which represents the statm::Empty node.
  * (missing)
  */
  class Empty : public Statement {
    protected:
      ...
      */
      Empty(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Empty& other, bool tryOnVirtualParent);
