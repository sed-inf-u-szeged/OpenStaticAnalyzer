...
#ifndef _JAVA_Continue_H_
#define _JAVA_Continue_H_

#include "java/inc/java.h"

/**
* \file Continue.h
* \brief Contains declaration of the statm::Continue class.
...
namespace statm {
  ...
  /**
  * \brief Continue class, which represents the statm::Continue node.
  * (missing)
  */
  class Continue : public Jump {
    protected:
      ...
      */
      Continue(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Continue& other, bool tryOnVirtualParent);
