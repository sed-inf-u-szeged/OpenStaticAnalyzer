...
#ifndef _JAVA_Selection_H_
#define _JAVA_Selection_H_

#include "java/inc/java.h"

/**
* \file Selection.h
* \brief Contains declaration of the statm::Selection class.
...
namespace statm {
  ...
  /**
  * \brief Selection class, which represents the statm::Selection node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Selection : public Statement {
    protected:
      ...
      */
      Selection(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Selection& other, bool tryOnVirtualParent);
