...
#ifndef _JAVA_Statement_H_
#define _JAVA_Statement_H_

#include "java/inc/java.h"

/**
* \file Statement.h
* \brief Contains declaration of the statm::Statement class.
...
namespace statm {
  ...
  /**
  * \brief Statement class, which represents the statm::Statement node.
  * (missing)
  */
  class Statement : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      Statement(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Statement& other, bool tryOnVirtualParent);
