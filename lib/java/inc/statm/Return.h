...
#ifndef _JAVA_Return_H_
#define _JAVA_Return_H_

#include "java/inc/java.h"

/**
* \file Return.h
* \brief Contains declaration of the statm::Return class.
...
namespace statm {
  ...
  /**
  * \brief Return class, which represents the statm::Return node.
  * (missing)
  * 
  * Edges:
  ...
  */
  class Return : public Statement {
    protected:
      ...
      */
      Return(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Return& other, bool tryOnVirtualParent);
