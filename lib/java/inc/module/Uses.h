...
#ifndef _JAVA_Uses_H_
#define _JAVA_Uses_H_

#include "java/inc/java.h"

/**
* \file Uses.h
* \brief Contains declaration of the module::Uses class.
...
namespace module {
  ...
  /**
  * \brief Uses class, which represents the module::Uses node.
  * (missing)
  * 
  * Edges:
  *   - hasServiceName (expr::Expression, single) : (missing)
  */
  class Uses : public ModuleDirective {
    protected:
      /**
      * \internal
      ...
      */
      Uses(NodeId nodeId, Factory *factory);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const Uses& other, bool tryOnVirtualParent);
