...
#ifndef _JAVA_ModuleDirective_H_
#define _JAVA_ModuleDirective_H_

#include "java/inc/java.h"

/**
* \file ModuleDirective.h
* \brief Contains declaration of the module::ModuleDirective class.
...
namespace module {
  ...
  /**
  * \brief ModuleDirective class, which represents the module::ModuleDirective node.
  * (missing)
  */
  class ModuleDirective : public base::Positioned {
    protected:
      /**
      * \internal
      ...
      */
      ModuleDirective(NodeId nodeId, Factory *factory);

      /**
      * \internal
      * \brief Non-public destructor, only factory can destroy nodes.
      */
      virtual ~ModuleDirective();

    private:
      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      ModuleDirective & operator=(const ModuleDirective&);

      /**
      * \brief This function always throws a JavaException due to copying is not allowed!
      */
      ModuleDirective(const ModuleDirective&);
    ...
    protected:
      ...
      * \brief Clone method.
      */
      virtual void clone(const ModuleDirective& other, bool tryOnVirtualParent);
